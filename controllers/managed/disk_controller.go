...
// +kubebuilder:rbac:groups=managed.azurerm.kubeform.com,resources=disks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=managed.azurerm.kubeform.com,resources=disks/status,verbs=get;update;patch
...
func (r *DiskReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &managedv1alpha1.Disk{}); err != nil {
			klog.Error(err, "unable to set up auditor", managedv1alpha1.Disk{}.APIVersion, managedv1alpha1.Disk{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&managedv1alpha1.Disk{}).
