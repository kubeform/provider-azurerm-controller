...
// +kubebuilder:rbac:groups=managed.azurerm.kubeform.com,resources=applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=managed.azurerm.kubeform.com,resources=applications/status,verbs=get;update;patch
...
func (r *ApplicationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &managedv1alpha1.Application{}); err != nil {
			klog.Error(err, "unable to set up auditor", managedv1alpha1.Application{}.APIVersion, managedv1alpha1.Application{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&managedv1alpha1.Application{}).
