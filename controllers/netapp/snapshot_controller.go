...
// +kubebuilder:rbac:groups=netapp.azurerm.kubeform.com,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=netapp.azurerm.kubeform.com,resources=snapshots/status,verbs=get;update;patch
...
func (r *SnapshotReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &netappv1alpha1.Snapshot{}); err != nil {
			klog.Error(err, "unable to set up auditor", netappv1alpha1.Snapshot{}.APIVersion, netappv1alpha1.Snapshot{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&netappv1alpha1.Snapshot{}).
