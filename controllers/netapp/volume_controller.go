...
// +kubebuilder:rbac:groups=netapp.azurerm.kubeform.com,resources=volumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=netapp.azurerm.kubeform.com,resources=volumes/status,verbs=get;update;patch
...
func (r *VolumeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &netappv1alpha1.Volume{}); err != nil {
			klog.Error(err, "unable to set up auditor", netappv1alpha1.Volume{}.APIVersion, netappv1alpha1.Volume{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&netappv1alpha1.Volume{}).
