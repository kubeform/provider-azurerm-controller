...
// +kubebuilder:rbac:groups=netapp.azurerm.kubeform.com,resources=pools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=netapp.azurerm.kubeform.com,resources=pools/status,verbs=get;update;patch
...
func (r *PoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &netappv1alpha1.Pool{}); err != nil {
			klog.Error(err, "unable to set up auditor", netappv1alpha1.Pool{}.APIVersion, netappv1alpha1.Pool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&netappv1alpha1.Pool{}).
