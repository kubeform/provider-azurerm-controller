...
// +kubebuilder:rbac:groups=keyvault.azurerm.kubeform.com,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=keyvault.azurerm.kubeform.com,resources=keys/status,verbs=get;update;patch
...
func (r *KeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &keyvaultv1alpha1.Key{}); err != nil {
			klog.Error(err, "unable to set up auditor", keyvaultv1alpha1.Key{}.APIVersion, keyvaultv1alpha1.Key{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&keyvaultv1alpha1.Key{}).
