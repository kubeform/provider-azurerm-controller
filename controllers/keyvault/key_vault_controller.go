...
// +kubebuilder:rbac:groups=keyvault.azurerm.kubeform.com,resources=keyvaults,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=keyvault.azurerm.kubeform.com,resources=keyvaults/status,verbs=get;update;patch
...
func (r *KeyVaultReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &keyvaultv1alpha1.KeyVault{}); err != nil {
			klog.Error(err, "unable to set up auditor", keyvaultv1alpha1.KeyVault{}.APIVersion, keyvaultv1alpha1.KeyVault{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&keyvaultv1alpha1.KeyVault{}).
