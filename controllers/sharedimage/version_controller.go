...
// +kubebuilder:rbac:groups=sharedimage.azurerm.kubeform.com,resources=versions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sharedimage.azurerm.kubeform.com,resources=versions/status,verbs=get;update;patch
...
func (r *VersionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sharedimagev1alpha1.Version{}); err != nil {
			klog.Error(err, "unable to set up auditor", sharedimagev1alpha1.Version{}.APIVersion, sharedimagev1alpha1.Version{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sharedimagev1alpha1.Version{}).
