...
// +kubebuilder:rbac:groups=devspace.azurerm.kubeform.com,resources=controllers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=devspace.azurerm.kubeform.com,resources=controllers/status,verbs=get;update;patch

func (r *ControllerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("controller", req.NamespacedName)
...
func (r *ControllerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &devspacev1alpha1.Controller{}); err != nil {
			klog.Error(err, "unable to set up auditor", devspacev1alpha1.Controller{}.APIVersion, devspacev1alpha1.Controller{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&devspacev1alpha1.Controller{}).
...
func (r *ControllerReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Controller")
			return nil
		}
		...
		resourceList := &devspacev1alpha1.ControllerList{}
