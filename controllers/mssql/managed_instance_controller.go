...
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=managedinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=managedinstances/status,verbs=get;update;patch
...
func (r *ManagedInstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mssqlv1alpha1.ManagedInstance{}); err != nil {
			klog.Error(err, "unable to set up auditor", mssqlv1alpha1.ManagedInstance{}.APIVersion, mssqlv1alpha1.ManagedInstance{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mssqlv1alpha1.ManagedInstance{}).
...
func (r *ManagedInstanceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for ManagedInstance")
			return nil
		}
		...
		resourceList := &mssqlv1alpha1.ManagedInstanceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list ManagedInstance")
			return nil
		}
