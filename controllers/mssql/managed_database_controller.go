...
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=manageddatabases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=manageddatabases/status,verbs=get;update;patch
...
func (r *ManagedDatabaseReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mssqlv1alpha1.ManagedDatabase{}); err != nil {
			klog.Error(err, "unable to set up auditor", mssqlv1alpha1.ManagedDatabase{}.APIVersion, mssqlv1alpha1.ManagedDatabase{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mssqlv1alpha1.ManagedDatabase{}).
