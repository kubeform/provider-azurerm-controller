...
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=databases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=databases/status,verbs=get;update;patch
...
func (r *DatabaseReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mssqlv1alpha1.Database{}); err != nil {
			klog.Error(err, "unable to set up auditor", mssqlv1alpha1.Database{}.APIVersion, mssqlv1alpha1.Database{}.Kind)
			return err
		}
	}
...
func (r *DatabaseReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &mssqlv1alpha1.DatabaseList{}
