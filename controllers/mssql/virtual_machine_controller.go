...
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=virtualmachines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mssql.azurerm.kubeform.com,resources=virtualmachines/status,verbs=get;update;patch
...
func (r *VirtualMachineReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mssqlv1alpha1.VirtualMachine{}); err != nil {
			klog.Error(err, "unable to set up auditor", mssqlv1alpha1.VirtualMachine{}.APIVersion, mssqlv1alpha1.VirtualMachine{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mssqlv1alpha1.VirtualMachine{}).
...
func (r *VirtualMachineReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &mssqlv1alpha1.VirtualMachineList{}
