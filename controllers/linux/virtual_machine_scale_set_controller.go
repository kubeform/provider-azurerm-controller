...
// +kubebuilder:rbac:groups=linux.azurerm.kubeform.com,resources=virtualmachinescalesets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=linux.azurerm.kubeform.com,resources=virtualmachinescalesets/status,verbs=get;update;patch
...
func (r *VirtualMachineScaleSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &linuxv1alpha1.VirtualMachineScaleSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", linuxv1alpha1.VirtualMachineScaleSet{}.APIVersion, linuxv1alpha1.VirtualMachineScaleSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&linuxv1alpha1.VirtualMachineScaleSet{}).
...
func (r *VirtualMachineScaleSetReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &linuxv1alpha1.VirtualMachineScaleSetList{}
