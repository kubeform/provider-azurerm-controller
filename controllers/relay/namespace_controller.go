...
// +kubebuilder:rbac:groups=relay.azurerm.kubeform.com,resources=namespace_s,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=relay.azurerm.kubeform.com,resources=namespace_s/status,verbs=get;update;patch
...
func (r *Namespace_Reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &relayv1alpha1.Namespace_{}); err != nil {
			klog.Error(err, "unable to set up auditor", relayv1alpha1.Namespace_{}.APIVersion, relayv1alpha1.Namespace_{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&relayv1alpha1.Namespace_{}).
