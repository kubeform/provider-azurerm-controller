...
// +kubebuilder:rbac:groups=relay.azurerm.kubeform.com,resources=namespaceauthorizationrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=relay.azurerm.kubeform.com,resources=namespaceauthorizationrules/status,verbs=get;update;patch
...
func (r *NamespaceAuthorizationRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &relayv1alpha1.NamespaceAuthorizationRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", relayv1alpha1.NamespaceAuthorizationRule{}.APIVersion, relayv1alpha1.NamespaceAuthorizationRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&relayv1alpha1.NamespaceAuthorizationRule{}).
...
func (r *NamespaceAuthorizationRuleReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &relayv1alpha1.NamespaceAuthorizationRuleList{}
