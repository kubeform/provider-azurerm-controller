...
// +kubebuilder:rbac:groups=logz.azurerm.kubeform.com,resources=monitors,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=logz.azurerm.kubeform.com,resources=monitors/status,verbs=get;update;patch
...
func (r *MonitorReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &logzv1alpha1.Monitor{}); err != nil {
			klog.Error(err, "unable to set up auditor", logzv1alpha1.Monitor{}.APIVersion, logzv1alpha1.Monitor{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&logzv1alpha1.Monitor{}).
