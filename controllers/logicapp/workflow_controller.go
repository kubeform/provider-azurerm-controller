...
// +kubebuilder:rbac:groups=logicapp.azurerm.kubeform.com,resources=workflows,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=logicapp.azurerm.kubeform.com,resources=workflows/status,verbs=get;update;patch
...
func (r *WorkflowReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &logicappv1alpha1.Workflow{}); err != nil {
			klog.Error(err, "unable to set up auditor", logicappv1alpha1.Workflow{}.APIVersion, logicappv1alpha1.Workflow{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&logicappv1alpha1.Workflow{}).
