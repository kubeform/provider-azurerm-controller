...
// +kubebuilder:rbac:groups=tenant.azurerm.kubeform.com,resources=templatedeployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tenant.azurerm.kubeform.com,resources=templatedeployments/status,verbs=get;update;patch
...
func (r *TemplateDeploymentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &tenantv1alpha1.TemplateDeployment{}); err != nil {
			klog.Error(err, "unable to set up auditor", tenantv1alpha1.TemplateDeployment{}.APIVersion, tenantv1alpha1.TemplateDeployment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&tenantv1alpha1.TemplateDeployment{}).
