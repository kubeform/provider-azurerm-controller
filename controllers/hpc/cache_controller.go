...
// +kubebuilder:rbac:groups=hpc.azurerm.kubeform.com,resources=caches,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hpc.azurerm.kubeform.com,resources=caches/status,verbs=get;update;patch
...
func (r *CacheReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &hpcv1alpha1.Cache{}); err != nil {
			klog.Error(err, "unable to set up auditor", hpcv1alpha1.Cache{}.APIVersion, hpcv1alpha1.Cache{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&hpcv1alpha1.Cache{}).
...
func (r *CacheReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &hpcv1alpha1.CacheList{}
