...
// +kubebuilder:rbac:groups=vpn.azurerm.kubeform.com,resources=sites,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vpn.azurerm.kubeform.com,resources=sites/status,verbs=get;update;patch
...
func (r *SiteReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vpnv1alpha1.Site{}); err != nil {
			klog.Error(err, "unable to set up auditor", vpnv1alpha1.Site{}.APIVersion, vpnv1alpha1.Site{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&vpnv1alpha1.Site{}).
