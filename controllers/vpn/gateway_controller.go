...
// +kubebuilder:rbac:groups=vpn.azurerm.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vpn.azurerm.kubeform.com,resources=gateways/status,verbs=get;update;patch
