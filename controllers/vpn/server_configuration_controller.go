...
type ServerConfigurationReconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=vpn.azurerm.kubeform.com,resources=serverconfigurations/status,verbs=get;update;patch
...
func (r *ServerConfigurationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch ServerConfiguration")
...
func (r *ServerConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&vpnv1alpha1.ServerConfiguration{}).
...
func (r *ServerConfigurationReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for ServerConfiguration")
			return nil
		}
