...
// +kubebuilder:rbac:groups=bot.azurerm.kubeform.com,resources=webapps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bot.azurerm.kubeform.com,resources=webapps/status,verbs=get;update;patch
...
func (r *WebAppReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &botv1alpha1.WebApp{}); err != nil {
			klog.Error(err, "unable to set up auditor", botv1alpha1.WebApp{}.APIVersion, botv1alpha1.WebApp{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&botv1alpha1.WebApp{}).
...
func (r *WebAppReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for WebApp")
			return nil
		}
		...
		resourceList := &botv1alpha1.WebAppList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list WebApp")
			return nil
		}
