...
// +kubebuilder:rbac:groups=bot.azurerm.kubeform.com,resources=connections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bot.azurerm.kubeform.com,resources=connections/status,verbs=get;update;patch
...
func (r *ConnectionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &botv1alpha1.Connection{}); err != nil {
			klog.Error(err, "unable to set up auditor", botv1alpha1.Connection{}.APIVersion, botv1alpha1.Connection{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&botv1alpha1.Connection{}).
...
func (r *ConnectionReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &botv1alpha1.ConnectionList{}
