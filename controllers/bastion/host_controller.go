...
// +kubebuilder:rbac:groups=bastion.azurerm.kubeform.com,resources=hosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bastion.azurerm.kubeform.com,resources=hosts/status,verbs=get;update;patch
...
func (r *HostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bastionv1alpha1.Host{}); err != nil {
			klog.Error(err, "unable to set up auditor", bastionv1alpha1.Host{}.APIVersion, bastionv1alpha1.Host{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bastionv1alpha1.Host{}).
