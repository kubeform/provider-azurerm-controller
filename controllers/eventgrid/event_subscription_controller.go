...
// +kubebuilder:rbac:groups=eventgrid.azurerm.kubeform.com,resources=eventsubscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventgrid.azurerm.kubeform.com,resources=eventsubscriptions/status,verbs=get;update;patch
...
func (r *EventSubscriptionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventgridv1alpha1.EventSubscription{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventgridv1alpha1.EventSubscription{}.APIVersion, eventgridv1alpha1.EventSubscription{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventgridv1alpha1.EventSubscription{}).
...
func (r *EventSubscriptionReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for EventSubscription")
			return nil
		}
		...
		resourceList := &eventgridv1alpha1.EventSubscriptionList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list EventSubscription")
			return nil
		}
