...
// +kubebuilder:rbac:groups=eventgrid.azurerm.kubeform.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventgrid.azurerm.kubeform.com,resources=domains/status,verbs=get;update;patch
...
func (r *DomainReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventgridv1alpha1.Domain{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventgridv1alpha1.Domain{}.APIVersion, eventgridv1alpha1.Domain{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventgridv1alpha1.Domain{}).
...
func (r *DomainReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &eventgridv1alpha1.DomainList{}
