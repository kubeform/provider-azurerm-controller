...
// +kubebuilder:rbac:groups=eventgrid.azurerm.kubeform.com,resources=topics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventgrid.azurerm.kubeform.com,resources=topics/status,verbs=get;update;patch
...
func (r *TopicReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventgridv1alpha1.Topic{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventgridv1alpha1.Topic{}.APIVersion, eventgridv1alpha1.Topic{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventgridv1alpha1.Topic{}).
...
func (r *TopicReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Topic")
			return nil
		}
		...
		resourceList := &eventgridv1alpha1.TopicList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Topic")
			return nil
		}
