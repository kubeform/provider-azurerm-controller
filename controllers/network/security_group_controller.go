...
// +kubebuilder:rbac:groups=network.azurerm.kubeform.com,resources=securitygroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.azurerm.kubeform.com,resources=securitygroups/status,verbs=get;update;patch
...
func (r *SecurityGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.SecurityGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.SecurityGroup{}.APIVersion, networkv1alpha1.SecurityGroup{}.Kind)
			return err
		}
	}
