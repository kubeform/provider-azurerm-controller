...
// +kubebuilder:rbac:groups=packet.azurerm.kubeform.com,resources=captures,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=packet.azurerm.kubeform.com,resources=captures/status,verbs=get;update;patch
...
func (r *CaptureReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &packetv1alpha1.Capture{}); err != nil {
			klog.Error(err, "unable to set up auditor", packetv1alpha1.Capture{}.APIVersion, packetv1alpha1.Capture{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&packetv1alpha1.Capture{}).
