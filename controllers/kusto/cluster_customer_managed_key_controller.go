...
// +kubebuilder:rbac:groups=kusto.azurerm.kubeform.com,resources=clustercustomermanagedkeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kusto.azurerm.kubeform.com,resources=clustercustomermanagedkeys/status,verbs=get;update;patch
...
func (r *ClusterCustomerManagedKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &kustov1alpha1.ClusterCustomerManagedKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", kustov1alpha1.ClusterCustomerManagedKey{}.APIVersion, kustov1alpha1.ClusterCustomerManagedKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&kustov1alpha1.ClusterCustomerManagedKey{}).
