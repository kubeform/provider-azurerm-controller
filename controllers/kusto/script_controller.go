...
// +kubebuilder:rbac:groups=kusto.azurerm.kubeform.com,resources=scripts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kusto.azurerm.kubeform.com,resources=scripts/status,verbs=get;update;patch
...
func (r *ScriptReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &kustov1alpha1.Script{}); err != nil {
			klog.Error(err, "unable to set up auditor", kustov1alpha1.Script{}.APIVersion, kustov1alpha1.Script{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&kustov1alpha1.Script{}).
