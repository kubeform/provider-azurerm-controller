...
// +kubebuilder:rbac:groups=local.azurerm.kubeform.com,resources=networkgateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=local.azurerm.kubeform.com,resources=networkgateways/status,verbs=get;update;patch
...
func (r *NetworkGatewayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &localv1alpha1.NetworkGateway{}); err != nil {
			klog.Error(err, "unable to set up auditor", localv1alpha1.NetworkGateway{}.APIVersion, localv1alpha1.NetworkGateway{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&localv1alpha1.NetworkGateway{}).
