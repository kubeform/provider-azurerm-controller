...
// SparkClusterReconciler reconciles a SparkCluster object
...
// +kubebuilder:rbac:groups=hdinsight.azurerm.kubeform.com,resources=sparkclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hdinsight.azurerm.kubeform.com,resources=sparkclusters/status,verbs=get;update;patch
...
func (r *SparkClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch SparkCluster")
...
func (r *SparkClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &hdinsightv1alpha1.SparkCluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", hdinsightv1alpha1.SparkCluster{}.APIVersion, hdinsightv1alpha1.SparkCluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&hdinsightv1alpha1.SparkCluster{}).
...
func (r *SparkClusterReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for SparkCluster")
			return nil
		}
		...
		resourceList := &hdinsightv1alpha1.SparkClusterList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list SparkCluster")
			return nil
		}
