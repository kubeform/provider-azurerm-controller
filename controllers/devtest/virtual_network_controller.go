...
// +kubebuilder:rbac:groups=devtest.azurerm.kubeform.com,resources=virtualnetworks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=devtest.azurerm.kubeform.com,resources=virtualnetworks/status,verbs=get;update;patch
...
func (r *VirtualNetworkReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &devtestv1alpha1.VirtualNetwork{}); err != nil {
			klog.Error(err, "unable to set up auditor", devtestv1alpha1.VirtualNetwork{}.APIVersion, devtestv1alpha1.VirtualNetwork{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&devtestv1alpha1.VirtualNetwork{}).
