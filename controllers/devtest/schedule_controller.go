...
// +kubebuilder:rbac:groups=devtest.azurerm.kubeform.com,resources=schedules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=devtest.azurerm.kubeform.com,resources=schedules/status,verbs=get;update;patch
...
func (r *ScheduleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &devtestv1alpha1.Schedule{}); err != nil {
			klog.Error(err, "unable to set up auditor", devtestv1alpha1.Schedule{}.APIVersion, devtestv1alpha1.Schedule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&devtestv1alpha1.Schedule{}).
