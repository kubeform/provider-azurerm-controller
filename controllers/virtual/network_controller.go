...
// +kubebuilder:rbac:groups=virtual.azurerm.kubeform.com,resources=networks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=virtual.azurerm.kubeform.com,resources=networks/status,verbs=get;update;patch
...
func (r *NetworkReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &virtualv1alpha1.Network{}); err != nil {
			klog.Error(err, "unable to set up auditor", virtualv1alpha1.Network{}.APIVersion, virtualv1alpha1.Network{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&virtualv1alpha1.Network{}).
