...
// +kubebuilder:rbac:groups=virtual.azurerm.kubeform.com,resources=machines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=virtual.azurerm.kubeform.com,resources=machines/status,verbs=get;update;patch
