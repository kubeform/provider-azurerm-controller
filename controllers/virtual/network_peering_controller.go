...
// +kubebuilder:rbac:groups=virtual.azurerm.kubeform.com,resources=networkpeerings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=virtual.azurerm.kubeform.com,resources=networkpeerings/status,verbs=get;update;patch
...
func (r *NetworkPeeringReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &virtualv1alpha1.NetworkPeering{}); err != nil {
			klog.Error(err, "unable to set up auditor", virtualv1alpha1.NetworkPeering{}.APIVersion, virtualv1alpha1.NetworkPeering{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&virtualv1alpha1.NetworkPeering{}).
