...
// +kubebuilder:rbac:groups=iothub.azurerm.kubeform.com,resources=routes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iothub.azurerm.kubeform.com,resources=routes/status,verbs=get;update;patch
...
func (r *RouteReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iothubv1alpha1.Route{}); err != nil {
			klog.Error(err, "unable to set up auditor", iothubv1alpha1.Route{}.APIVersion, iothubv1alpha1.Route{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iothubv1alpha1.Route{}).
