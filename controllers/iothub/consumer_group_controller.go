...
// +kubebuilder:rbac:groups=iothub.azurerm.kubeform.com,resources=consumergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iothub.azurerm.kubeform.com,resources=consumergroups/status,verbs=get;update;patch
...
func (r *ConsumerGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iothubv1alpha1.ConsumerGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", iothubv1alpha1.ConsumerGroup{}.APIVersion, iothubv1alpha1.ConsumerGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iothubv1alpha1.ConsumerGroup{}).
