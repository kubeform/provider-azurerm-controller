...
// +kubebuilder:rbac:groups=windows.azurerm.kubeform.com,resources=virtualmachinescalesets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=windows.azurerm.kubeform.com,resources=virtualmachinescalesets/status,verbs=get;update;patch
...
func (r *VirtualMachineScaleSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &windowsv1alpha1.VirtualMachineScaleSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", windowsv1alpha1.VirtualMachineScaleSet{}.APIVersion, windowsv1alpha1.VirtualMachineScaleSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&windowsv1alpha1.VirtualMachineScaleSet{}).
...
func (r *VirtualMachineScaleSetReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for VirtualMachineScaleSet")
			return nil
		}
		...
		resourceList := &windowsv1alpha1.VirtualMachineScaleSetList{}
