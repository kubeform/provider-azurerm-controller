...
// +kubebuilder:rbac:groups=windows.azurerm.kubeform.com,resources=virtualmachines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=windows.azurerm.kubeform.com,resources=virtualmachines/status,verbs=get;update;patch
...
func (r *VirtualMachineReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &windowsv1alpha1.VirtualMachine{}); err != nil {
			klog.Error(err, "unable to set up auditor", windowsv1alpha1.VirtualMachine{}.APIVersion, windowsv1alpha1.VirtualMachine{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&windowsv1alpha1.VirtualMachine{}).
...
func (r *VirtualMachineReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for VirtualMachine")
			return nil
		}
		...
		resourceList := &windowsv1alpha1.VirtualMachineList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list VirtualMachine")
			return nil
		}
