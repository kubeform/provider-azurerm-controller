...
// +kubebuilder:rbac:groups=eventhub.azurerm.kubeform.com,resources=consumergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventhub.azurerm.kubeform.com,resources=consumergroups/status,verbs=get;update;patch
...
func (r *ConsumerGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventhubv1alpha1.ConsumerGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventhubv1alpha1.ConsumerGroup{}.APIVersion, eventhubv1alpha1.ConsumerGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventhubv1alpha1.ConsumerGroup{}).
