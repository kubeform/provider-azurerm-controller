...
// +kubebuilder:rbac:groups=eventhub.azurerm.kubeform.com,resources=eventhubs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventhub.azurerm.kubeform.com,resources=eventhubs/status,verbs=get;update;patch
...
func (r *EventhubReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventhubv1alpha1.Eventhub{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventhubv1alpha1.Eventhub{}.APIVersion, eventhubv1alpha1.Eventhub{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventhubv1alpha1.Eventhub{}).
