...
// +kubebuilder:rbac:groups=eventhub.azurerm.kubeform.com,resources=namespaceauthorizationrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventhub.azurerm.kubeform.com,resources=namespaceauthorizationrules/status,verbs=get;update;patch
...
func (r *NamespaceAuthorizationRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventhubv1alpha1.NamespaceAuthorizationRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventhubv1alpha1.NamespaceAuthorizationRule{}.APIVersion, eventhubv1alpha1.NamespaceAuthorizationRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventhubv1alpha1.NamespaceAuthorizationRule{}).
...
func (r *NamespaceAuthorizationRuleReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &eventhubv1alpha1.NamespaceAuthorizationRuleList{}
