...
// +kubebuilder:rbac:groups=servicebus.azurerm.kubeform.com,resources=namespaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=servicebus.azurerm.kubeform.com,resources=namespaces/status,verbs=get;update;patch
...
func (r *NamespaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &servicebusv1alpha1.Namespace{}); err != nil {
			klog.Error(err, "unable to set up auditor", servicebusv1alpha1.Namespace{}.APIVersion, servicebusv1alpha1.Namespace{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&servicebusv1alpha1.Namespace{}).
...
func (r *NamespaceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Namespace")
			return nil
		}
		...
		resourceList := &servicebusv1alpha1.NamespaceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Namespace")
			return nil
		}
