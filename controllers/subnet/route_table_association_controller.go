...
// +kubebuilder:rbac:groups=subnet.azurerm.kubeform.com,resources=routetableassociations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=subnet.azurerm.kubeform.com,resources=routetableassociations/status,verbs=get;update;patch
...
func (r *RouteTableAssociationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &subnetv1alpha1.RouteTableAssociation{}); err != nil {
			klog.Error(err, "unable to set up auditor", subnetv1alpha1.RouteTableAssociation{}.APIVersion, subnetv1alpha1.RouteTableAssociation{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&subnetv1alpha1.RouteTableAssociation{}).
