...
// +kubebuilder:rbac:groups=lb.azurerm.kubeform.com,resources=rules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.azurerm.kubeform.com,resources=rules/status,verbs=get;update;patch
...
func (r *RuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lbv1alpha1.Rule{}); err != nil {
			klog.Error(err, "unable to set up auditor", lbv1alpha1.Rule{}.APIVersion, lbv1alpha1.Rule{}.Kind)
			return err
		}
	}
