...
// +kubebuilder:rbac:groups=dashboard.azurerm.kubeform.com,resources=dashboards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dashboard.azurerm.kubeform.com,resources=dashboards/status,verbs=get;update;patch
