...
// +kubebuilder:rbac:groups=application.azurerm.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=application.azurerm.kubeform.com,resources=gateways/status,verbs=get;update;patch
...
func (r *GatewayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &applicationv1alpha1.Gateway{}); err != nil {
			klog.Error(err, "unable to set up auditor", applicationv1alpha1.Gateway{}.APIVersion, applicationv1alpha1.Gateway{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&applicationv1alpha1.Gateway{}).
...
func (r *GatewayReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &applicationv1alpha1.GatewayList{}
