...
// +kubebuilder:rbac:groups=application.azurerm.kubeform.com,resources=securitygroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=application.azurerm.kubeform.com,resources=securitygroups/status,verbs=get;update;patch
...
func (r *SecurityGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &applicationv1alpha1.SecurityGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", applicationv1alpha1.SecurityGroup{}.APIVersion, applicationv1alpha1.SecurityGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&applicationv1alpha1.SecurityGroup{}).
