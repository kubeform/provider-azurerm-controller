...
// +kubebuilder:rbac:groups=static.azurerm.kubeform.com,resources=sites,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=static.azurerm.kubeform.com,resources=sites/status,verbs=get;update;patch

func (r *SiteReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("site", req.NamespacedName)
...
func (r *SiteReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &staticv1alpha1.Site{}); err != nil {
			klog.Error(err, "unable to set up auditor", staticv1alpha1.Site{}.APIVersion, staticv1alpha1.Site{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&staticv1alpha1.Site{}).
