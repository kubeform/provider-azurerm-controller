...
// +kubebuilder:rbac:groups=synapse.azurerm.kubeform.com,resources=workspaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=synapse.azurerm.kubeform.com,resources=workspaces/status,verbs=get;update;patch
...
func (r *WorkspaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &synapsev1alpha1.Workspace{}); err != nil {
			klog.Error(err, "unable to set up auditor", synapsev1alpha1.Workspace{}.APIVersion, synapsev1alpha1.Workspace{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&synapsev1alpha1.Workspace{}).
...
func (r *WorkspaceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &synapsev1alpha1.WorkspaceList{}
