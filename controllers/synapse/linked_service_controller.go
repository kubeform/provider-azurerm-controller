...
// +kubebuilder:rbac:groups=synapse.azurerm.kubeform.com,resources=linkedservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=synapse.azurerm.kubeform.com,resources=linkedservices/status,verbs=get;update;patch
...
func (r *LinkedServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &synapsev1alpha1.LinkedService{}); err != nil {
			klog.Error(err, "unable to set up auditor", synapsev1alpha1.LinkedService{}.APIVersion, synapsev1alpha1.LinkedService{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&synapsev1alpha1.LinkedService{}).
