...
// +kubebuilder:rbac:groups=iotsecurity.azurerm.kubeform.com,resources=solutions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iotsecurity.azurerm.kubeform.com,resources=solutions/status,verbs=get;update;patch
...
func (r *SolutionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iotsecurityv1alpha1.Solution{}); err != nil {
			klog.Error(err, "unable to set up auditor", iotsecurityv1alpha1.Solution{}.APIVersion, iotsecurityv1alpha1.Solution{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iotsecurityv1alpha1.Solution{}).
