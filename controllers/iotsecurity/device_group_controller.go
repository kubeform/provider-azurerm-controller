...
// +kubebuilder:rbac:groups=iotsecurity.azurerm.kubeform.com,resources=devicegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iotsecurity.azurerm.kubeform.com,resources=devicegroups/status,verbs=get;update;patch
...
func (r *DeviceGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iotsecurityv1alpha1.DeviceGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", iotsecurityv1alpha1.DeviceGroup{}.APIVersion, iotsecurityv1alpha1.DeviceGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iotsecurityv1alpha1.DeviceGroup{}).
