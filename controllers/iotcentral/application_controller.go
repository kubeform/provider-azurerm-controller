...
// +kubebuilder:rbac:groups=iotcentral.azurerm.kubeform.com,resources=applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iotcentral.azurerm.kubeform.com,resources=applications/status,verbs=get;update;patch
...
func (r *ApplicationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iotcentralv1alpha1.Application{}); err != nil {
			klog.Error(err, "unable to set up auditor", iotcentralv1alpha1.Application{}.APIVersion, iotcentralv1alpha1.Application{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iotcentralv1alpha1.Application{}).
