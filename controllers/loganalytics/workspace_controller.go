...
// +kubebuilder:rbac:groups=loganalytics.azurerm.kubeform.com,resources=workspaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loganalytics.azurerm.kubeform.com,resources=workspaces/status,verbs=get;update;patch
...
func (r *WorkspaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loganalyticsv1alpha1.Workspace{}); err != nil {
			klog.Error(err, "unable to set up auditor", loganalyticsv1alpha1.Workspace{}.APIVersion, loganalyticsv1alpha1.Workspace{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&loganalyticsv1alpha1.Workspace{}).
...
func (r *WorkspaceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Workspace")
			return nil
		}
		...
		resourceList := &loganalyticsv1alpha1.WorkspaceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Workspace")
			return nil
		}
