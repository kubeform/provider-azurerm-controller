...
// +kubebuilder:rbac:groups=template.azurerm.kubeform.com,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=template.azurerm.kubeform.com,resources=deployments/status,verbs=get;update;patch
...
func (r *DeploymentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &templatev1alpha1.Deployment{}); err != nil {
			klog.Error(err, "unable to set up auditor", templatev1alpha1.Deployment{}.APIVersion, templatev1alpha1.Deployment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&templatev1alpha1.Deployment{}).
