...
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=accounts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=accounts/status,verbs=get;update;patch
...
func (r *AccountReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Account{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Account{}.APIVersion, storagev1alpha1.Account{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.Account{}).
...
func (r *AccountReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &storagev1alpha1.AccountList{}
