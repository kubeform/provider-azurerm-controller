...
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=accountcustomermanagedkeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=accountcustomermanagedkeys/status,verbs=get;update;patch
...
func (r *AccountCustomerManagedKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.AccountCustomerManagedKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.AccountCustomerManagedKey{}.APIVersion, storagev1alpha1.AccountCustomerManagedKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.AccountCustomerManagedKey{}).
