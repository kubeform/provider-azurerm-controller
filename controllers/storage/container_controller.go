...
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=containers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=containers/status,verbs=get;update;patch
...
func (r *ContainerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Container{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Container{}.APIVersion, storagev1alpha1.Container{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.Container{}).
