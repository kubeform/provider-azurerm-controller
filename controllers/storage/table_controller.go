...
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=tables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=tables/status,verbs=get;update;patch
...
func (r *TableReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Table{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Table{}.APIVersion, storagev1alpha1.Table{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.Table{}).
