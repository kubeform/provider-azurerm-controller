...
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=queues,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=queues/status,verbs=get;update;patch
...
func (r *QueueReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Queue{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Queue{}.APIVersion, storagev1alpha1.Queue{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.Queue{}).
