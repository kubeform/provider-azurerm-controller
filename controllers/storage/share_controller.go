...
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=shares,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.azurerm.kubeform.com,resources=shares/status,verbs=get;update;patch
...
func (r *ShareReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Share{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Share{}.APIVersion, storagev1alpha1.Share{}.Kind)
			return err
		}
	}
