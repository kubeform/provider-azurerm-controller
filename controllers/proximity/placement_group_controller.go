...
// +kubebuilder:rbac:groups=proximity.azurerm.kubeform.com,resources=placementgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=proximity.azurerm.kubeform.com,resources=placementgroups/status,verbs=get;update;patch
...
func (r *PlacementGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &proximityv1alpha1.PlacementGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", proximityv1alpha1.PlacementGroup{}.APIVersion, proximityv1alpha1.PlacementGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&proximityv1alpha1.PlacementGroup{}).
