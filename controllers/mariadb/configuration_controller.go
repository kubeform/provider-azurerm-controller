...
// +kubebuilder:rbac:groups=mariadb.azurerm.kubeform.com,resources=configurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mariadb.azurerm.kubeform.com,resources=configurations/status,verbs=get;update;patch
...
func (r *ConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mariadbv1alpha1.Configuration{}); err != nil {
			klog.Error(err, "unable to set up auditor", mariadbv1alpha1.Configuration{}.APIVersion, mariadbv1alpha1.Configuration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mariadbv1alpha1.Configuration{}).
