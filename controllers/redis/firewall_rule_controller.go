...
// +kubebuilder:rbac:groups=redis.azurerm.kubeform.com,resources=firewallrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=redis.azurerm.kubeform.com,resources=firewallrules/status,verbs=get;update;patch
...
func (r *FirewallRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &redisv1alpha1.FirewallRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", redisv1alpha1.FirewallRule{}.APIVersion, redisv1alpha1.FirewallRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&redisv1alpha1.FirewallRule{}).
