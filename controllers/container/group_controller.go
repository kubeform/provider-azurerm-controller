...
// +kubebuilder:rbac:groups=container.azurerm.kubeform.com,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=container.azurerm.kubeform.com,resources=groups/status,verbs=get;update;patch
...
func (r *GroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &containerv1alpha1.Group{}); err != nil {
			klog.Error(err, "unable to set up auditor", containerv1alpha1.Group{}.APIVersion, containerv1alpha1.Group{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&containerv1alpha1.Group{}).
...
func (r *GroupReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Group")
			return nil
		}
		...
		resourceList := &containerv1alpha1.GroupList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Group")
			return nil
		}
