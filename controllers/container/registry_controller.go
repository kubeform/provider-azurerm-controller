...
// +kubebuilder:rbac:groups=container.azurerm.kubeform.com,resources=registries/status,verbs=get;update;patch
...
func (r *RegistryReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for Registry")
			return nil
		}
