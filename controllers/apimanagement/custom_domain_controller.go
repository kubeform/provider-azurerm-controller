...
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=customdomains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=customdomains/status,verbs=get;update;patch
...
func (r *CustomDomainReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.CustomDomain{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.CustomDomain{}.APIVersion, apimanagementv1alpha1.CustomDomain{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apimanagementv1alpha1.CustomDomain{}).
...
func (r *CustomDomainReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &apimanagementv1alpha1.CustomDomainList{}
