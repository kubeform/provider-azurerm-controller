...
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=apis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=apis/status,verbs=get;update;patch
...
func (r *ApiReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.Api{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.Api{}.APIVersion, apimanagementv1alpha1.Api{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apimanagementv1alpha1.Api{}).
