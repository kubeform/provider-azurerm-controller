...
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=subscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=subscriptions/status,verbs=get;update;patch
...
func (r *SubscriptionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.Subscription{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.Subscription{}.APIVersion, apimanagementv1alpha1.Subscription{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apimanagementv1alpha1.Subscription{}).
...
func (r *SubscriptionReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Subscription")
			return nil
		}
		...
		resourceList := &apimanagementv1alpha1.SubscriptionList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Subscription")
			return nil
		}
