...
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=users/status,verbs=get;update;patch
...
func (r *UserReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.User{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.User{}.APIVersion, apimanagementv1alpha1.User{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apimanagementv1alpha1.User{}).
...
func (r *UserReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &apimanagementv1alpha1.UserList{}
