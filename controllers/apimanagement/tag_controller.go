...
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=tags,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=tags/status,verbs=get;update;patch
...
func (r *TagReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.Tag{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.Tag{}.APIVersion, apimanagementv1alpha1.Tag{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apimanagementv1alpha1.Tag{}).
