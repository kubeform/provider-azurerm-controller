...
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=backends,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=backends/status,verbs=get;update;patch
...
func (r *BackendReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.Backend{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.Backend{}.APIVersion, apimanagementv1alpha1.Backend{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apimanagementv1alpha1.Backend{}).
...
func (r *BackendReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Backend")
			return nil
		}
		...
		resourceList := &apimanagementv1alpha1.BackendList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Backend")
			return nil
		}
