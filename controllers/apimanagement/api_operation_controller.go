...
func (r *ApiOperationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.ApiOperation{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.ApiOperation{}.APIVersion, apimanagementv1alpha1.ApiOperation{}.Kind)
			return err
		}
	}
