...
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azurerm.kubeform.com,resources=groups/status,verbs=get;update;patch
...
func (r *GroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apimanagementv1alpha1.Group{}); err != nil {
			klog.Error(err, "unable to set up auditor", apimanagementv1alpha1.Group{}.APIVersion, apimanagementv1alpha1.Group{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apimanagementv1alpha1.Group{}).
