...
// +kubebuilder:rbac:groups=ssh.azurerm.kubeform.com,resources=publickeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssh.azurerm.kubeform.com,resources=publickeys/status,verbs=get;update;patch
...
func (r *PublicKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sshv1alpha1.PublicKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", sshv1alpha1.PublicKey{}.APIVersion, sshv1alpha1.PublicKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sshv1alpha1.PublicKey{}).
