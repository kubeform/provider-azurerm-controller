...
// +kubebuilder:rbac:groups=publicip.azurerm.kubeform.com,resources=publicips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=publicip.azurerm.kubeform.com,resources=publicips/status,verbs=get;update;patch
...
func (r *PublicIPReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &publicipv1alpha1.PublicIP{}); err != nil {
			klog.Error(err, "unable to set up auditor", publicipv1alpha1.PublicIP{}.APIVersion, publicipv1alpha1.PublicIP{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&publicipv1alpha1.PublicIP{}).
