...
// +kubebuilder:rbac:groups=route.azurerm.kubeform.com,resources=tables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route.azurerm.kubeform.com,resources=tables/status,verbs=get;update;patch
