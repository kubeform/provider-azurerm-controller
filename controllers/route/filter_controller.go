...
// +kubebuilder:rbac:groups=route.azurerm.kubeform.com,resources=filters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route.azurerm.kubeform.com,resources=filters/status,verbs=get;update;patch
...
func (r *FilterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &routev1alpha1.Filter{}); err != nil {
			klog.Error(err, "unable to set up auditor", routev1alpha1.Filter{}.APIVersion, routev1alpha1.Filter{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&routev1alpha1.Filter{}).
