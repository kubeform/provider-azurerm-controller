...
// +kubebuilder:rbac:groups=route.azurerm.kubeform.com,resources=routes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route.azurerm.kubeform.com,resources=routes/status,verbs=get;update;patch
