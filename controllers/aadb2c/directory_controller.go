...
// +kubebuilder:rbac:groups=aadb2c.azurerm.kubeform.com,resources=directories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=aadb2c.azurerm.kubeform.com,resources=directories/status,verbs=get;update;patch
...
func (r *DirectoryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &aadb2cv1alpha1.Directory{}); err != nil {
			klog.Error(err, "unable to set up auditor", aadb2cv1alpha1.Directory{}.APIVersion, aadb2cv1alpha1.Directory{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&aadb2cv1alpha1.Directory{}).
