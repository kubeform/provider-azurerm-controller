...
// +kubebuilder:rbac:groups=private.azurerm.kubeform.com,resources=endpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=private.azurerm.kubeform.com,resources=endpoints/status,verbs=get;update;patch
...
func (r *EndpointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &privatev1alpha1.Endpoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", privatev1alpha1.Endpoint{}.APIVersion, privatev1alpha1.Endpoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&privatev1alpha1.Endpoint{}).
