...
// +kubebuilder:rbac:groups=siterecovery.azurerm.kubeform.com,resources=replicationpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=siterecovery.azurerm.kubeform.com,resources=replicationpolicies/status,verbs=get;update;patch
...
func (r *ReplicationPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &siterecoveryv1alpha1.ReplicationPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", siterecoveryv1alpha1.ReplicationPolicy{}.APIVersion, siterecoveryv1alpha1.ReplicationPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&siterecoveryv1alpha1.ReplicationPolicy{}).
