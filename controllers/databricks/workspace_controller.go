...
// +kubebuilder:rbac:groups=databricks.azurerm.kubeform.com,resources=workspaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=databricks.azurerm.kubeform.com,resources=workspaces/status,verbs=get;update;patch
...
func (r *WorkspaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &databricksv1alpha1.Workspace{}); err != nil {
			klog.Error(err, "unable to set up auditor", databricksv1alpha1.Workspace{}.APIVersion, databricksv1alpha1.Workspace{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&databricksv1alpha1.Workspace{}).
...
func (r *WorkspaceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &databricksv1alpha1.WorkspaceList{}
