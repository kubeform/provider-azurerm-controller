...
// +kubebuilder:rbac:groups=dedicatedhost.azurerm.kubeform.com,resources=dedicatedhosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dedicatedhost.azurerm.kubeform.com,resources=dedicatedhosts/status,verbs=get;update;patch
...
func (r *DedicatedHostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dedicatedhostv1alpha1.DedicatedHost{}); err != nil {
			klog.Error(err, "unable to set up auditor", dedicatedhostv1alpha1.DedicatedHost{}.APIVersion, dedicatedhostv1alpha1.DedicatedHost{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dedicatedhostv1alpha1.DedicatedHost{}).
