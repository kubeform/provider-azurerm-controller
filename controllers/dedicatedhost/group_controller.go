...
// +kubebuilder:rbac:groups=dedicatedhost.azurerm.kubeform.com,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dedicatedhost.azurerm.kubeform.com,resources=groups/status,verbs=get;update;patch
...
func (r *GroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dedicatedhostv1alpha1.Group{}); err != nil {
			klog.Error(err, "unable to set up auditor", dedicatedhostv1alpha1.Group{}.APIVersion, dedicatedhostv1alpha1.Group{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dedicatedhostv1alpha1.Group{}).
