...
// +kubebuilder:rbac:groups=signalr.azurerm.kubeform.com,resources=services,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=signalr.azurerm.kubeform.com,resources=services/status,verbs=get;update;patch
...
func (r *ServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &signalrv1alpha1.Service{}); err != nil {
			klog.Error(err, "unable to set up auditor", signalrv1alpha1.Service{}.APIVersion, signalrv1alpha1.Service{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&signalrv1alpha1.Service{}).
...
func (r *ServiceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Service")
			return nil
		}
		...
		resourceList := &signalrv1alpha1.ServiceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Service")
			return nil
		}
