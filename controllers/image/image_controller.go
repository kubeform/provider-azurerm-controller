...
// +kubebuilder:rbac:groups=image.azurerm.kubeform.com,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=image.azurerm.kubeform.com,resources=images/status,verbs=get;update;patch
