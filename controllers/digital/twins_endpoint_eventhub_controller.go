...
// TwinsEndpointEventhubReconciler reconciles a TwinsEndpointEventhub object
type TwinsEndpointEventhubReconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=digital.azurerm.kubeform.com,resources=twinsendpointeventhubs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=digital.azurerm.kubeform.com,resources=twinsendpointeventhubs/status,verbs=get;update;patch

func (r *TwinsEndpointEventhubReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("twinsendpointeventhub", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch TwinsEndpointEventhub")
...
func (r *TwinsEndpointEventhubReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &digitalv1alpha1.TwinsEndpointEventhub{}); err != nil {
			klog.Error(err, "unable to set up auditor", digitalv1alpha1.TwinsEndpointEventhub{}.APIVersion, digitalv1alpha1.TwinsEndpointEventhub{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&digitalv1alpha1.TwinsEndpointEventhub{}).
...
func (r *TwinsEndpointEventhubReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for TwinsEndpointEventhub")
			return nil
		}
		...
		resourceList := &digitalv1alpha1.TwinsEndpointEventhubList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list TwinsEndpointEventhub")
			return nil
		}
