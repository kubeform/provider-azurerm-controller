...
// +kubebuilder:rbac:groups=dns.azurerm.kubeform.com,resources=zones,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.azurerm.kubeform.com,resources=zones/status,verbs=get;update;patch
