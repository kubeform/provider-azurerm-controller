...
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=credentials,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=credentials/status,verbs=get;update;patch
...
func (r *CredentialReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &automationv1alpha1.Credential{}); err != nil {
			klog.Error(err, "unable to set up auditor", automationv1alpha1.Credential{}.APIVersion, automationv1alpha1.Credential{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&automationv1alpha1.Credential{}).
...
func (r *CredentialReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Credential")
			return nil
		}
		...
		resourceList := &automationv1alpha1.CredentialList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Credential")
			return nil
		}
