...
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=webhooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=webhooks/status,verbs=get;update;patch
...
func (r *WebhookReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &automationv1alpha1.Webhook{}); err != nil {
			klog.Error(err, "unable to set up auditor", automationv1alpha1.Webhook{}.APIVersion, automationv1alpha1.Webhook{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&automationv1alpha1.Webhook{}).
...
func (r *WebhookReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &automationv1alpha1.WebhookList{}
