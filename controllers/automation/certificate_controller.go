...
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=certificates/status,verbs=get;update;patch
...
func (r *CertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &automationv1alpha1.Certificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", automationv1alpha1.Certificate{}.APIVersion, automationv1alpha1.Certificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&automationv1alpha1.Certificate{}).
...
func (r *CertificateReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &automationv1alpha1.CertificateList{}
