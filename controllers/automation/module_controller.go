...
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=modules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=automation.azurerm.kubeform.com,resources=modules/status,verbs=get;update;patch
...
func (r *ModuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &automationv1alpha1.Module{}); err != nil {
			klog.Error(err, "unable to set up auditor", automationv1alpha1.Module{}.APIVersion, automationv1alpha1.Module{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&automationv1alpha1.Module{}).
