...
// +kubebuilder:rbac:groups=mysql.azurerm.kubeform.com,resources=firewallrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mysql.azurerm.kubeform.com,resources=firewallrules/status,verbs=get;update;patch
...
func (r *FirewallRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mysqlv1alpha1.FirewallRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", mysqlv1alpha1.FirewallRule{}.APIVersion, mysqlv1alpha1.FirewallRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mysqlv1alpha1.FirewallRule{}).
