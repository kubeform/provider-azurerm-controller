...
// +kubebuilder:rbac:groups=mysql.azurerm.kubeform.com,resources=virtualnetworkrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mysql.azurerm.kubeform.com,resources=virtualnetworkrules/status,verbs=get;update;patch
...
func (r *VirtualNetworkRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mysqlv1alpha1.VirtualNetworkRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", mysqlv1alpha1.VirtualNetworkRule{}.APIVersion, mysqlv1alpha1.VirtualNetworkRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mysqlv1alpha1.VirtualNetworkRule{}).
