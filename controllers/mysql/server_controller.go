...
// +kubebuilder:rbac:groups=mysql.azurerm.kubeform.com,resources=servers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mysql.azurerm.kubeform.com,resources=servers/status,verbs=get;update;patch
...
func (r *ServerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mysqlv1alpha1.Server{}); err != nil {
			klog.Error(err, "unable to set up auditor", mysqlv1alpha1.Server{}.APIVersion, mysqlv1alpha1.Server{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mysqlv1alpha1.Server{}).
...
func (r *ServerReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &mysqlv1alpha1.ServerList{}
