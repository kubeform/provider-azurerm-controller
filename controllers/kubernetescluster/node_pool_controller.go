...
// +kubebuilder:rbac:groups=kubernetescluster.azurerm.kubeform.com,resources=nodepools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubernetescluster.azurerm.kubeform.com,resources=nodepools/status,verbs=get;update;patch
...
func (r *NodePoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &kubernetesclusterv1alpha1.NodePool{}); err != nil {
			klog.Error(err, "unable to set up auditor", kubernetesclusterv1alpha1.NodePool{}.APIVersion, kubernetesclusterv1alpha1.NodePool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&kubernetesclusterv1alpha1.NodePool{}).
