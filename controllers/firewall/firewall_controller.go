...
// +kubebuilder:rbac:groups=firewall.azurerm.kubeform.com,resources=firewalls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=firewall.azurerm.kubeform.com,resources=firewalls/status,verbs=get;update;patch
