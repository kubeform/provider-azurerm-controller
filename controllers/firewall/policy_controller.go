...
// +kubebuilder:rbac:groups=firewall.azurerm.kubeform.com,resources=policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=firewall.azurerm.kubeform.com,resources=policies/status,verbs=get;update;patch
