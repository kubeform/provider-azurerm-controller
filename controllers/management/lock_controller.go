...
// +kubebuilder:rbac:groups=management.azurerm.kubeform.com,resources=locks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=management.azurerm.kubeform.com,resources=locks/status,verbs=get;update;patch
...
func (r *LockReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &managementv1alpha1.Lock{}); err != nil {
			klog.Error(err, "unable to set up auditor", managementv1alpha1.Lock{}.APIVersion, managementv1alpha1.Lock{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&managementv1alpha1.Lock{}).
