...
// +kubebuilder:rbac:groups=availability.azurerm.kubeform.com,resources=sets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=availability.azurerm.kubeform.com,resources=sets/status,verbs=get;update;patch
...
func (r *SetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &availabilityv1alpha1.Set{}); err != nil {
			klog.Error(err, "unable to set up auditor", availabilityv1alpha1.Set{}.APIVersion, availabilityv1alpha1.Set{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&availabilityv1alpha1.Set{}).
