...
// +kubebuilder:rbac:groups=role.azurerm.kubeform.com,resources=assignments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=role.azurerm.kubeform.com,resources=assignments/status,verbs=get;update;patch
...
func (r *AssignmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rolev1alpha1.Assignment{}); err != nil {
			klog.Error(err, "unable to set up auditor", rolev1alpha1.Assignment{}.APIVersion, rolev1alpha1.Assignment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rolev1alpha1.Assignment{}).
