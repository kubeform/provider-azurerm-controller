...
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=managedinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=managedinstances/status,verbs=get;update;patch
...
func (r *ManagedInstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sqlv1alpha1.ManagedInstance{}); err != nil {
			klog.Error(err, "unable to set up auditor", sqlv1alpha1.ManagedInstance{}.APIVersion, sqlv1alpha1.ManagedInstance{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sqlv1alpha1.ManagedInstance{}).
...
func (r *ManagedInstanceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &sqlv1alpha1.ManagedInstanceList{}
