...
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=failovergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=failovergroups/status,verbs=get;update;patch
...
func (r *FailoverGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sqlv1alpha1.FailoverGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", sqlv1alpha1.FailoverGroup{}.APIVersion, sqlv1alpha1.FailoverGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sqlv1alpha1.FailoverGroup{}).
