...
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=managedinstancefailovergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=managedinstancefailovergroups/status,verbs=get;update;patch
...
func (r *ManagedInstanceFailoverGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sqlv1alpha1.ManagedInstanceFailoverGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", sqlv1alpha1.ManagedInstanceFailoverGroup{}.APIVersion, sqlv1alpha1.ManagedInstanceFailoverGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sqlv1alpha1.ManagedInstanceFailoverGroup{}).
