...
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=elasticpools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=elasticpools/status,verbs=get;update;patch
...
func (r *ElasticpoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sqlv1alpha1.Elasticpool{}); err != nil {
			klog.Error(err, "unable to set up auditor", sqlv1alpha1.Elasticpool{}.APIVersion, sqlv1alpha1.Elasticpool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sqlv1alpha1.Elasticpool{}).
