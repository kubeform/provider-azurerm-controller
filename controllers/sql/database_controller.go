...
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=databases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sql.azurerm.kubeform.com,resources=databases/status,verbs=get;update;patch
...
func (r *DatabaseReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &sqlv1alpha1.DatabaseList{}
