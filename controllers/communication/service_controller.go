...
// +kubebuilder:rbac:groups=communication.azurerm.kubeform.com,resources=services,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=communication.azurerm.kubeform.com,resources=services/status,verbs=get;update;patch
...
func (r *ServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &communicationv1alpha1.Service{}); err != nil {
			klog.Error(err, "unable to set up auditor", communicationv1alpha1.Service{}.APIVersion, communicationv1alpha1.Service{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&communicationv1alpha1.Service{}).
