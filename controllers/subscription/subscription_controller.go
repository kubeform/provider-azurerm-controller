...
// +kubebuilder:rbac:groups=subscription.azurerm.kubeform.com,resources=subscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=subscription.azurerm.kubeform.com,resources=subscriptions/status,verbs=get;update;patch
