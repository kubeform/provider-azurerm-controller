...
// +kubebuilder:rbac:groups=media.azurerm.kubeform.com,resources=assets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=media.azurerm.kubeform.com,resources=assets/status,verbs=get;update;patch
...
func (r *AssetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Asset")
...
func (r *AssetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mediav1alpha1.Asset{}); err != nil {
			klog.Error(err, "unable to set up auditor", mediav1alpha1.Asset{}.APIVersion, mediav1alpha1.Asset{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mediav1alpha1.Asset{}).
