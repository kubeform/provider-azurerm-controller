...
// +kubebuilder:rbac:groups=postgresql.azurerm.kubeform.com,resources=firewallrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=postgresql.azurerm.kubeform.com,resources=firewallrules/status,verbs=get;update;patch
...
func (r *FirewallRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &postgresqlv1alpha1.FirewallRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", postgresqlv1alpha1.FirewallRule{}.APIVersion, postgresqlv1alpha1.FirewallRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&postgresqlv1alpha1.FirewallRule{}).
