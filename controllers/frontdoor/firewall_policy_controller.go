...
// +kubebuilder:rbac:groups=frontdoor.azurerm.kubeform.com,resources=firewallpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=frontdoor.azurerm.kubeform.com,resources=firewallpolicies/status,verbs=get;update;patch
...
func (r *FirewallPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &frontdoorv1alpha1.FirewallPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", frontdoorv1alpha1.FirewallPolicy{}.APIVersion, frontdoorv1alpha1.FirewallPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&frontdoorv1alpha1.FirewallPolicy{}).
