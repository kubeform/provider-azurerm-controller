...
// +kubebuilder:rbac:groups=frontdoor.azurerm.kubeform.com,resources=rulesengines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=frontdoor.azurerm.kubeform.com,resources=rulesengines/status,verbs=get;update;patch
...
func (r *RulesEngineReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch RulesEngine")
...
func (r *RulesEngineReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &frontdoorv1alpha1.RulesEngine{}); err != nil {
			klog.Error(err, "unable to set up auditor", frontdoorv1alpha1.RulesEngine{}.APIVersion, frontdoorv1alpha1.RulesEngine{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&frontdoorv1alpha1.RulesEngine{}).
