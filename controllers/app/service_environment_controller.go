...
// +kubebuilder:rbac:groups=app.azurerm.kubeform.com,resources=serviceenvironments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=app.azurerm.kubeform.com,resources=serviceenvironments/status,verbs=get;update;patch
...
func (r *ServiceEnvironmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appv1alpha1.ServiceEnvironment{}); err != nil {
			klog.Error(err, "unable to set up auditor", appv1alpha1.ServiceEnvironment{}.APIVersion, appv1alpha1.ServiceEnvironment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appv1alpha1.ServiceEnvironment{}).
