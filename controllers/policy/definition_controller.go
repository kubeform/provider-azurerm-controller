...
// +kubebuilder:rbac:groups=policy.azurerm.kubeform.com,resources=definitions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=policy.azurerm.kubeform.com,resources=definitions/status,verbs=get;update;patch
...
func (r *DefinitionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &policyv1alpha1.Definition{}); err != nil {
			klog.Error(err, "unable to set up auditor", policyv1alpha1.Definition{}.APIVersion, policyv1alpha1.Definition{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&policyv1alpha1.Definition{}).
