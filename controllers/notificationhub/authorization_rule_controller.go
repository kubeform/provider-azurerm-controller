...
// +kubebuilder:rbac:groups=notificationhub.azurerm.kubeform.com,resources=authorizationrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=notificationhub.azurerm.kubeform.com,resources=authorizationrules/status,verbs=get;update;patch
...
func (r *AuthorizationRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &notificationhubv1alpha1.AuthorizationRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", notificationhubv1alpha1.AuthorizationRule{}.APIVersion, notificationhubv1alpha1.AuthorizationRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&notificationhubv1alpha1.AuthorizationRule{}).
