...
// +kubebuilder:rbac:groups=notificationhub.azurerm.kubeform.com,resources=namespace_s,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=notificationhub.azurerm.kubeform.com,resources=namespace_s/status,verbs=get;update;patch
...
func (r *Namespace_Reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &notificationhubv1alpha1.Namespace_{}); err != nil {
			klog.Error(err, "unable to set up auditor", notificationhubv1alpha1.Namespace_{}.APIVersion, notificationhubv1alpha1.Namespace_{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&notificationhubv1alpha1.Namespace_{}).
