...
// +kubebuilder:rbac:groups=notificationhub.azurerm.kubeform.com,resources=namespaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=notificationhub.azurerm.kubeform.com,resources=namespaces/status,verbs=get;update;patch
...
func (r *NamespaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &notificationhubv1alpha1.Namespace{}); err != nil {
			klog.Error(err, "unable to set up auditor", notificationhubv1alpha1.Namespace{}.APIVersion, notificationhubv1alpha1.Namespace{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&notificationhubv1alpha1.Namespace{}).
