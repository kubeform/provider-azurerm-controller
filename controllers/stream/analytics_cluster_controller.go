...
// +kubebuilder:rbac:groups=stream.azurerm.kubeform.com,resources=analyticsclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=stream.azurerm.kubeform.com,resources=analyticsclusters/status,verbs=get;update;patch
...
func (r *AnalyticsClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &streamv1alpha1.AnalyticsCluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", streamv1alpha1.AnalyticsCluster{}.APIVersion, streamv1alpha1.AnalyticsCluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&streamv1alpha1.AnalyticsCluster{}).
