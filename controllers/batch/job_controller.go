...
// +kubebuilder:rbac:groups=batch.azurerm.kubeform.com,resources=jobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=batch.azurerm.kubeform.com,resources=jobs/status,verbs=get;update;patch
...
func (r *JobReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &batchv1alpha1.Job{}); err != nil {
			klog.Error(err, "unable to set up auditor", batchv1alpha1.Job{}.APIVersion, batchv1alpha1.Job{}.Kind)
			return err
		}
	}
