...
// +kubebuilder:rbac:groups=batch.azurerm.kubeform.com,resources=pools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=batch.azurerm.kubeform.com,resources=pools/status,verbs=get;update;patch
...
func (r *PoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &batchv1alpha1.Pool{}); err != nil {
			klog.Error(err, "unable to set up auditor", batchv1alpha1.Pool{}.APIVersion, batchv1alpha1.Pool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&batchv1alpha1.Pool{}).
...
func (r *PoolReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Pool")
			return nil
		}
