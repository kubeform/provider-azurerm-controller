...
// +kubebuilder:rbac:groups=function.azurerm.kubeform.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=function.azurerm.kubeform.com,resources=apps/status,verbs=get;update;patch
...
func (r *AppReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &functionv1alpha1.App{}); err != nil {
			klog.Error(err, "unable to set up auditor", functionv1alpha1.App{}.APIVersion, functionv1alpha1.App{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&functionv1alpha1.App{}).
...
func (r *AppReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &functionv1alpha1.AppList{}
