...
// +kubebuilder:rbac:groups=snapshot.azurerm.kubeform.com,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=snapshot.azurerm.kubeform.com,resources=snapshots/status,verbs=get;update;patch
