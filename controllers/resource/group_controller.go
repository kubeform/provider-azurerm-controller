...
// +kubebuilder:rbac:groups=resource.azurerm.kubeform.com,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=resource.azurerm.kubeform.com,resources=groups/status,verbs=get;update;patch
