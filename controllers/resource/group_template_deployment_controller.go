...
// +kubebuilder:rbac:groups=resource.azurerm.kubeform.com,resources=grouptemplatedeployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=resource.azurerm.kubeform.com,resources=grouptemplatedeployments/status,verbs=get;update;patch
...
func (r *GroupTemplateDeploymentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &resourcev1alpha1.GroupTemplateDeployment{}); err != nil {
			klog.Error(err, "unable to set up auditor", resourcev1alpha1.GroupTemplateDeployment{}.APIVersion, resourcev1alpha1.GroupTemplateDeployment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&resourcev1alpha1.GroupTemplateDeployment{}).
