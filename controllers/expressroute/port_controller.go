...
// +kubebuilder:rbac:groups=expressroute.azurerm.kubeform.com,resources=ports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=expressroute.azurerm.kubeform.com,resources=ports/status,verbs=get;update;patch
...
func (r *PortReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &expressroutev1alpha1.Port{}); err != nil {
			klog.Error(err, "unable to set up auditor", expressroutev1alpha1.Port{}.APIVersion, expressroutev1alpha1.Port{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&expressroutev1alpha1.Port{}).
