...
// +kubebuilder:rbac:groups=expressroute.azurerm.kubeform.com,resources=circuits,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=expressroute.azurerm.kubeform.com,resources=circuits/status,verbs=get;update;patch
...
func (r *CircuitReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &expressroutev1alpha1.Circuit{}); err != nil {
			klog.Error(err, "unable to set up auditor", expressroutev1alpha1.Circuit{}.APIVersion, expressroutev1alpha1.Circuit{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&expressroutev1alpha1.Circuit{}).
...
func (r *CircuitReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Circuit")
			return nil
		}
		...
		resourceList := &expressroutev1alpha1.CircuitList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Circuit")
			return nil
		}
