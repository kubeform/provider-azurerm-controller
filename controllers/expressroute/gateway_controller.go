...
// +kubebuilder:rbac:groups=expressroute.azurerm.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=expressroute.azurerm.kubeform.com,resources=gateways/status,verbs=get;update;patch
...
func (r *GatewayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &expressroutev1alpha1.Gateway{}); err != nil {
			klog.Error(err, "unable to set up auditor", expressroutev1alpha1.Gateway{}.APIVersion, expressroutev1alpha1.Gateway{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&expressroutev1alpha1.Gateway{}).
