...
// +kubebuilder:rbac:groups=trafficmanager.azurerm.kubeform.com,resources=endpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=trafficmanager.azurerm.kubeform.com,resources=endpoints/status,verbs=get;update;patch
...
func (r *EndpointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &trafficmanagerv1alpha1.Endpoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", trafficmanagerv1alpha1.Endpoint{}.APIVersion, trafficmanagerv1alpha1.Endpoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&trafficmanagerv1alpha1.Endpoint{}).
