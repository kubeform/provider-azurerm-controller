...
// +kubebuilder:rbac:groups=trafficmanager.azurerm.kubeform.com,resources=profiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=trafficmanager.azurerm.kubeform.com,resources=profiles/status,verbs=get;update;patch
...
func (r *ProfileReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &trafficmanagerv1alpha1.Profile{}); err != nil {
			klog.Error(err, "unable to set up auditor", trafficmanagerv1alpha1.Profile{}.APIVersion, trafficmanagerv1alpha1.Profile{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&trafficmanagerv1alpha1.Profile{}).
