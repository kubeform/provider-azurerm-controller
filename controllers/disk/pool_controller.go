...
// +kubebuilder:rbac:groups=disk.azurerm.kubeform.com,resources=pools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=disk.azurerm.kubeform.com,resources=pools/status,verbs=get;update;patch
...
func (r *PoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &diskv1alpha1.Pool{}); err != nil {
			klog.Error(err, "unable to set up auditor", diskv1alpha1.Pool{}.APIVersion, diskv1alpha1.Pool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&diskv1alpha1.Pool{}).
