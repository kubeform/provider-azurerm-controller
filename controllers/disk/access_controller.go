...
// +kubebuilder:rbac:groups=disk.azurerm.kubeform.com,resources=accesses,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=disk.azurerm.kubeform.com,resources=accesses/status,verbs=get;update;patch
...
func (r *AccessReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &diskv1alpha1.Access{}); err != nil {
			klog.Error(err, "unable to set up auditor", diskv1alpha1.Access{}.APIVersion, diskv1alpha1.Access{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&diskv1alpha1.Access{}).
