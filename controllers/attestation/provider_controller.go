...
// +kubebuilder:rbac:groups=attestation.azurerm.kubeform.com,resources=providers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=attestation.azurerm.kubeform.com,resources=providers/status,verbs=get;update;patch
...
func (r *ProviderReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &attestationv1alpha1.Provider{}); err != nil {
			klog.Error(err, "unable to set up auditor", attestationv1alpha1.Provider{}.APIVersion, attestationv1alpha1.Provider{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&attestationv1alpha1.Provider{}).
