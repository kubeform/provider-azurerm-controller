...
// +kubebuilder:rbac:groups=nat.azurerm.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nat.azurerm.kubeform.com,resources=gateways/status,verbs=get;update;patch
