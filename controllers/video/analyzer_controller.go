...
// +kubebuilder:rbac:groups=video.azurerm.kubeform.com,resources=analyzers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=video.azurerm.kubeform.com,resources=analyzers/status,verbs=get;update;patch
...
func (r *AnalyzerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &videov1alpha1.Analyzer{}); err != nil {
			klog.Error(err, "unable to set up auditor", videov1alpha1.Analyzer{}.APIVersion, videov1alpha1.Analyzer{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&videov1alpha1.Analyzer{}).
