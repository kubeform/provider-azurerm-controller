...
// +kubebuilder:rbac:groups=cosmosdb.azurerm.kubeform.com,resources=sqldatabases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cosmosdb.azurerm.kubeform.com,resources=sqldatabases/status,verbs=get;update;patch
...
func (r *SqlDatabaseReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cosmosdbv1alpha1.SqlDatabase{}); err != nil {
			klog.Error(err, "unable to set up auditor", cosmosdbv1alpha1.SqlDatabase{}.APIVersion, cosmosdbv1alpha1.SqlDatabase{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cosmosdbv1alpha1.SqlDatabase{}).
