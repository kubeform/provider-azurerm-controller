...
import (
	...
	azurermscheme "kubeform.dev/provider-azurerm-api/client/clientset/versioned/scheme"
...
func init() {
	...
	_ = azurermscheme.AddToScheme(scheme)
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "5b87adeb.azurerm.kubeform.com", // 5b87adeb needs to be dynamically generated for each controller
			})
			if err != nil {
