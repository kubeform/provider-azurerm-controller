...
func (in *FlexibleServerDatabaseSpec) DeepCopyInto(out *FlexibleServerDatabaseSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FlexibleServerDatabaseSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlexibleServerDatabaseSpecResource) DeepCopyInto(out *FlexibleServerDatabaseSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlexibleServerDatabaseSpecResource.
func (in *FlexibleServerDatabaseSpecResource) DeepCopy() *FlexibleServerDatabaseSpecResource {
	if in == nil {
		return nil
	}
	out := new(FlexibleServerDatabaseSpecResource)
