...
type DirectoryDomainServiceReplicaSet struct {
	...
	Spec              DirectoryDomainServiceReplicaSetSpec   `json:"spec,omitempty"`
	Status            DirectoryDomainServiceReplicaSetStatus `json:"status,omitempty"`
}

type DirectoryDomainServiceReplicaSetSpec struct {
	State *DirectoryDomainServiceReplicaSetSpecResource `json:"state,omitempty" tf:"-"`

	Resource DirectoryDomainServiceReplicaSetSpecResource `json:"resource" tf:"resource"`
...
type DirectoryDomainServiceReplicaSetSpecResource struct {
...
// DirectoryDomainServiceReplicaSetList is a list of DirectoryDomainServiceReplicaSets
type DirectoryDomainServiceReplicaSetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of DirectoryDomainServiceReplicaSet CRD objects
	Items []DirectoryDomainServiceReplicaSet `json:"items,omitempty"`
}
