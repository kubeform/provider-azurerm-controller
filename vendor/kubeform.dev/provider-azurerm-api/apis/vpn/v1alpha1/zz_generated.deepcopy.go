...
func (in *GatewayConnectionSpecResource) DeepCopyInto(out *GatewayConnectionSpecResource) {
	*out = *in
	...
	if in.TrafficSelectorPolicy != nil {
		...
		*out = make([]GatewayConnectionSpecTrafficSelectorPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GatewayConnectionSpecRouting) DeepCopyInto(out *GatewayConnectionSpecRouting) {
	*out = *in
	...
	if in.PropagatedRouteTable != nil {
		...
		*out = new(GatewayConnectionSpecRoutingPropagatedRouteTable)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayConnectionSpecRoutingPropagatedRouteTable) DeepCopyInto(out *GatewayConnectionSpecRoutingPropagatedRouteTable) {
	*out = *in
	if in.Labels != nil {
...
func (in *GatewayConnectionSpecRoutingPropagatedRouteTable) DeepCopy() *GatewayConnectionSpecRoutingPropagatedRouteTable {
	if in == nil {
		return nil
	}
	out := new(GatewayConnectionSpecRoutingPropagatedRouteTable)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayConnectionSpecTrafficSelectorPolicy) DeepCopyInto(out *GatewayConnectionSpecTrafficSelectorPolicy) {
	*out = *in
...
func (in *GatewayConnectionSpecTrafficSelectorPolicy) DeepCopy() *GatewayConnectionSpecTrafficSelectorPolicy {
	if in == nil {
		return nil
	}
	out := new(GatewayConnectionSpecTrafficSelectorPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GatewayNATRuleList) DeepCopyInto(out *GatewayNATRuleList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]GatewayNATRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GatewayNATRuleSpec) DeepCopyInto(out *GatewayNATRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(GatewayNATRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *GatewayNATRuleSpec) DeepCopy() *GatewayNATRuleSpec {
	...
	out := new(GatewayNATRuleSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayNATRuleSpecResource) DeepCopyInto(out *GatewayNATRuleSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
	...
	if in.ExternalAddressSpaceMappings != nil {
		in, out := &in.ExternalAddressSpaceMappings, &out.ExternalAddressSpaceMappings
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.InternalAddressSpaceMappings != nil {
		in, out := &in.InternalAddressSpaceMappings, &out.InternalAddressSpaceMappings
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *GatewayNATRuleSpecResource) DeepCopy() *GatewayNATRuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(GatewayNATRuleSpecResource)
...
func (in *GatewayNATRuleStatus) DeepCopy() *GatewayNATRuleStatus {
	if in == nil {
		return nil
	}
	out := new(GatewayNATRuleStatus)
	in.DeepCopyInto(out)
	return out
}
