...
func (in *AutomationRuleSpec) DeepCopyInto(out *AutomationRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(AutomationRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomationRuleSpecActionIncident) DeepCopyInto(out *AutomationRuleSpecActionIncident) {
	*out = *in
...
func (in *AutomationRuleSpecActionIncident) DeepCopy() *AutomationRuleSpecActionIncident {
	if in == nil {
		return nil
	}
	out := new(AutomationRuleSpecActionIncident)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomationRuleSpecActionPlaybook) DeepCopyInto(out *AutomationRuleSpecActionPlaybook) {
	*out = *in
...
func (in *AutomationRuleSpecActionPlaybook) DeepCopy() *AutomationRuleSpecActionPlaybook {
	if in == nil {
		return nil
	}
	out := new(AutomationRuleSpecActionPlaybook)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomationRuleSpecCondition) DeepCopyInto(out *AutomationRuleSpecCondition) {
	*out = *in
	if in.Operator != nil {
...
func (in *AutomationRuleSpecCondition) DeepCopy() *AutomationRuleSpecCondition {
	if in == nil {
		return nil
	}
	out := new(AutomationRuleSpecCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomationRuleSpecResource) DeepCopyInto(out *AutomationRuleSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
	...
	if in.ActionIncident != nil {
		...
		*out = make([]AutomationRuleSpecActionIncident, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ActionPlaybook != nil {
		...
		*out = make([]AutomationRuleSpecActionPlaybook, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Condition != nil {
		...
		*out = make([]AutomationRuleSpecCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutomationRuleSpecResource) DeepCopy() *AutomationRuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(AutomationRuleSpecResource)
...
func (in *WatchlistItemSpec) DeepCopyInto(out *WatchlistItemSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(WatchlistItemSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *WatchlistItemSpec) DeepCopy() *WatchlistItemSpec {
	...
	out := new(WatchlistItemSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WatchlistItemSpecResource) DeepCopyInto(out *WatchlistItemSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
	...
	if in.WatchlistID != nil {
		in, out := &in.WatchlistID, &out.WatchlistID
		*out = new(string)
		**out = **in
	}
	return
...
func (in *WatchlistItemSpecResource) DeepCopy() *WatchlistItemSpecResource {
	if in == nil {
		return nil
	}
	out := new(WatchlistItemSpecResource)
...
func (in *WatchlistSpecResource) DeepCopy() *WatchlistSpecResource {
	if in == nil {
		return nil
	}
	out := new(WatchlistSpecResource)
