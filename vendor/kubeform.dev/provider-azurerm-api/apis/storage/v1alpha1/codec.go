...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		...
		jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecShareProperties{}).Type1()):                              AccountSpecSharePropertiesCodec{},
		jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecSharePropertiesRetentionPolicy{}).Type1()):               AccountSpecSharePropertiesRetentionPolicyCodec{},
		jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecSharePropertiesSmb{}).Type1()):                           AccountSpecSharePropertiesSmbCodec{},
...
func (AccountSpecAzureFilesAuthenticationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj AccountSpecAzureFilesAuthentication
			...
			*(*AccountSpecAzureFilesAuthentication)(ptr) = obj
		} else {
			*(*AccountSpecAzureFilesAuthentication)(ptr) = AccountSpecAzureFilesAuthentication{}
		}
	default:
...
func (AccountSpecAzureFilesAuthenticationActiveDirectoryCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecAzureFilesAuthenticationActiveDirectory
			...
			*(*AccountSpecAzureFilesAuthenticationActiveDirectory)(ptr) = obj
		} else {
			*(*AccountSpecAzureFilesAuthenticationActiveDirectory)(ptr) = AccountSpecAzureFilesAuthenticationActiveDirectory{}
		}
	default:
...
func (AccountSpecBlobPropertiesCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecBlobProperties
			...
			*(*AccountSpecBlobProperties)(ptr) = obj
		} else {
			*(*AccountSpecBlobProperties)(ptr) = AccountSpecBlobProperties{}
		}
	default:
...
func (AccountSpecBlobPropertiesContainerDeleteRetentionPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecBlobPropertiesContainerDeleteRetentionPolicy
			...
			*(*AccountSpecBlobPropertiesContainerDeleteRetentionPolicy)(ptr) = obj
		} else {
			*(*AccountSpecBlobPropertiesContainerDeleteRetentionPolicy)(ptr) = AccountSpecBlobPropertiesContainerDeleteRetentionPolicy{}
		}
	default:
...
func (AccountSpecBlobPropertiesDeleteRetentionPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecBlobPropertiesDeleteRetentionPolicy
			...
			*(*AccountSpecBlobPropertiesDeleteRetentionPolicy)(ptr) = obj
		} else {
			*(*AccountSpecBlobPropertiesDeleteRetentionPolicy)(ptr) = AccountSpecBlobPropertiesDeleteRetentionPolicy{}
		}
	default:
...
func (AccountSpecCustomDomainCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecCustomDomain
			...
			*(*AccountSpecCustomDomain)(ptr) = obj
		} else {
			*(*AccountSpecCustomDomain)(ptr) = AccountSpecCustomDomain{}
		}
	default:
...
func (AccountSpecNetworkRulesCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecNetworkRules
			...
			*(*AccountSpecNetworkRules)(ptr) = obj
		} else {
			*(*AccountSpecNetworkRules)(ptr) = AccountSpecNetworkRules{}
		}
	default:
...
func (AccountSpecQueuePropertiesCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecQueueProperties
			...
			*(*AccountSpecQueueProperties)(ptr) = obj
		} else {
			*(*AccountSpecQueueProperties)(ptr) = AccountSpecQueueProperties{}
		}
	default:
...
func (AccountSpecQueuePropertiesHourMetricsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecQueuePropertiesHourMetrics
			...
			*(*AccountSpecQueuePropertiesHourMetrics)(ptr) = obj
		} else {
			*(*AccountSpecQueuePropertiesHourMetrics)(ptr) = AccountSpecQueuePropertiesHourMetrics{}
		}
	default:
...
func (AccountSpecQueuePropertiesLoggingCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecQueuePropertiesLogging
			...
			*(*AccountSpecQueuePropertiesLogging)(ptr) = obj
		} else {
			*(*AccountSpecQueuePropertiesLogging)(ptr) = AccountSpecQueuePropertiesLogging{}
		}
	default:
...
func (AccountSpecQueuePropertiesMinuteMetricsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecQueuePropertiesMinuteMetrics
			...
			*(*AccountSpecQueuePropertiesMinuteMetrics)(ptr) = obj
		} else {
			*(*AccountSpecQueuePropertiesMinuteMetrics)(ptr) = AccountSpecQueuePropertiesMinuteMetrics{}
		}
	default:
...
func (AccountSpecSharePropertiesCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*AccountSpecShareProperties)(ptr) == nil
}

func (AccountSpecSharePropertiesCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*AccountSpecShareProperties)(ptr)
	var objs []AccountSpecShareProperties
	if obj != nil {
		objs = []AccountSpecShareProperties{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecShareProperties{}).Type1())),
	}.Froze()
...
func (AccountSpecSharePropertiesCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*AccountSpecShareProperties)(ptr) = AccountSpecShareProperties{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecShareProperties{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*AccountSpecShareProperties)(ptr) = objs[0]
			} else {
				*(*AccountSpecShareProperties)(ptr) = AccountSpecShareProperties{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecShareProperties
			...
			*(*AccountSpecShareProperties)(ptr) = obj
		} else {
			*(*AccountSpecShareProperties)(ptr) = AccountSpecShareProperties{}
		}
	default:
		iter.ReportError("decode AccountSpecShareProperties", "unexpected JSON type")
	}
}
...
func (AccountSpecSharePropertiesRetentionPolicyCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*AccountSpecSharePropertiesRetentionPolicy)(ptr) == nil
}

func (AccountSpecSharePropertiesRetentionPolicyCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*AccountSpecSharePropertiesRetentionPolicy)(ptr)
	var objs []AccountSpecSharePropertiesRetentionPolicy
	if obj != nil {
		objs = []AccountSpecSharePropertiesRetentionPolicy{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecSharePropertiesRetentionPolicy{}).Type1())),
	}.Froze()
...
func (AccountSpecSharePropertiesRetentionPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*AccountSpecSharePropertiesRetentionPolicy)(ptr) = AccountSpecSharePropertiesRetentionPolicy{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecSharePropertiesRetentionPolicy{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*AccountSpecSharePropertiesRetentionPolicy)(ptr) = objs[0]
			} else {
				*(*AccountSpecSharePropertiesRetentionPolicy)(ptr) = AccountSpecSharePropertiesRetentionPolicy{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecSharePropertiesRetentionPolicy
			...
			*(*AccountSpecSharePropertiesRetentionPolicy)(ptr) = obj
		} else {
			*(*AccountSpecSharePropertiesRetentionPolicy)(ptr) = AccountSpecSharePropertiesRetentionPolicy{}
		}
	default:
		iter.ReportError("decode AccountSpecSharePropertiesRetentionPolicy", "unexpected JSON type")
	}
}
...
func (AccountSpecSharePropertiesSmbCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*AccountSpecSharePropertiesSmb)(ptr) == nil
}

func (AccountSpecSharePropertiesSmbCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*AccountSpecSharePropertiesSmb)(ptr)
	var objs []AccountSpecSharePropertiesSmb
	if obj != nil {
		objs = []AccountSpecSharePropertiesSmb{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecSharePropertiesSmb{}).Type1())),
	}.Froze()
...
func (AccountSpecSharePropertiesSmbCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*AccountSpecSharePropertiesSmb)(ptr) = AccountSpecSharePropertiesSmb{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecSharePropertiesSmb{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*AccountSpecSharePropertiesSmb)(ptr) = objs[0]
			} else {
				*(*AccountSpecSharePropertiesSmb)(ptr) = AccountSpecSharePropertiesSmb{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecSharePropertiesSmb
			...
			*(*AccountSpecSharePropertiesSmb)(ptr) = obj
		} else {
			*(*AccountSpecSharePropertiesSmb)(ptr) = AccountSpecSharePropertiesSmb{}
		}
	default:
		iter.ReportError("decode AccountSpecSharePropertiesSmb", "unexpected JSON type")
	}
}
...
func (AccountSpecStaticWebsiteCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecStaticWebsite
			...
			*(*AccountSpecStaticWebsite)(ptr) = obj
		} else {
			*(*AccountSpecStaticWebsite)(ptr) = AccountSpecStaticWebsite{}
		}
	default:
...
func (BlobInventoryPolicySpecRulesFilterCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj BlobInventoryPolicySpecRulesFilter
			...
			*(*BlobInventoryPolicySpecRulesFilter)(ptr) = obj
		} else {
			*(*BlobInventoryPolicySpecRulesFilter)(ptr) = BlobInventoryPolicySpecRulesFilter{}
		}
	default:
...
func (ManagementPolicySpecRuleActionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagementPolicySpecRuleActions
			...
			*(*ManagementPolicySpecRuleActions)(ptr) = obj
		} else {
			*(*ManagementPolicySpecRuleActions)(ptr) = ManagementPolicySpecRuleActions{}
		}
	default:
...
func (ManagementPolicySpecRuleActionsBaseBlobCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagementPolicySpecRuleActionsBaseBlob
			...
			*(*ManagementPolicySpecRuleActionsBaseBlob)(ptr) = obj
		} else {
			*(*ManagementPolicySpecRuleActionsBaseBlob)(ptr) = ManagementPolicySpecRuleActionsBaseBlob{}
		}
	default:
...
func (ManagementPolicySpecRuleActionsSnapshotCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagementPolicySpecRuleActionsSnapshot
			...
			*(*ManagementPolicySpecRuleActionsSnapshot)(ptr) = obj
		} else {
			*(*ManagementPolicySpecRuleActionsSnapshot)(ptr) = ManagementPolicySpecRuleActionsSnapshot{}
		}
	default:
...
func (ManagementPolicySpecRuleActionsVersionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagementPolicySpecRuleActionsVersion
			...
			*(*ManagementPolicySpecRuleActionsVersion)(ptr) = obj
		} else {
			*(*ManagementPolicySpecRuleActionsVersion)(ptr) = ManagementPolicySpecRuleActionsVersion{}
		}
	default:
...
func (ManagementPolicySpecRuleFiltersCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagementPolicySpecRuleFilters
			...
			*(*ManagementPolicySpecRuleFilters)(ptr) = obj
		} else {
			*(*ManagementPolicySpecRuleFilters)(ptr) = ManagementPolicySpecRuleFilters{}
		}
	default:
