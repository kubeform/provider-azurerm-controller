...
func (in *AccountSpecCustomerManagedKey) DeepCopy() *AccountSpecCustomerManagedKey {
	...
	out := new(AccountSpecCustomerManagedKey)
	in.DeepCopyInto(out)
	return out
}
