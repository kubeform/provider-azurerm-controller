...
func (in *FabricManagedCluster) DeepCopy() *FabricManagedCluster {
	if in == nil {
		return nil
	}
	out := new(FabricManagedCluster)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FabricManagedClusterList) DeepCopyInto(out *FabricManagedClusterList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]FabricManagedCluster, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FabricManagedClusterList) DeepCopy() *FabricManagedClusterList {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FabricManagedClusterSpec) DeepCopyInto(out *FabricManagedClusterSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FabricManagedClusterSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *FabricManagedClusterSpec) DeepCopy() *FabricManagedClusterSpec {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecAuthentication) DeepCopyInto(out *FabricManagedClusterSpecAuthentication) {
	*out = *in
	if in.ActiveDirectory != nil {
		in, out := &in.ActiveDirectory, &out.ActiveDirectory
		*out = new(FabricManagedClusterSpecAuthenticationActiveDirectory)
		(*in).DeepCopyInto(*out)
	}
	if in.Certificate != nil {
		in, out := &in.Certificate, &out.Certificate
		*out = make([]FabricManagedClusterSpecAuthenticationCertificate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FabricManagedClusterSpecAuthentication) DeepCopy() *FabricManagedClusterSpecAuthentication {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecAuthentication)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecAuthenticationActiveDirectory) DeepCopyInto(out *FabricManagedClusterSpecAuthenticationActiveDirectory) {
	*out = *in
	if in.ClientApplicationID != nil {
		in, out := &in.ClientApplicationID, &out.ClientApplicationID
		*out = new(string)
...
func (in *FabricManagedClusterSpecAuthenticationActiveDirectory) DeepCopy() *FabricManagedClusterSpecAuthenticationActiveDirectory {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecAuthenticationActiveDirectory)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecAuthenticationCertificate) DeepCopyInto(out *FabricManagedClusterSpecAuthenticationCertificate) {
	*out = *in
	if in.CommonName != nil {
		in, out := &in.CommonName, &out.CommonName
		*out = new(string)
...
func (in *FabricManagedClusterSpecAuthenticationCertificate) DeepCopy() *FabricManagedClusterSpecAuthenticationCertificate {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecAuthenticationCertificate)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecCustomFabricSetting) DeepCopyInto(out *FabricManagedClusterSpecCustomFabricSetting) {
	*out = *in
	if in.Parameter != nil {
...
func (in *FabricManagedClusterSpecCustomFabricSetting) DeepCopy() *FabricManagedClusterSpecCustomFabricSetting {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecCustomFabricSetting)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecLbRule) DeepCopyInto(out *FabricManagedClusterSpecLbRule) {
	*out = *in
...
func (in *FabricManagedClusterSpecLbRule) DeepCopy() *FabricManagedClusterSpecLbRule {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecLbRule)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecNodeType) DeepCopyInto(out *FabricManagedClusterSpecNodeType) {
	*out = *in
	...
	if in.VmSecrets != nil {
		...
		*out = make([]FabricManagedClusterSpecNodeTypeVmSecrets, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FabricManagedClusterSpecNodeType) DeepCopy() *FabricManagedClusterSpecNodeType {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecNodeType)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecNodeTypeVmSecrets) DeepCopyInto(out *FabricManagedClusterSpecNodeTypeVmSecrets) {
	*out = *in
	if in.Certificates != nil {
		in, out := &in.Certificates, &out.Certificates
		*out = make([]FabricManagedClusterSpecNodeTypeVmSecretsCertificates, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FabricManagedClusterSpecNodeTypeVmSecrets) DeepCopy() *FabricManagedClusterSpecNodeTypeVmSecrets {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecNodeTypeVmSecrets)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecNodeTypeVmSecretsCertificates) DeepCopyInto(out *FabricManagedClusterSpecNodeTypeVmSecretsCertificates) {
	*out = *in
	if in.Store != nil {
...
func (in *FabricManagedClusterSpecNodeTypeVmSecretsCertificates) DeepCopy() *FabricManagedClusterSpecNodeTypeVmSecretsCertificates {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecNodeTypeVmSecretsCertificates)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterSpecResource) DeepCopyInto(out *FabricManagedClusterSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
	...
	if in.CustomFabricSetting != nil {
		...
		*out = make([]FabricManagedClusterSpecCustomFabricSetting, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.LbRule != nil {
		...
		*out = make([]FabricManagedClusterSpecLbRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.NodeType != nil {
		in, out := &in.NodeType, &out.NodeType
		*out = make([]FabricManagedClusterSpecNodeType, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FabricManagedClusterSpecResource) DeepCopy() *FabricManagedClusterSpecResource {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterSpecResource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricManagedClusterStatus) DeepCopyInto(out *FabricManagedClusterStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]apiv1.Condition, len(*in))
...
func (in *FabricManagedClusterStatus) DeepCopy() *FabricManagedClusterStatus {
	if in == nil {
		return nil
	}
	out := new(FabricManagedClusterStatus)
	in.DeepCopyInto(out)
	return out
}
