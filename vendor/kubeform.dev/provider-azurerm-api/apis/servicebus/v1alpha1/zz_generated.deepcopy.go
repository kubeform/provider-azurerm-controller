...
func (in *Namespace_Spec) DeepCopyInto(out *Namespace_Spec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(Namespace_SpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Namespace_SpecResource) DeepCopyInto(out *Namespace_SpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Namespace_SpecResource.
func (in *Namespace_SpecResource) DeepCopy() *Namespace_SpecResource {
	if in == nil {
		return nil
	}
	out := new(Namespace_SpecResource)
