...
func (in *DirectorySpecResource) DeepCopyInto(out *DirectorySpecResource) {
	*out = *in
	...
	if in.DataResidencyLocation != nil {
		in, out := &in.DataResidencyLocation, &out.DataResidencyLocation
		*out = new(string)
		**out = **in
	}
	...
	if in.EffectiveStartDate != nil {
		in, out := &in.EffectiveStartDate, &out.EffectiveStartDate
		*out = new(string)
		**out = **in
	}
