...
var registrywebhookForceNewList = map[string]bool{
	"/location":            true,
	"/name":                true,
	"/registry_name":       true,
...
func (r *RegistryWebhook) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range registrywebhookForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`registrywebhook "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
