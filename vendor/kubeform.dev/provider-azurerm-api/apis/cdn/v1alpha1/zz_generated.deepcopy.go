...
func (in *EndpointCustomDomainSpec) DeepCopyInto(out *EndpointCustomDomainSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(EndpointCustomDomainSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *EndpointCustomDomainSpecCdnManagedHTTPS) DeepCopy() *EndpointCustomDomainSpecCdnManagedHTTPS {
	...
	out := new(EndpointCustomDomainSpecCdnManagedHTTPS)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EndpointCustomDomainSpecResource) DeepCopyInto(out *EndpointCustomDomainSpecResource) {
	*out = *in
	...
	if in.CdnManagedHTTPS != nil {
		in, out := &in.CdnManagedHTTPS, &out.CdnManagedHTTPS
		*out = new(EndpointCustomDomainSpecCdnManagedHTTPS)
		(*in).DeepCopyInto(*out)
	}
	if in.HostName != nil {
	...
	if in.UserManagedHTTPS != nil {
		in, out := &in.UserManagedHTTPS, &out.UserManagedHTTPS
		*out = new(EndpointCustomDomainSpecUserManagedHTTPS)
		(*in).DeepCopyInto(*out)
	}
	return
}
