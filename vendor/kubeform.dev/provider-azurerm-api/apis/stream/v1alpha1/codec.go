...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		...
		jsoniter.MustGetKind(reflect2.TypeOf(AnalyticsJobSpecIdentity{}).Type1()):                        AnalyticsJobSpecIdentityCodec{},
...
func (AnalyticsFunctionJavascriptUdfSpecOutputCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj AnalyticsFunctionJavascriptUdfSpecOutput
			...
			*(*AnalyticsFunctionJavascriptUdfSpecOutput)(ptr) = obj
		} else {
			*(*AnalyticsFunctionJavascriptUdfSpecOutput)(ptr) = AnalyticsFunctionJavascriptUdfSpecOutput{}
		}
	default:
...
func (AnalyticsJobSpecIdentityCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*AnalyticsJobSpecIdentity)(ptr) == nil
}

func (AnalyticsJobSpecIdentityCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*AnalyticsJobSpecIdentity)(ptr)
	var objs []AnalyticsJobSpecIdentity
	if obj != nil {
		objs = []AnalyticsJobSpecIdentity{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AnalyticsJobSpecIdentity{}).Type1())),
	}.Froze()
...
func (AnalyticsJobSpecIdentityCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	switch iter.WhatIsNext() {
	case jsoniter.NilValue:
		iter.Skip()
		*(*AnalyticsJobSpecIdentity)(ptr) = AnalyticsJobSpecIdentity{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AnalyticsJobSpecIdentity{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*AnalyticsJobSpecIdentity)(ptr) = objs[0]
			} else {
				*(*AnalyticsJobSpecIdentity)(ptr) = AnalyticsJobSpecIdentity{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsJobSpecIdentity
			...
			*(*AnalyticsJobSpecIdentity)(ptr) = obj
		} else {
			*(*AnalyticsJobSpecIdentity)(ptr) = AnalyticsJobSpecIdentity{}
		}
	default:
		iter.ReportError("decode AnalyticsJobSpecIdentity", "unexpected JSON type")
	}
}
...
func (AnalyticsOutputBlobSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsOutputBlobSpecSerialization
			...
			*(*AnalyticsOutputBlobSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsOutputBlobSpecSerialization)(ptr) = AnalyticsOutputBlobSpecSerialization{}
		}
	default:
...
func (AnalyticsOutputEventhubSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsOutputEventhubSpecSerialization
			...
			*(*AnalyticsOutputEventhubSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsOutputEventhubSpecSerialization)(ptr) = AnalyticsOutputEventhubSpecSerialization{}
		}
	default:
...
func (AnalyticsOutputServicebusQueueSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsOutputServicebusQueueSpecSerialization
			...
			*(*AnalyticsOutputServicebusQueueSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsOutputServicebusQueueSpecSerialization)(ptr) = AnalyticsOutputServicebusQueueSpecSerialization{}
		}
	default:
...
func (AnalyticsOutputServicebusTopicSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsOutputServicebusTopicSpecSerialization
			...
			*(*AnalyticsOutputServicebusTopicSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsOutputServicebusTopicSpecSerialization)(ptr) = AnalyticsOutputServicebusTopicSpecSerialization{}
		}
	default:
...
func (AnalyticsReferenceInputBlobSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsReferenceInputBlobSpecSerialization
			...
			*(*AnalyticsReferenceInputBlobSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsReferenceInputBlobSpecSerialization)(ptr) = AnalyticsReferenceInputBlobSpecSerialization{}
		}
	default:
...
func (AnalyticsStreamInputBlobSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsStreamInputBlobSpecSerialization
			...
			*(*AnalyticsStreamInputBlobSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsStreamInputBlobSpecSerialization)(ptr) = AnalyticsStreamInputBlobSpecSerialization{}
		}
	default:
...
func (AnalyticsStreamInputEventhubSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsStreamInputEventhubSpecSerialization
			...
			*(*AnalyticsStreamInputEventhubSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsStreamInputEventhubSpecSerialization)(ptr) = AnalyticsStreamInputEventhubSpecSerialization{}
		}
	default:
...
func (AnalyticsStreamInputIothubSpecSerializationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AnalyticsStreamInputIothubSpecSerialization
			...
			*(*AnalyticsStreamInputIothubSpecSerialization)(ptr) = obj
		} else {
			*(*AnalyticsStreamInputIothubSpecSerialization)(ptr) = AnalyticsStreamInputIothubSpecSerialization{}
		}
	default:
