...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		...
		jsoniter.MustGetKind(reflect2.TypeOf(PoolSpecIdentity{}).Type1()):                      PoolSpecIdentityCodec{},
...
func (AccountSpecKeyVaultReferenceCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecKeyVaultReference
			...
			*(*AccountSpecKeyVaultReference)(ptr) = obj
		} else {
			*(*AccountSpecKeyVaultReference)(ptr) = AccountSpecKeyVaultReference{}
		}
	default:
...
func (PoolSpecContainerConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj PoolSpecContainerConfiguration
			...
			*(*PoolSpecContainerConfiguration)(ptr) = obj
		} else {
			*(*PoolSpecContainerConfiguration)(ptr) = PoolSpecContainerConfiguration{}
		}
	default:
...
func (PoolSpecIdentityCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*PoolSpecIdentity)(ptr) == nil
}

func (PoolSpecIdentityCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*PoolSpecIdentity)(ptr)
	var objs []PoolSpecIdentity
	if obj != nil {
		objs = []PoolSpecIdentity{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(PoolSpecIdentity{}).Type1())),
	}.Froze()
...
func (PoolSpecIdentityCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*PoolSpecIdentity)(ptr) = PoolSpecIdentity{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(PoolSpecIdentity{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*PoolSpecIdentity)(ptr) = objs[0]
			} else {
				*(*PoolSpecIdentity)(ptr) = PoolSpecIdentity{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			...
			*(*PoolSpecIdentity)(ptr) = obj
		} else {
			*(*PoolSpecIdentity)(ptr) = PoolSpecIdentity{}
		}
	default:
		iter.ReportError("decode PoolSpecIdentity", "unexpected JSON type")
	}
}
...
func (PoolSpecNetworkConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj PoolSpecNetworkConfiguration
			...
			*(*PoolSpecNetworkConfiguration)(ptr) = obj
		} else {
			*(*PoolSpecNetworkConfiguration)(ptr) = PoolSpecNetworkConfiguration{}
		}
	default:
...
func (PoolSpecStartTaskUserIdentityCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj PoolSpecStartTaskUserIdentity
			...
			*(*PoolSpecStartTaskUserIdentity)(ptr) = obj
		} else {
			*(*PoolSpecStartTaskUserIdentity)(ptr) = PoolSpecStartTaskUserIdentity{}
		}
	default:
...
func (PoolSpecStartTaskUserIdentityAutoUserCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj PoolSpecStartTaskUserIdentityAutoUser
			...
			*(*PoolSpecStartTaskUserIdentityAutoUser)(ptr) = obj
		} else {
			*(*PoolSpecStartTaskUserIdentityAutoUser)(ptr) = PoolSpecStartTaskUserIdentityAutoUser{}
		}
	default:
...
func (PoolSpecStorageImageReferenceCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj PoolSpecStorageImageReference
			...
			*(*PoolSpecStorageImageReference)(ptr) = obj
		} else {
			*(*PoolSpecStorageImageReference)(ptr) = PoolSpecStorageImageReference{}
		}
	default:
