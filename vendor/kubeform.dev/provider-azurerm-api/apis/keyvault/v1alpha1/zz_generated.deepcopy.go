...
func (in *ManagedStorageAccountSasTokenDefinitionSpec) DeepCopyInto(out *ManagedStorageAccountSasTokenDefinitionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ManagedStorageAccountSasTokenDefinitionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedStorageAccountSasTokenDefinitionSpecResource) DeepCopyInto(out *ManagedStorageAccountSasTokenDefinitionSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *ManagedStorageAccountSasTokenDefinitionSpecResource) DeepCopy() *ManagedStorageAccountSasTokenDefinitionSpecResource {
	if in == nil {
		return nil
	}
	out := new(ManagedStorageAccountSasTokenDefinitionSpecResource)
...
func (in *ManagedStorageAccountSpec) DeepCopyInto(out *ManagedStorageAccountSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ManagedStorageAccountSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedStorageAccountSpecResource) DeepCopyInto(out *ManagedStorageAccountSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *ManagedStorageAccountSpecResource) DeepCopy() *ManagedStorageAccountSpecResource {
	if in == nil {
		return nil
	}
	out := new(ManagedStorageAccountSpecResource)
