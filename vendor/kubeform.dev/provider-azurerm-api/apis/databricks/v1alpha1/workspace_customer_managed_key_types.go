...
type WorkspaceCustomerManagedKey struct {
	...
	Spec              WorkspaceCustomerManagedKeySpec   `json:"spec,omitempty"`
	Status            WorkspaceCustomerManagedKeyStatus `json:"status,omitempty"`
}

type WorkspaceCustomerManagedKeySpec struct {
	State *WorkspaceCustomerManagedKeySpecResource `json:"state,omitempty" tf:"-"`

	Resource WorkspaceCustomerManagedKeySpecResource `json:"resource" tf:"resource"`
...
type WorkspaceCustomerManagedKeySpecResource struct {
...
type WorkspaceCustomerManagedKeyList struct {
	...
	// Items is a list of WorkspaceCustomerManagedKey CRD objects
	Items []WorkspaceCustomerManagedKey `json:"items,omitempty"`
}
