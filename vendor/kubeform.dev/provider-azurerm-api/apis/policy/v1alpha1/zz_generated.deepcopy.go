...
func (in *VirtualMachineConfigurationAssignmentSpec) DeepCopyInto(out *VirtualMachineConfigurationAssignmentSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(VirtualMachineConfigurationAssignmentSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineConfigurationAssignmentSpecConfiguration) DeepCopyInto(out *VirtualMachineConfigurationAssignmentSpecConfiguration) {
	*out = *in
	...
	if in.Parameter != nil {
		...
		*out = make([]VirtualMachineConfigurationAssignmentSpecConfigurationParameter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VirtualMachineConfigurationAssignmentSpecConfiguration) DeepCopy() *VirtualMachineConfigurationAssignmentSpecConfiguration {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineConfigurationAssignmentSpecConfiguration)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineConfigurationAssignmentSpecConfigurationParameter) DeepCopyInto(out *VirtualMachineConfigurationAssignmentSpecConfigurationParameter) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
func (in *VirtualMachineConfigurationAssignmentSpecConfigurationParameter) DeepCopy() *VirtualMachineConfigurationAssignmentSpecConfigurationParameter {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineConfigurationAssignmentSpecConfigurationParameter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineConfigurationAssignmentSpecResource) DeepCopyInto(out *VirtualMachineConfigurationAssignmentSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *VirtualMachineConfigurationAssignmentSpecResource) DeepCopy() *VirtualMachineConfigurationAssignmentSpecResource {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineConfigurationAssignmentSpecResource)
