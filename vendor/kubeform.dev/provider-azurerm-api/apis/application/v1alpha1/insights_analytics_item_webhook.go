...
var insightsanalyticsitemForceNewList = map[string]bool{
...
func (r *InsightsAnalyticsItem) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range insightsanalyticsitemForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`insightsanalyticsitem "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
