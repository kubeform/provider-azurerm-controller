...
var insightswebtestForceNewList = map[string]bool{
...
func (r *InsightsWebTest) ValidateUpdate(old runtime.Object) error {
	...
	for key := range insightswebtestForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`insightswebtest "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
