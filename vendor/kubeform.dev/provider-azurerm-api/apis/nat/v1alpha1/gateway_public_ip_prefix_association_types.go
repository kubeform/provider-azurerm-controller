...
type GatewayPublicIPPrefixAssociation struct {
	...
	Spec              GatewayPublicIPPrefixAssociationSpec   `json:"spec,omitempty"`
...
type GatewayPublicIPPrefixAssociationSpecResource struct {
...
type GatewayPublicIPPrefixAssociationList struct {
	...
	// Items is a list of GatewayPublicIPPrefixAssociation CRD objects
	Items []GatewayPublicIPPrefixAssociation `json:"items,omitempty"`
}
