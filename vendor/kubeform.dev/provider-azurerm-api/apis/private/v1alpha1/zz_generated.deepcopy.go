...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointSpecNetworkInterface) DeepCopyInto(out *EndpointSpecNetworkInterface) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
func (in *EndpointSpecNetworkInterface) DeepCopy() *EndpointSpecNetworkInterface {
	if in == nil {
		return nil
	}
	out := new(EndpointSpecNetworkInterface)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EndpointSpecResource) DeepCopyInto(out *EndpointSpecResource) {
	*out = *in
	...
	if in.NetworkInterface != nil {
		...
		*out = make([]EndpointSpecNetworkInterface, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
