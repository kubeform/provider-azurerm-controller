...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecAnalyticalStorage{}).Type1()):             AccountSpecAnalyticalStorageCodec{},
		jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecBackup{}).Type1()):                        AccountSpecBackupCodec{},
		jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecCapacity{}).Type1()):                      AccountSpecCapacityCodec{},
		...
		jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecRestore{}).Type1()):                       AccountSpecRestoreCodec{},
		...
		jsoniter.MustGetKind(reflect2.TypeOf(GremlinGraphSpecIndexPolicy{}).Type1()):              GremlinGraphSpecIndexPolicyCodec{},
...
func (AccountSpecAnalyticalStorageCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*AccountSpecAnalyticalStorage)(ptr) == nil
}

func (AccountSpecAnalyticalStorageCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*AccountSpecAnalyticalStorage)(ptr)
	var objs []AccountSpecAnalyticalStorage
	if obj != nil {
		objs = []AccountSpecAnalyticalStorage{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecAnalyticalStorage{}).Type1())),
	}.Froze()
...
func (AccountSpecAnalyticalStorageCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*AccountSpecAnalyticalStorage)(ptr) = AccountSpecAnalyticalStorage{}
		return
	case jsoniter.ArrayValue:
		...
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecAnalyticalStorage{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*AccountSpecAnalyticalStorage)(ptr) = objs[0]
			} else {
				*(*AccountSpecAnalyticalStorage)(ptr) = AccountSpecAnalyticalStorage{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj AccountSpecAnalyticalStorage
			...
			*(*AccountSpecAnalyticalStorage)(ptr) = obj
		} else {
			*(*AccountSpecAnalyticalStorage)(ptr) = AccountSpecAnalyticalStorage{}
		}
	default:
		iter.ReportError("decode AccountSpecAnalyticalStorage", "unexpected JSON type")
	}
}
...
func (AccountSpecCapacityCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*AccountSpecCapacity)(ptr) == nil
}

func (AccountSpecCapacityCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*AccountSpecCapacity)(ptr)
	var objs []AccountSpecCapacity
	if obj != nil {
		objs = []AccountSpecCapacity{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecCapacity{}).Type1())),
	}.Froze()
...
func (AccountSpecCapacityCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*AccountSpecCapacity)(ptr) = AccountSpecCapacity{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecCapacity{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*AccountSpecCapacity)(ptr) = objs[0]
			} else {
				*(*AccountSpecCapacity)(ptr) = AccountSpecCapacity{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			...
			*(*AccountSpecCapacity)(ptr) = obj
		} else {
			*(*AccountSpecCapacity)(ptr) = AccountSpecCapacity{}
		}
	default:
		iter.ReportError("decode AccountSpecCapacity", "unexpected JSON type")
	}
}
...
func (AccountSpecConsistencyPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj AccountSpecConsistencyPolicy
			...
			*(*AccountSpecConsistencyPolicy)(ptr) = obj
		} else {
			*(*AccountSpecConsistencyPolicy)(ptr) = AccountSpecConsistencyPolicy{}
		}
	default:
...
func (AccountSpecRestoreCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*AccountSpecRestore)(ptr) == nil
}

func (AccountSpecRestoreCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*AccountSpecRestore)(ptr)
	var objs []AccountSpecRestore
	if obj != nil {
		objs = []AccountSpecRestore{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecRestore{}).Type1())),
	}.Froze()
...
func (AccountSpecRestoreCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*AccountSpecRestore)(ptr) = AccountSpecRestore{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(AccountSpecRestore{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*AccountSpecRestore)(ptr) = objs[0]
			} else {
				*(*AccountSpecRestore)(ptr) = AccountSpecRestore{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			...
			*(*AccountSpecRestore)(ptr) = obj
		} else {
			*(*AccountSpecRestore)(ptr) = AccountSpecRestore{}
		}
	default:
		iter.ReportError("decode AccountSpecRestore", "unexpected JSON type")
	}
}
...
func (CassandraKeyspaceSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj CassandraKeyspaceSpecAutoscaleSettings
			...
			*(*CassandraKeyspaceSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*CassandraKeyspaceSpecAutoscaleSettings)(ptr) = CassandraKeyspaceSpecAutoscaleSettings{}
		}
	default:
...
func (CassandraTableSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj CassandraTableSpecAutoscaleSettings
			...
			*(*CassandraTableSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*CassandraTableSpecAutoscaleSettings)(ptr) = CassandraTableSpecAutoscaleSettings{}
		}
	default:
...
func (CassandraTableSpecSchemaCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj CassandraTableSpecSchema
			...
			*(*CassandraTableSpecSchema)(ptr) = obj
		} else {
			*(*CassandraTableSpecSchema)(ptr) = CassandraTableSpecSchema{}
		}
	default:
...
func (GremlinDatabaseSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj GremlinDatabaseSpecAutoscaleSettings
			...
			*(*GremlinDatabaseSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*GremlinDatabaseSpecAutoscaleSettings)(ptr) = GremlinDatabaseSpecAutoscaleSettings{}
		}
	default:
...
func (GremlinGraphSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj GremlinGraphSpecAutoscaleSettings
			...
			*(*GremlinGraphSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*GremlinGraphSpecAutoscaleSettings)(ptr) = GremlinGraphSpecAutoscaleSettings{}
		}
	default:
...
func (GremlinGraphSpecConflictResolutionPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj GremlinGraphSpecConflictResolutionPolicy
			...
			*(*GremlinGraphSpecConflictResolutionPolicy)(ptr) = obj
		} else {
			*(*GremlinGraphSpecConflictResolutionPolicy)(ptr) = GremlinGraphSpecConflictResolutionPolicy{}
		}
	default:
...
func (GremlinGraphSpecIndexPolicyCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*GremlinGraphSpecIndexPolicy)(ptr) == nil
}

func (GremlinGraphSpecIndexPolicyCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*GremlinGraphSpecIndexPolicy)(ptr)
	var objs []GremlinGraphSpecIndexPolicy
	if obj != nil {
		objs = []GremlinGraphSpecIndexPolicy{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(GremlinGraphSpecIndexPolicy{}).Type1())),
	}.Froze()
...
func (GremlinGraphSpecIndexPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*GremlinGraphSpecIndexPolicy)(ptr) = GremlinGraphSpecIndexPolicy{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(GremlinGraphSpecIndexPolicy{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*GremlinGraphSpecIndexPolicy)(ptr) = objs[0]
			} else {
				*(*GremlinGraphSpecIndexPolicy)(ptr) = GremlinGraphSpecIndexPolicy{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj GremlinGraphSpecIndexPolicy
			...
			*(*GremlinGraphSpecIndexPolicy)(ptr) = obj
		} else {
			*(*GremlinGraphSpecIndexPolicy)(ptr) = GremlinGraphSpecIndexPolicy{}
		}
	default:
		iter.ReportError("decode GremlinGraphSpecIndexPolicy", "unexpected JSON type")
	}
}
...
func (MongoCollectionSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj MongoCollectionSpecAutoscaleSettings
			...
			*(*MongoCollectionSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*MongoCollectionSpecAutoscaleSettings)(ptr) = MongoCollectionSpecAutoscaleSettings{}
		}
	default:
...
func (MongoDatabaseSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj MongoDatabaseSpecAutoscaleSettings
			...
			*(*MongoDatabaseSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*MongoDatabaseSpecAutoscaleSettings)(ptr) = MongoDatabaseSpecAutoscaleSettings{}
		}
	default:
...
func (SqlContainerSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SqlContainerSpecAutoscaleSettings
			...
			*(*SqlContainerSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*SqlContainerSpecAutoscaleSettings)(ptr) = SqlContainerSpecAutoscaleSettings{}
		}
	default:
...
func (SqlContainerSpecConflictResolutionPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SqlContainerSpecConflictResolutionPolicy
			...
			*(*SqlContainerSpecConflictResolutionPolicy)(ptr) = obj
		} else {
			*(*SqlContainerSpecConflictResolutionPolicy)(ptr) = SqlContainerSpecConflictResolutionPolicy{}
		}
	default:
...
func (SqlContainerSpecIndexingPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SqlContainerSpecIndexingPolicy
			...
			*(*SqlContainerSpecIndexingPolicy)(ptr) = obj
		} else {
			*(*SqlContainerSpecIndexingPolicy)(ptr) = SqlContainerSpecIndexingPolicy{}
		}
	default:
...
func (SqlDatabaseSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SqlDatabaseSpecAutoscaleSettings
			...
			*(*SqlDatabaseSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*SqlDatabaseSpecAutoscaleSettings)(ptr) = SqlDatabaseSpecAutoscaleSettings{}
		}
	default:
...
func (TableSpecAutoscaleSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj TableSpecAutoscaleSettings
			...
			*(*TableSpecAutoscaleSettings)(ptr) = obj
		} else {
			*(*TableSpecAutoscaleSettings)(ptr) = TableSpecAutoscaleSettings{}
		}
	default:
