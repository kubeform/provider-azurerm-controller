...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-data-azurerm-kubeform-com-v1alpha1-protectionbackuppolicypostgresql,mutating=false,failurePolicy=fail,groups=data.azurerm.kubeform.com,resources=protectionbackuppolicypostgresqls,versions=v1alpha1,name=protectionbackuppolicypostgresql.data.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *ProtectionBackupPolicyPostgresql) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`protectionbackuppolicypostgresql "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
