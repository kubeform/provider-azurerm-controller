...
func (r *FactoryLinkedServiceSQLServer) ValidateUpdate(old runtime.Object) error {
	...
	res := old.(*FactoryLinkedServiceSQLServer)
	...
	for key, _ := range factorylinkedservicesqlserverForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`factorylinkedservicesqlserver "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
