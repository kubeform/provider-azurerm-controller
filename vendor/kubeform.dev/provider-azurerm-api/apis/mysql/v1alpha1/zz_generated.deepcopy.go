...
func (in *FlexibleDatabaseSpec) DeepCopyInto(out *FlexibleDatabaseSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FlexibleDatabaseSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlexibleDatabaseSpecResource) DeepCopyInto(out *FlexibleDatabaseSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *FlexibleDatabaseSpecResource) DeepCopy() *FlexibleDatabaseSpecResource {
	if in == nil {
		return nil
	}
	out := new(FlexibleDatabaseSpecResource)
...
func (in *FlexibleServerConfigurationSpec) DeepCopyInto(out *FlexibleServerConfigurationSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FlexibleServerConfigurationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlexibleServerConfigurationSpecResource) DeepCopyInto(out *FlexibleServerConfigurationSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *FlexibleServerConfigurationSpecResource) DeepCopy() *FlexibleServerConfigurationSpecResource {
	if in == nil {
		return nil
	}
	out := new(FlexibleServerConfigurationSpecResource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlexibleServerSpecHighAvailability) DeepCopyInto(out *FlexibleServerSpecHighAvailability) {
	*out = *in
	if in.Mode != nil {
...
func (in *FlexibleServerSpecHighAvailability) DeepCopy() *FlexibleServerSpecHighAvailability {
	if in == nil {
		return nil
	}
	out := new(FlexibleServerSpecHighAvailability)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FlexibleServerSpecResource) DeepCopyInto(out *FlexibleServerSpecResource) {
	*out = *in
	...
	if in.Storage != nil {
		...
		*out = new(FlexibleServerSpecStorage)
		(*in).DeepCopyInto(*out)
	}
	if in.Tags != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlexibleServerSpecStorage) DeepCopyInto(out *FlexibleServerSpecStorage) {
	*out = *in
...
func (in *FlexibleServerSpecStorage) DeepCopy() *FlexibleServerSpecStorage {
	if in == nil {
		return nil
	}
	out := new(FlexibleServerSpecStorage)
