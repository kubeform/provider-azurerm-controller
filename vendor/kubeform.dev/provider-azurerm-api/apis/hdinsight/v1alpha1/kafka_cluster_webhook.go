...
var kafkaclusterForceNewList = map[string]bool{
	"/cluster_version":                                     true,
	"/component_version/*/kafka":                           true,
	...
	"/roles/*/kafka_management_node/*/ssh_keys":            true,
	"/roles/*/kafka_management_node/*/subnet_id":           true,
	"/roles/*/kafka_management_node/*/username":            true,
	"/roles/*/kafka_management_node/*/virtual_network_id":  true,
	"/roles/*/kafka_management_node/*/vm_size":             true,
	"/roles/*/worker_node/*/min_instance_count":            true,
	"/roles/*/worker_node/*/number_of_disks_per_node":      true,
...
func (r *KafkaCluster) ValidateUpdate(old runtime.Object) error {
	...
	for key := range kafkaclusterForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`kafkacluster "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
