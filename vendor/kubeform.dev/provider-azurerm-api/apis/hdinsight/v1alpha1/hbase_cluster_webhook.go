...
var hbaseclusterForceNewList = map[string]bool{
	"/cluster_version":                                     true,
	"/component_version/*/hbase":                           true,
...
func (r *HbaseCluster) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range hbaseclusterForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`hbasecluster "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
