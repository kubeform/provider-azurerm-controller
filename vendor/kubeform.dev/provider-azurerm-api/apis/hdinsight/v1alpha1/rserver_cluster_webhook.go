...
var rserverclusterForceNewList = map[string]bool{
...
func (r *RserverCluster) ValidateUpdate(old runtime.Object) error {
	...
	for key := range rserverclusterForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`rservercluster "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
