...
var sparkclusterForceNewList = map[string]bool{
	"/cluster_version":                                     true,
	"/component_version/*/spark":                           true,
...
func (r *SparkCluster) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range sparkclusterForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`sparkcluster "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
