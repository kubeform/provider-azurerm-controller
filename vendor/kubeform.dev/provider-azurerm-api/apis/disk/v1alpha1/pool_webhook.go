...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-disk-azurerm-kubeform-com-v1alpha1-pool,mutating=false,failurePolicy=fail,groups=disk.azurerm.kubeform.com,resources=pools,versions=v1alpha1,name=pool.disk.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
