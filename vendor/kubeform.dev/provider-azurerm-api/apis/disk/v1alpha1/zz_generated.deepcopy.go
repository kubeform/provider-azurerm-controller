...
func (in *PoolIscsiTargetList) DeepCopyInto(out *PoolIscsiTargetList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]PoolIscsiTarget, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PoolIscsiTargetLunList) DeepCopyInto(out *PoolIscsiTargetLunList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]PoolIscsiTargetLun, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PoolIscsiTargetLunList) DeepCopy() *PoolIscsiTargetLunList {
	if in == nil {
		return nil
	}
	out := new(PoolIscsiTargetLunList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PoolIscsiTargetLunSpec) DeepCopyInto(out *PoolIscsiTargetLunSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(PoolIscsiTargetLunSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *PoolIscsiTargetLunSpec) DeepCopy() *PoolIscsiTargetLunSpec {
	if in == nil {
		return nil
	}
	out := new(PoolIscsiTargetLunSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolIscsiTargetLunSpecResource) DeepCopyInto(out *PoolIscsiTargetLunSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
	...
	if in.DiskPoolManagedDiskAttachmentID != nil {
		in, out := &in.DiskPoolManagedDiskAttachmentID, &out.DiskPoolManagedDiskAttachmentID
		*out = new(string)
		**out = **in
	}
	if in.IscsiTargetID != nil {
		in, out := &in.IscsiTargetID, &out.IscsiTargetID
		*out = new(string)
		**out = **in
	}
	if in.Lun != nil {
...
func (in *PoolIscsiTargetLunSpecResource) DeepCopy() *PoolIscsiTargetLunSpecResource {
	if in == nil {
		return nil
	}
	out := new(PoolIscsiTargetLunSpecResource)
...
func (in *PoolIscsiTargetLunStatus) DeepCopy() *PoolIscsiTargetLunStatus {
	if in == nil {
		return nil
	}
	out := new(PoolIscsiTargetLunStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PoolIscsiTargetSpec) DeepCopyInto(out *PoolIscsiTargetSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(PoolIscsiTargetSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *PoolIscsiTargetSpec) DeepCopy() *PoolIscsiTargetSpec {
	...
	out := new(PoolIscsiTargetSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolIscsiTargetSpecResource) DeepCopyInto(out *PoolIscsiTargetSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
	...
	if in.AclMode != nil {
		in, out := &in.AclMode, &out.AclMode
		*out = new(string)
		**out = **in
	}
	if in.DisksPoolID != nil {
		in, out := &in.DisksPoolID, &out.DisksPoolID
		*out = new(string)
		**out = **in
	}
	if in.Endpoints != nil {
	...
	if in.TargetIqn != nil {
		in, out := &in.TargetIqn, &out.TargetIqn
		*out = new(string)
		**out = **in
	}
	return
...
func (in *PoolIscsiTargetSpecResource) DeepCopy() *PoolIscsiTargetSpecResource {
	if in == nil {
		return nil
	}
	out := new(PoolIscsiTargetSpecResource)
...
func (in *PoolIscsiTargetStatus) DeepCopy() *PoolIscsiTargetStatus {
	if in == nil {
		return nil
	}
	out := new(PoolIscsiTargetStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolManagedDiskAttachment) DeepCopyInto(out *PoolManagedDiskAttachment) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
func (in *PoolManagedDiskAttachment) DeepCopy() *PoolManagedDiskAttachment {
	if in == nil {
		return nil
	}
	out := new(PoolManagedDiskAttachment)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolManagedDiskAttachmentList) DeepCopyInto(out *PoolManagedDiskAttachmentList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]PoolManagedDiskAttachment, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PoolManagedDiskAttachmentList) DeepCopy() *PoolManagedDiskAttachmentList {
	if in == nil {
		return nil
	}
	out := new(PoolManagedDiskAttachmentList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolManagedDiskAttachmentSpec) DeepCopyInto(out *PoolManagedDiskAttachmentSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(PoolManagedDiskAttachmentSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *PoolManagedDiskAttachmentSpec) DeepCopy() *PoolManagedDiskAttachmentSpec {
	if in == nil {
		return nil
	}
	out := new(PoolManagedDiskAttachmentSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolManagedDiskAttachmentSpecResource) DeepCopyInto(out *PoolManagedDiskAttachmentSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
	...
	if in.DiskPoolID != nil {
		in, out := &in.DiskPoolID, &out.DiskPoolID
		*out = new(string)
		**out = **in
	}
...
func (in *PoolManagedDiskAttachmentSpecResource) DeepCopy() *PoolManagedDiskAttachmentSpecResource {
	if in == nil {
		return nil
	}
	out := new(PoolManagedDiskAttachmentSpecResource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolManagedDiskAttachmentStatus) DeepCopyInto(out *PoolManagedDiskAttachmentStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]apiv1.Condition, len(*in))
...
func (in *PoolManagedDiskAttachmentStatus) DeepCopy() *PoolManagedDiskAttachmentStatus {
	if in == nil {
		return nil
	}
	out := new(PoolManagedDiskAttachmentStatus)
	in.DeepCopyInto(out)
	return out
}
