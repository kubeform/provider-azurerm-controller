...
type Interface interface {
	...
	PortalV1alpha1() portalv1alpha1.PortalV1alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	portalV1alpha1            *portalv1alpha1.PortalV1alpha1Client
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.portalV1alpha1, err = portalv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.portalV1alpha1 = portalv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.portalV1alpha1 = portalv1alpha1.New(c)
