...
// ApiReleasesGetter has a method to return a ApiReleaseInterface.
...
// apiReleases implements ApiReleaseInterface
type apiReleases struct {
	client rest.Interface
	ns     string
}

// newApiReleases returns a ApiReleases
func newApiReleases(c *ApimanagementV1alpha1Client, namespace string) *apiReleases {
	return &apiReleases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *apiReleases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiRelease, err error) {
	result = &v1alpha1.ApiRelease{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apiReleases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiReleaseList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApiReleaseList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apireleases").
...
func (c *apiReleases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiReleases) Create(ctx context.Context, apiRelease *v1alpha1.ApiRelease, opts v1.CreateOptions) (result *v1alpha1.ApiRelease, err error) {
	result = &v1alpha1.ApiRelease{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apireleases").
...
func (c *apiReleases) Update(ctx context.Context, apiRelease *v1alpha1.ApiRelease, opts v1.UpdateOptions) (result *v1alpha1.ApiRelease, err error) {
	result = &v1alpha1.ApiRelease{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apireleases").
...
func (c *apiReleases) UpdateStatus(ctx context.Context, apiRelease *v1alpha1.ApiRelease, opts v1.UpdateOptions) (result *v1alpha1.ApiRelease, err error) {
	result = &v1alpha1.ApiRelease{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apireleases").
...
func (c *apiReleases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiReleases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiReleases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiRelease, err error) {
	result = &v1alpha1.ApiRelease{}
