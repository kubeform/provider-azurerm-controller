...
// GatewayAPIsGetter has a method to return a GatewayAPIInterface.
...
// gatewayAPIs implements GatewayAPIInterface
type gatewayAPIs struct {
	client rest.Interface
	ns     string
}

// newGatewayAPIs returns a GatewayAPIs
func newGatewayAPIs(c *ApimanagementV1alpha1Client, namespace string) *gatewayAPIs {
	return &gatewayAPIs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *gatewayAPIs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GatewayAPI, err error) {
	result = &v1alpha1.GatewayAPI{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *gatewayAPIs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GatewayAPIList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GatewayAPIList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gatewayapis").
...
func (c *gatewayAPIs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *gatewayAPIs) Create(ctx context.Context, gatewayAPI *v1alpha1.GatewayAPI, opts v1.CreateOptions) (result *v1alpha1.GatewayAPI, err error) {
	result = &v1alpha1.GatewayAPI{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gatewayapis").
...
func (c *gatewayAPIs) Update(ctx context.Context, gatewayAPI *v1alpha1.GatewayAPI, opts v1.UpdateOptions) (result *v1alpha1.GatewayAPI, err error) {
	result = &v1alpha1.GatewayAPI{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gatewayapis").
...
func (c *gatewayAPIs) UpdateStatus(ctx context.Context, gatewayAPI *v1alpha1.GatewayAPI, opts v1.UpdateOptions) (result *v1alpha1.GatewayAPI, err error) {
	result = &v1alpha1.GatewayAPI{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gatewayapis").
...
func (c *gatewayAPIs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *gatewayAPIs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *gatewayAPIs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GatewayAPI, err error) {
	result = &v1alpha1.GatewayAPI{}
