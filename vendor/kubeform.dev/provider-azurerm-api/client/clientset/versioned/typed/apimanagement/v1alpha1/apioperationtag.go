...
// ApiOperationTagsGetter has a method to return a ApiOperationTagInterface.
...
// apiOperationTags implements ApiOperationTagInterface
type apiOperationTags struct {
	client rest.Interface
	ns     string
}

// newApiOperationTags returns a ApiOperationTags
func newApiOperationTags(c *ApimanagementV1alpha1Client, namespace string) *apiOperationTags {
...
func (c *apiOperationTags) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiOperationTag, err error) {
	result = &v1alpha1.ApiOperationTag{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apiOperationTags) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiOperationTagList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApiOperationTagList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apioperationtags").
...
func (c *apiOperationTags) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiOperationTags) Create(ctx context.Context, apiOperationTag *v1alpha1.ApiOperationTag, opts v1.CreateOptions) (result *v1alpha1.ApiOperationTag, err error) {
	result = &v1alpha1.ApiOperationTag{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apioperationtags").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apiOperationTag).
		Do(ctx).
		Into(result)
	return
}
...
func (c *apiOperationTags) Update(ctx context.Context, apiOperationTag *v1alpha1.ApiOperationTag, opts v1.UpdateOptions) (result *v1alpha1.ApiOperationTag, err error) {
	result = &v1alpha1.ApiOperationTag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apioperationtags").
		Name(apiOperationTag.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apiOperationTag).
		Do(ctx).
		Into(result)
...
func (c *apiOperationTags) UpdateStatus(ctx context.Context, apiOperationTag *v1alpha1.ApiOperationTag, opts v1.UpdateOptions) (result *v1alpha1.ApiOperationTag, err error) {
	result = &v1alpha1.ApiOperationTag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apioperationtags").
...
func (c *apiOperationTags) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiOperationTags) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiOperationTags) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiOperationTag, err error) {
	result = &v1alpha1.ApiOperationTag{}
