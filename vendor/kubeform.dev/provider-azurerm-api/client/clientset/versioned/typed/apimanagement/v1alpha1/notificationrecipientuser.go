...
// NotificationRecipientUsersGetter has a method to return a NotificationRecipientUserInterface.
...
// notificationRecipientUsers implements NotificationRecipientUserInterface
type notificationRecipientUsers struct {
	client rest.Interface
	ns     string
}

// newNotificationRecipientUsers returns a NotificationRecipientUsers
func newNotificationRecipientUsers(c *ApimanagementV1alpha1Client, namespace string) *notificationRecipientUsers {
...
func (c *notificationRecipientUsers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NotificationRecipientUser, err error) {
	result = &v1alpha1.NotificationRecipientUser{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *notificationRecipientUsers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NotificationRecipientUserList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NotificationRecipientUserList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("notificationrecipientusers").
...
func (c *notificationRecipientUsers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *notificationRecipientUsers) Create(ctx context.Context, notificationRecipientUser *v1alpha1.NotificationRecipientUser, opts v1.CreateOptions) (result *v1alpha1.NotificationRecipientUser, err error) {
	result = &v1alpha1.NotificationRecipientUser{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("notificationrecipientusers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(notificationRecipientUser).
		Do(ctx).
		Into(result)
	return
}
...
func (c *notificationRecipientUsers) Update(ctx context.Context, notificationRecipientUser *v1alpha1.NotificationRecipientUser, opts v1.UpdateOptions) (result *v1alpha1.NotificationRecipientUser, err error) {
	result = &v1alpha1.NotificationRecipientUser{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("notificationrecipientusers").
		Name(notificationRecipientUser.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(notificationRecipientUser).
		Do(ctx).
		Into(result)
...
func (c *notificationRecipientUsers) UpdateStatus(ctx context.Context, notificationRecipientUser *v1alpha1.NotificationRecipientUser, opts v1.UpdateOptions) (result *v1alpha1.NotificationRecipientUser, err error) {
	result = &v1alpha1.NotificationRecipientUser{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("notificationrecipientusers").
...
func (c *notificationRecipientUsers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *notificationRecipientUsers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *notificationRecipientUsers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NotificationRecipientUser, err error) {
	result = &v1alpha1.NotificationRecipientUser{}
