...
// NestedEndpointsGetter has a method to return a NestedEndpointInterface.
...
// nestedEndpoints implements NestedEndpointInterface
type nestedEndpoints struct {
	client rest.Interface
	ns     string
}

// newNestedEndpoints returns a NestedEndpoints
func newNestedEndpoints(c *TrafficmanagerV1alpha1Client, namespace string) *nestedEndpoints {
...
func (c *nestedEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NestedEndpoint, err error) {
	result = &v1alpha1.NestedEndpoint{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *nestedEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NestedEndpointList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NestedEndpointList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nestedendpoints").
...
func (c *nestedEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *nestedEndpoints) Create(ctx context.Context, nestedEndpoint *v1alpha1.NestedEndpoint, opts v1.CreateOptions) (result *v1alpha1.NestedEndpoint, err error) {
	result = &v1alpha1.NestedEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nestedendpoints").
...
func (c *nestedEndpoints) Update(ctx context.Context, nestedEndpoint *v1alpha1.NestedEndpoint, opts v1.UpdateOptions) (result *v1alpha1.NestedEndpoint, err error) {
	result = &v1alpha1.NestedEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nestedendpoints").
...
func (c *nestedEndpoints) UpdateStatus(ctx context.Context, nestedEndpoint *v1alpha1.NestedEndpoint, opts v1.UpdateOptions) (result *v1alpha1.NestedEndpoint, err error) {
	result = &v1alpha1.NestedEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nestedendpoints").
...
func (c *nestedEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *nestedEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *nestedEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NestedEndpoint, err error) {
	result = &v1alpha1.NestedEndpoint{}
