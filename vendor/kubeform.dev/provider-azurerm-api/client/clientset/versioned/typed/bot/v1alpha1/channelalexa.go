...
// ChannelAlexasGetter has a method to return a ChannelAlexaInterface.
...
// channelAlexas implements ChannelAlexaInterface
type channelAlexas struct {
	client rest.Interface
	ns     string
}

// newChannelAlexas returns a ChannelAlexas
func newChannelAlexas(c *BotV1alpha1Client, namespace string) *channelAlexas {
	return &channelAlexas{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *channelAlexas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ChannelAlexa, err error) {
	result = &v1alpha1.ChannelAlexa{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *channelAlexas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ChannelAlexaList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ChannelAlexaList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("channelalexas").
...
func (c *channelAlexas) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *channelAlexas) Create(ctx context.Context, channelAlexa *v1alpha1.ChannelAlexa, opts v1.CreateOptions) (result *v1alpha1.ChannelAlexa, err error) {
	result = &v1alpha1.ChannelAlexa{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("channelalexas").
...
func (c *channelAlexas) Update(ctx context.Context, channelAlexa *v1alpha1.ChannelAlexa, opts v1.UpdateOptions) (result *v1alpha1.ChannelAlexa, err error) {
	result = &v1alpha1.ChannelAlexa{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("channelalexas").
		Name(channelAlexa.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(channelAlexa).
		Do(ctx).
		Into(result)
...
func (c *channelAlexas) UpdateStatus(ctx context.Context, channelAlexa *v1alpha1.ChannelAlexa, opts v1.UpdateOptions) (result *v1alpha1.ChannelAlexa, err error) {
	result = &v1alpha1.ChannelAlexa{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("channelalexas").
...
func (c *channelAlexas) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *channelAlexas) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *channelAlexas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ChannelAlexa, err error) {
	result = &v1alpha1.ChannelAlexa{}
