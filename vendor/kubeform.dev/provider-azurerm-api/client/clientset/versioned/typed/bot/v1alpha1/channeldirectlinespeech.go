...
// ChannelDirectLineSpeechesGetter has a method to return a ChannelDirectLineSpeechInterface.
...
// channelDirectLineSpeeches implements ChannelDirectLineSpeechInterface
type channelDirectLineSpeeches struct {
	client rest.Interface
	ns     string
}

// newChannelDirectLineSpeeches returns a ChannelDirectLineSpeeches
func newChannelDirectLineSpeeches(c *BotV1alpha1Client, namespace string) *channelDirectLineSpeeches {
	return &channelDirectLineSpeeches{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *channelDirectLineSpeeches) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ChannelDirectLineSpeech, err error) {
	result = &v1alpha1.ChannelDirectLineSpeech{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *channelDirectLineSpeeches) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ChannelDirectLineSpeechList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ChannelDirectLineSpeechList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("channeldirectlinespeeches").
...
func (c *channelDirectLineSpeeches) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *channelDirectLineSpeeches) Create(ctx context.Context, channelDirectLineSpeech *v1alpha1.ChannelDirectLineSpeech, opts v1.CreateOptions) (result *v1alpha1.ChannelDirectLineSpeech, err error) {
	result = &v1alpha1.ChannelDirectLineSpeech{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("channeldirectlinespeeches").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(channelDirectLineSpeech).
		Do(ctx).
		Into(result)
	return
}
...
func (c *channelDirectLineSpeeches) Update(ctx context.Context, channelDirectLineSpeech *v1alpha1.ChannelDirectLineSpeech, opts v1.UpdateOptions) (result *v1alpha1.ChannelDirectLineSpeech, err error) {
	result = &v1alpha1.ChannelDirectLineSpeech{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("channeldirectlinespeeches").
		Name(channelDirectLineSpeech.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(channelDirectLineSpeech).
		Do(ctx).
		Into(result)
...
func (c *channelDirectLineSpeeches) UpdateStatus(ctx context.Context, channelDirectLineSpeech *v1alpha1.ChannelDirectLineSpeech, opts v1.UpdateOptions) (result *v1alpha1.ChannelDirectLineSpeech, err error) {
	result = &v1alpha1.ChannelDirectLineSpeech{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("channeldirectlinespeeches").
...
func (c *channelDirectLineSpeeches) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *channelDirectLineSpeeches) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *channelDirectLineSpeeches) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ChannelDirectLineSpeech, err error) {
	result = &v1alpha1.ChannelDirectLineSpeech{}
