...
// DisksPoolsGetter has a method to return a DisksPoolInterface.
...
// disksPools implements DisksPoolInterface
type disksPools struct {
	client rest.Interface
	ns     string
}

// newDisksPools returns a DisksPools
func newDisksPools(c *StorageV1alpha1Client, namespace string) *disksPools {
	return &disksPools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *disksPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DisksPool, err error) {
	result = &v1alpha1.DisksPool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("diskspools").
		Name(name).
...
func (c *disksPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DisksPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DisksPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("diskspools").
...
func (c *disksPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *disksPools) Create(ctx context.Context, disksPool *v1alpha1.DisksPool, opts v1.CreateOptions) (result *v1alpha1.DisksPool, err error) {
	result = &v1alpha1.DisksPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("diskspools").
...
func (c *disksPools) Update(ctx context.Context, disksPool *v1alpha1.DisksPool, opts v1.UpdateOptions) (result *v1alpha1.DisksPool, err error) {
	result = &v1alpha1.DisksPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskspools").
...
func (c *disksPools) UpdateStatus(ctx context.Context, disksPool *v1alpha1.DisksPool, opts v1.UpdateOptions) (result *v1alpha1.DisksPool, err error) {
	result = &v1alpha1.DisksPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskspools").
...
func (c *disksPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *disksPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *disksPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DisksPool, err error) {
	result = &v1alpha1.DisksPool{}
