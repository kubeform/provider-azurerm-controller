...
// FactoryTriggerBlobEventsGetter has a method to return a FactoryTriggerBlobEventInterface.
...
// factoryTriggerBlobEvents implements FactoryTriggerBlobEventInterface
type factoryTriggerBlobEvents struct {
	client rest.Interface
	ns     string
}

// newFactoryTriggerBlobEvents returns a FactoryTriggerBlobEvents
func newFactoryTriggerBlobEvents(c *DataV1alpha1Client, namespace string) *factoryTriggerBlobEvents {
	return &factoryTriggerBlobEvents{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryTriggerBlobEvents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryTriggerBlobEvent, err error) {
	result = &v1alpha1.FactoryTriggerBlobEvent{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryTriggerBlobEvents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryTriggerBlobEventList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryTriggerBlobEventList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorytriggerblobevents").
...
func (c *factoryTriggerBlobEvents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryTriggerBlobEvents) Create(ctx context.Context, factoryTriggerBlobEvent *v1alpha1.FactoryTriggerBlobEvent, opts v1.CreateOptions) (result *v1alpha1.FactoryTriggerBlobEvent, err error) {
	result = &v1alpha1.FactoryTriggerBlobEvent{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorytriggerblobevents").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryTriggerBlobEvent).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryTriggerBlobEvents) Update(ctx context.Context, factoryTriggerBlobEvent *v1alpha1.FactoryTriggerBlobEvent, opts v1.UpdateOptions) (result *v1alpha1.FactoryTriggerBlobEvent, err error) {
	result = &v1alpha1.FactoryTriggerBlobEvent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorytriggerblobevents").
		Name(factoryTriggerBlobEvent.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryTriggerBlobEvent).
		Do(ctx).
		Into(result)
...
func (c *factoryTriggerBlobEvents) UpdateStatus(ctx context.Context, factoryTriggerBlobEvent *v1alpha1.FactoryTriggerBlobEvent, opts v1.UpdateOptions) (result *v1alpha1.FactoryTriggerBlobEvent, err error) {
	result = &v1alpha1.FactoryTriggerBlobEvent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorytriggerblobevents").
...
func (c *factoryTriggerBlobEvents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryTriggerBlobEvents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryTriggerBlobEvents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryTriggerBlobEvent, err error) {
	result = &v1alpha1.FactoryTriggerBlobEvent{}
