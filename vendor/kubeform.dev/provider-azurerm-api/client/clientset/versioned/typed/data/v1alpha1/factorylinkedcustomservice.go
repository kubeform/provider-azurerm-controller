...
// FactoryLinkedCustomServicesGetter has a method to return a FactoryLinkedCustomServiceInterface.
...
// factoryLinkedCustomServices implements FactoryLinkedCustomServiceInterface
type factoryLinkedCustomServices struct {
	client rest.Interface
	ns     string
}

// newFactoryLinkedCustomServices returns a FactoryLinkedCustomServices
func newFactoryLinkedCustomServices(c *DataV1alpha1Client, namespace string) *factoryLinkedCustomServices {
	return &factoryLinkedCustomServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryLinkedCustomServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryLinkedCustomService, err error) {
	result = &v1alpha1.FactoryLinkedCustomService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryLinkedCustomServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryLinkedCustomServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryLinkedCustomServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorylinkedcustomservices").
...
func (c *factoryLinkedCustomServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryLinkedCustomServices) Create(ctx context.Context, factoryLinkedCustomService *v1alpha1.FactoryLinkedCustomService, opts v1.CreateOptions) (result *v1alpha1.FactoryLinkedCustomService, err error) {
	result = &v1alpha1.FactoryLinkedCustomService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorylinkedcustomservices").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedCustomService).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryLinkedCustomServices) Update(ctx context.Context, factoryLinkedCustomService *v1alpha1.FactoryLinkedCustomService, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedCustomService, err error) {
	result = &v1alpha1.FactoryLinkedCustomService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedcustomservices").
		Name(factoryLinkedCustomService.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedCustomService).
		Do(ctx).
		Into(result)
...
func (c *factoryLinkedCustomServices) UpdateStatus(ctx context.Context, factoryLinkedCustomService *v1alpha1.FactoryLinkedCustomService, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedCustomService, err error) {
	result = &v1alpha1.FactoryLinkedCustomService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedcustomservices").
...
func (c *factoryLinkedCustomServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryLinkedCustomServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryLinkedCustomServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryLinkedCustomService, err error) {
	result = &v1alpha1.FactoryLinkedCustomService{}
