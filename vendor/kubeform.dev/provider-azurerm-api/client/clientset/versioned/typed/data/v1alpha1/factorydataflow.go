...
// FactoryDataFlowsGetter has a method to return a FactoryDataFlowInterface.
...
// factoryDataFlows implements FactoryDataFlowInterface
type factoryDataFlows struct {
	client rest.Interface
	ns     string
}

// newFactoryDataFlows returns a FactoryDataFlows
func newFactoryDataFlows(c *DataV1alpha1Client, namespace string) *factoryDataFlows {
	return &factoryDataFlows{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryDataFlows) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryDataFlow, err error) {
	result = &v1alpha1.FactoryDataFlow{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryDataFlows) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryDataFlowList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryDataFlowList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorydataflows").
...
func (c *factoryDataFlows) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryDataFlows) Create(ctx context.Context, factoryDataFlow *v1alpha1.FactoryDataFlow, opts v1.CreateOptions) (result *v1alpha1.FactoryDataFlow, err error) {
	result = &v1alpha1.FactoryDataFlow{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorydataflows").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDataFlow).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryDataFlows) Update(ctx context.Context, factoryDataFlow *v1alpha1.FactoryDataFlow, opts v1.UpdateOptions) (result *v1alpha1.FactoryDataFlow, err error) {
	result = &v1alpha1.FactoryDataFlow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydataflows").
		Name(factoryDataFlow.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDataFlow).
		Do(ctx).
		Into(result)
...
func (c *factoryDataFlows) UpdateStatus(ctx context.Context, factoryDataFlow *v1alpha1.FactoryDataFlow, opts v1.UpdateOptions) (result *v1alpha1.FactoryDataFlow, err error) {
	result = &v1alpha1.FactoryDataFlow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydataflows").
...
func (c *factoryDataFlows) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryDataFlows) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryDataFlows) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryDataFlow, err error) {
	result = &v1alpha1.FactoryDataFlow{}
