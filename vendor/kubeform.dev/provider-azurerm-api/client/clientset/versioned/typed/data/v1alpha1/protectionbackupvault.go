...
// ProtectionBackupVaultsGetter has a method to return a ProtectionBackupVaultInterface.
...
// protectionBackupVaults implements ProtectionBackupVaultInterface
type protectionBackupVaults struct {
	client rest.Interface
	ns     string
}

// newProtectionBackupVaults returns a ProtectionBackupVaults
func newProtectionBackupVaults(c *DataV1alpha1Client, namespace string) *protectionBackupVaults {
	return &protectionBackupVaults{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *protectionBackupVaults) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProtectionBackupVault, err error) {
	result = &v1alpha1.ProtectionBackupVault{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *protectionBackupVaults) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProtectionBackupVaultList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProtectionBackupVaultList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("protectionbackupvaults").
...
func (c *protectionBackupVaults) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *protectionBackupVaults) Create(ctx context.Context, protectionBackupVault *v1alpha1.ProtectionBackupVault, opts v1.CreateOptions) (result *v1alpha1.ProtectionBackupVault, err error) {
	result = &v1alpha1.ProtectionBackupVault{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("protectionbackupvaults").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectionBackupVault).
		Do(ctx).
		Into(result)
	return
}
...
func (c *protectionBackupVaults) Update(ctx context.Context, protectionBackupVault *v1alpha1.ProtectionBackupVault, opts v1.UpdateOptions) (result *v1alpha1.ProtectionBackupVault, err error) {
	result = &v1alpha1.ProtectionBackupVault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectionbackupvaults").
		Name(protectionBackupVault.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectionBackupVault).
		Do(ctx).
		Into(result)
...
func (c *protectionBackupVaults) UpdateStatus(ctx context.Context, protectionBackupVault *v1alpha1.ProtectionBackupVault, opts v1.UpdateOptions) (result *v1alpha1.ProtectionBackupVault, err error) {
	result = &v1alpha1.ProtectionBackupVault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectionbackupvaults").
...
func (c *protectionBackupVaults) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *protectionBackupVaults) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *protectionBackupVaults) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProtectionBackupVault, err error) {
	result = &v1alpha1.ProtectionBackupVault{}
