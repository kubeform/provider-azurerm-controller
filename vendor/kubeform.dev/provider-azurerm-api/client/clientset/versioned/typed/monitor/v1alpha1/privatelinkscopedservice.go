...
// PrivateLinkScopedServicesGetter has a method to return a PrivateLinkScopedServiceInterface.
...
// privateLinkScopedServices implements PrivateLinkScopedServiceInterface
type privateLinkScopedServices struct {
	client rest.Interface
	ns     string
}

// newPrivateLinkScopedServices returns a PrivateLinkScopedServices
func newPrivateLinkScopedServices(c *MonitorV1alpha1Client, namespace string) *privateLinkScopedServices {
	return &privateLinkScopedServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *privateLinkScopedServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrivateLinkScopedService, err error) {
	result = &v1alpha1.PrivateLinkScopedService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *privateLinkScopedServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrivateLinkScopedServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PrivateLinkScopedServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("privatelinkscopedservices").
...
func (c *privateLinkScopedServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *privateLinkScopedServices) Create(ctx context.Context, privateLinkScopedService *v1alpha1.PrivateLinkScopedService, opts v1.CreateOptions) (result *v1alpha1.PrivateLinkScopedService, err error) {
	result = &v1alpha1.PrivateLinkScopedService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("privatelinkscopedservices").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateLinkScopedService).
		Do(ctx).
		Into(result)
	return
}
...
func (c *privateLinkScopedServices) Update(ctx context.Context, privateLinkScopedService *v1alpha1.PrivateLinkScopedService, opts v1.UpdateOptions) (result *v1alpha1.PrivateLinkScopedService, err error) {
	result = &v1alpha1.PrivateLinkScopedService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatelinkscopedservices").
		Name(privateLinkScopedService.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateLinkScopedService).
		Do(ctx).
		Into(result)
...
func (c *privateLinkScopedServices) UpdateStatus(ctx context.Context, privateLinkScopedService *v1alpha1.PrivateLinkScopedService, opts v1.UpdateOptions) (result *v1alpha1.PrivateLinkScopedService, err error) {
	result = &v1alpha1.PrivateLinkScopedService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatelinkscopedservices").
...
func (c *privateLinkScopedServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *privateLinkScopedServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *privateLinkScopedServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrivateLinkScopedService, err error) {
	result = &v1alpha1.PrivateLinkScopedService{}
