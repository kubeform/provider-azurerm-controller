...
// PrivateLinkScopesGetter has a method to return a PrivateLinkScopeInterface.
...
// privateLinkScopes implements PrivateLinkScopeInterface
type privateLinkScopes struct {
	client rest.Interface
	ns     string
}

// newPrivateLinkScopes returns a PrivateLinkScopes
func newPrivateLinkScopes(c *MonitorV1alpha1Client, namespace string) *privateLinkScopes {
...
func (c *privateLinkScopes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrivateLinkScope, err error) {
	result = &v1alpha1.PrivateLinkScope{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *privateLinkScopes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrivateLinkScopeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PrivateLinkScopeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("privatelinkscopes").
...
func (c *privateLinkScopes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *privateLinkScopes) Create(ctx context.Context, privateLinkScope *v1alpha1.PrivateLinkScope, opts v1.CreateOptions) (result *v1alpha1.PrivateLinkScope, err error) {
	result = &v1alpha1.PrivateLinkScope{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("privatelinkscopes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateLinkScope).
		Do(ctx).
		Into(result)
	return
}
...
func (c *privateLinkScopes) Update(ctx context.Context, privateLinkScope *v1alpha1.PrivateLinkScope, opts v1.UpdateOptions) (result *v1alpha1.PrivateLinkScope, err error) {
	result = &v1alpha1.PrivateLinkScope{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatelinkscopes").
...
func (c *privateLinkScopes) UpdateStatus(ctx context.Context, privateLinkScope *v1alpha1.PrivateLinkScope, opts v1.UpdateOptions) (result *v1alpha1.PrivateLinkScope, err error) {
	result = &v1alpha1.PrivateLinkScope{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatelinkscopes").
...
func (c *privateLinkScopes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *privateLinkScopes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *privateLinkScopes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrivateLinkScope, err error) {
	result = &v1alpha1.PrivateLinkScope{}
