...
// StandardsGetter has a method to return a StandardInterface.
...
// standards implements StandardInterface
type standards struct {
	client rest.Interface
	ns     string
}

// newStandards returns a Standards
func newStandards(c *LogicappV1alpha1Client, namespace string) *standards {
	return &standards{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *standards) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Standard, err error) {
	result = &v1alpha1.Standard{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("standards").
		Name(name).
...
func (c *standards) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StandardList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StandardList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("standards").
...
func (c *standards) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *standards) Create(ctx context.Context, standard *v1alpha1.Standard, opts v1.CreateOptions) (result *v1alpha1.Standard, err error) {
	result = &v1alpha1.Standard{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("standards").
...
func (c *standards) Update(ctx context.Context, standard *v1alpha1.Standard, opts v1.UpdateOptions) (result *v1alpha1.Standard, err error) {
	result = &v1alpha1.Standard{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("standards").
...
func (c *standards) UpdateStatus(ctx context.Context, standard *v1alpha1.Standard, opts v1.UpdateOptions) (result *v1alpha1.Standard, err error) {
	result = &v1alpha1.Standard{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("standards").
...
func (c *standards) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *standards) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *standards) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Standard, err error) {
	result = &v1alpha1.Standard{}
