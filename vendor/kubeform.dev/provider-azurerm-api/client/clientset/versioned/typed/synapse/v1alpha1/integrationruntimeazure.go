...
// IntegrationRuntimeAzuresGetter has a method to return a IntegrationRuntimeAzureInterface.
...
// integrationRuntimeAzures implements IntegrationRuntimeAzureInterface
type integrationRuntimeAzures struct {
	client rest.Interface
	ns     string
}

// newIntegrationRuntimeAzures returns a IntegrationRuntimeAzures
func newIntegrationRuntimeAzures(c *SynapseV1alpha1Client, namespace string) *integrationRuntimeAzures {
	return &integrationRuntimeAzures{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *integrationRuntimeAzures) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IntegrationRuntimeAzure, err error) {
	result = &v1alpha1.IntegrationRuntimeAzure{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *integrationRuntimeAzures) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IntegrationRuntimeAzureList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IntegrationRuntimeAzureList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("integrationruntimeazures").
...
func (c *integrationRuntimeAzures) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *integrationRuntimeAzures) Create(ctx context.Context, integrationRuntimeAzure *v1alpha1.IntegrationRuntimeAzure, opts v1.CreateOptions) (result *v1alpha1.IntegrationRuntimeAzure, err error) {
	result = &v1alpha1.IntegrationRuntimeAzure{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("integrationruntimeazures").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationRuntimeAzure).
		Do(ctx).
		Into(result)
	return
}
...
func (c *integrationRuntimeAzures) Update(ctx context.Context, integrationRuntimeAzure *v1alpha1.IntegrationRuntimeAzure, opts v1.UpdateOptions) (result *v1alpha1.IntegrationRuntimeAzure, err error) {
	result = &v1alpha1.IntegrationRuntimeAzure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationruntimeazures").
		Name(integrationRuntimeAzure.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationRuntimeAzure).
		Do(ctx).
		Into(result)
...
func (c *integrationRuntimeAzures) UpdateStatus(ctx context.Context, integrationRuntimeAzure *v1alpha1.IntegrationRuntimeAzure, opts v1.UpdateOptions) (result *v1alpha1.IntegrationRuntimeAzure, err error) {
	result = &v1alpha1.IntegrationRuntimeAzure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationruntimeazures").
...
func (c *integrationRuntimeAzures) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *integrationRuntimeAzures) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *integrationRuntimeAzures) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IntegrationRuntimeAzure, err error) {
	result = &v1alpha1.IntegrationRuntimeAzure{}
