...
// WorkspaceKeysGetter has a method to return a WorkspaceKeyInterface.
...
// workspaceKeys implements WorkspaceKeyInterface
type workspaceKeys struct {
	client rest.Interface
	ns     string
}

// newWorkspaceKeys returns a WorkspaceKeys
func newWorkspaceKeys(c *SynapseV1alpha1Client, namespace string) *workspaceKeys {
...
func (c *workspaceKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WorkspaceKey, err error) {
	result = &v1alpha1.WorkspaceKey{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *workspaceKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WorkspaceKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.WorkspaceKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("workspacekeys").
...
func (c *workspaceKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *workspaceKeys) Create(ctx context.Context, workspaceKey *v1alpha1.WorkspaceKey, opts v1.CreateOptions) (result *v1alpha1.WorkspaceKey, err error) {
	result = &v1alpha1.WorkspaceKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("workspacekeys").
...
func (c *workspaceKeys) Update(ctx context.Context, workspaceKey *v1alpha1.WorkspaceKey, opts v1.UpdateOptions) (result *v1alpha1.WorkspaceKey, err error) {
	result = &v1alpha1.WorkspaceKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workspacekeys").
...
func (c *workspaceKeys) UpdateStatus(ctx context.Context, workspaceKey *v1alpha1.WorkspaceKey, opts v1.UpdateOptions) (result *v1alpha1.WorkspaceKey, err error) {
	result = &v1alpha1.WorkspaceKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workspacekeys").
...
func (c *workspaceKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *workspaceKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *workspaceKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WorkspaceKey, err error) {
	result = &v1alpha1.WorkspaceKey{}
