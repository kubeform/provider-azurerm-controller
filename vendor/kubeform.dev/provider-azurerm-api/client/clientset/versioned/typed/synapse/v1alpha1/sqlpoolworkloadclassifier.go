...
// SqlPoolWorkloadClassifiersGetter has a method to return a SqlPoolWorkloadClassifierInterface.
...
// sqlPoolWorkloadClassifiers implements SqlPoolWorkloadClassifierInterface
type sqlPoolWorkloadClassifiers struct {
	client rest.Interface
	ns     string
}

// newSqlPoolWorkloadClassifiers returns a SqlPoolWorkloadClassifiers
func newSqlPoolWorkloadClassifiers(c *SynapseV1alpha1Client, namespace string) *sqlPoolWorkloadClassifiers {
...
func (c *sqlPoolWorkloadClassifiers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlPoolWorkloadClassifier, err error) {
	result = &v1alpha1.SqlPoolWorkloadClassifier{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *sqlPoolWorkloadClassifiers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlPoolWorkloadClassifierList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SqlPoolWorkloadClassifierList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sqlpoolworkloadclassifiers").
...
func (c *sqlPoolWorkloadClassifiers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlPoolWorkloadClassifiers) Create(ctx context.Context, sqlPoolWorkloadClassifier *v1alpha1.SqlPoolWorkloadClassifier, opts v1.CreateOptions) (result *v1alpha1.SqlPoolWorkloadClassifier, err error) {
	result = &v1alpha1.SqlPoolWorkloadClassifier{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlpoolworkloadclassifiers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sqlPoolWorkloadClassifier).
		Do(ctx).
		Into(result)
	return
}
...
func (c *sqlPoolWorkloadClassifiers) Update(ctx context.Context, sqlPoolWorkloadClassifier *v1alpha1.SqlPoolWorkloadClassifier, opts v1.UpdateOptions) (result *v1alpha1.SqlPoolWorkloadClassifier, err error) {
	result = &v1alpha1.SqlPoolWorkloadClassifier{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpoolworkloadclassifiers").
		Name(sqlPoolWorkloadClassifier.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sqlPoolWorkloadClassifier).
		Do(ctx).
		Into(result)
...
func (c *sqlPoolWorkloadClassifiers) UpdateStatus(ctx context.Context, sqlPoolWorkloadClassifier *v1alpha1.SqlPoolWorkloadClassifier, opts v1.UpdateOptions) (result *v1alpha1.SqlPoolWorkloadClassifier, err error) {
	result = &v1alpha1.SqlPoolWorkloadClassifier{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpoolworkloadclassifiers").
...
func (c *sqlPoolWorkloadClassifiers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlPoolWorkloadClassifiers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlPoolWorkloadClassifiers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlPoolWorkloadClassifier, err error) {
	result = &v1alpha1.SqlPoolWorkloadClassifier{}
