...
// IntegrationRuntimeSelfHostedsGetter has a method to return a IntegrationRuntimeSelfHostedInterface.
...
// integrationRuntimeSelfHosteds implements IntegrationRuntimeSelfHostedInterface
type integrationRuntimeSelfHosteds struct {
	client rest.Interface
	ns     string
}

// newIntegrationRuntimeSelfHosteds returns a IntegrationRuntimeSelfHosteds
func newIntegrationRuntimeSelfHosteds(c *SynapseV1alpha1Client, namespace string) *integrationRuntimeSelfHosteds {
	return &integrationRuntimeSelfHosteds{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *integrationRuntimeSelfHosteds) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IntegrationRuntimeSelfHosted, err error) {
	result = &v1alpha1.IntegrationRuntimeSelfHosted{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *integrationRuntimeSelfHosteds) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IntegrationRuntimeSelfHostedList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IntegrationRuntimeSelfHostedList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("integrationruntimeselfhosteds").
...
func (c *integrationRuntimeSelfHosteds) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *integrationRuntimeSelfHosteds) Create(ctx context.Context, integrationRuntimeSelfHosted *v1alpha1.IntegrationRuntimeSelfHosted, opts v1.CreateOptions) (result *v1alpha1.IntegrationRuntimeSelfHosted, err error) {
	result = &v1alpha1.IntegrationRuntimeSelfHosted{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("integrationruntimeselfhosteds").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationRuntimeSelfHosted).
		Do(ctx).
		Into(result)
	return
}
...
func (c *integrationRuntimeSelfHosteds) Update(ctx context.Context, integrationRuntimeSelfHosted *v1alpha1.IntegrationRuntimeSelfHosted, opts v1.UpdateOptions) (result *v1alpha1.IntegrationRuntimeSelfHosted, err error) {
	result = &v1alpha1.IntegrationRuntimeSelfHosted{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationruntimeselfhosteds").
		Name(integrationRuntimeSelfHosted.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationRuntimeSelfHosted).
		Do(ctx).
		Into(result)
...
func (c *integrationRuntimeSelfHosteds) UpdateStatus(ctx context.Context, integrationRuntimeSelfHosted *v1alpha1.IntegrationRuntimeSelfHosted, opts v1.UpdateOptions) (result *v1alpha1.IntegrationRuntimeSelfHosted, err error) {
	result = &v1alpha1.IntegrationRuntimeSelfHosted{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationruntimeselfhosteds").
...
func (c *integrationRuntimeSelfHosteds) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *integrationRuntimeSelfHosteds) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *integrationRuntimeSelfHosteds) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IntegrationRuntimeSelfHosted, err error) {
	result = &v1alpha1.IntegrationRuntimeSelfHosted{}
