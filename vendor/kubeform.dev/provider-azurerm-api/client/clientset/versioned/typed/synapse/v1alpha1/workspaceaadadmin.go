...
// WorkspaceAadAdminsGetter has a method to return a WorkspaceAadAdminInterface.
...
// workspaceAadAdmins implements WorkspaceAadAdminInterface
type workspaceAadAdmins struct {
	client rest.Interface
	ns     string
}

// newWorkspaceAadAdmins returns a WorkspaceAadAdmins
func newWorkspaceAadAdmins(c *SynapseV1alpha1Client, namespace string) *workspaceAadAdmins {
...
func (c *workspaceAadAdmins) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WorkspaceAadAdmin, err error) {
	result = &v1alpha1.WorkspaceAadAdmin{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *workspaceAadAdmins) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WorkspaceAadAdminList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.WorkspaceAadAdminList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("workspaceaadadmins").
...
func (c *workspaceAadAdmins) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *workspaceAadAdmins) Create(ctx context.Context, workspaceAadAdmin *v1alpha1.WorkspaceAadAdmin, opts v1.CreateOptions) (result *v1alpha1.WorkspaceAadAdmin, err error) {
	result = &v1alpha1.WorkspaceAadAdmin{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("workspaceaadadmins").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(workspaceAadAdmin).
		Do(ctx).
		Into(result)
	return
}
...
func (c *workspaceAadAdmins) Update(ctx context.Context, workspaceAadAdmin *v1alpha1.WorkspaceAadAdmin, opts v1.UpdateOptions) (result *v1alpha1.WorkspaceAadAdmin, err error) {
	result = &v1alpha1.WorkspaceAadAdmin{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workspaceaadadmins").
		Name(workspaceAadAdmin.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(workspaceAadAdmin).
		Do(ctx).
		Into(result)
...
func (c *workspaceAadAdmins) UpdateStatus(ctx context.Context, workspaceAadAdmin *v1alpha1.WorkspaceAadAdmin, opts v1.UpdateOptions) (result *v1alpha1.WorkspaceAadAdmin, err error) {
	result = &v1alpha1.WorkspaceAadAdmin{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workspaceaadadmins").
...
func (c *workspaceAadAdmins) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *workspaceAadAdmins) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *workspaceAadAdmins) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WorkspaceAadAdmin, err error) {
	result = &v1alpha1.WorkspaceAadAdmin{}
