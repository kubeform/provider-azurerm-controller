...
// SqlPoolExtendedAuditingPoliciesGetter has a method to return a SqlPoolExtendedAuditingPolicyInterface.
...
// sqlPoolExtendedAuditingPolicies implements SqlPoolExtendedAuditingPolicyInterface
type sqlPoolExtendedAuditingPolicies struct {
	client rest.Interface
	ns     string
}

// newSqlPoolExtendedAuditingPolicies returns a SqlPoolExtendedAuditingPolicies
func newSqlPoolExtendedAuditingPolicies(c *SynapseV1alpha1Client, namespace string) *sqlPoolExtendedAuditingPolicies {
	return &sqlPoolExtendedAuditingPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *sqlPoolExtendedAuditingPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlPoolExtendedAuditingPolicy, err error) {
	result = &v1alpha1.SqlPoolExtendedAuditingPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *sqlPoolExtendedAuditingPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlPoolExtendedAuditingPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SqlPoolExtendedAuditingPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sqlpoolextendedauditingpolicies").
...
func (c *sqlPoolExtendedAuditingPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlPoolExtendedAuditingPolicies) Create(ctx context.Context, sqlPoolExtendedAuditingPolicy *v1alpha1.SqlPoolExtendedAuditingPolicy, opts v1.CreateOptions) (result *v1alpha1.SqlPoolExtendedAuditingPolicy, err error) {
	result = &v1alpha1.SqlPoolExtendedAuditingPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlpoolextendedauditingpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sqlPoolExtendedAuditingPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *sqlPoolExtendedAuditingPolicies) Update(ctx context.Context, sqlPoolExtendedAuditingPolicy *v1alpha1.SqlPoolExtendedAuditingPolicy, opts v1.UpdateOptions) (result *v1alpha1.SqlPoolExtendedAuditingPolicy, err error) {
	result = &v1alpha1.SqlPoolExtendedAuditingPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpoolextendedauditingpolicies").
		Name(sqlPoolExtendedAuditingPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sqlPoolExtendedAuditingPolicy).
		Do(ctx).
		Into(result)
...
func (c *sqlPoolExtendedAuditingPolicies) UpdateStatus(ctx context.Context, sqlPoolExtendedAuditingPolicy *v1alpha1.SqlPoolExtendedAuditingPolicy, opts v1.UpdateOptions) (result *v1alpha1.SqlPoolExtendedAuditingPolicy, err error) {
	result = &v1alpha1.SqlPoolExtendedAuditingPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpoolextendedauditingpolicies").
...
func (c *sqlPoolExtendedAuditingPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlPoolExtendedAuditingPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlPoolExtendedAuditingPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlPoolExtendedAuditingPolicy, err error) {
	result = &v1alpha1.SqlPoolExtendedAuditingPolicy{}
