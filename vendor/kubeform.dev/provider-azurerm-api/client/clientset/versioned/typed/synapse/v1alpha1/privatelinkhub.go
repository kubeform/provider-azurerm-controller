...
// PrivateLinkHubsGetter has a method to return a PrivateLinkHubInterface.
...
// privateLinkHubs implements PrivateLinkHubInterface
type privateLinkHubs struct {
	client rest.Interface
	ns     string
}

// newPrivateLinkHubs returns a PrivateLinkHubs
func newPrivateLinkHubs(c *SynapseV1alpha1Client, namespace string) *privateLinkHubs {
...
func (c *privateLinkHubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrivateLinkHub, err error) {
	result = &v1alpha1.PrivateLinkHub{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *privateLinkHubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrivateLinkHubList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PrivateLinkHubList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("privatelinkhubs").
...
func (c *privateLinkHubs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *privateLinkHubs) Create(ctx context.Context, privateLinkHub *v1alpha1.PrivateLinkHub, opts v1.CreateOptions) (result *v1alpha1.PrivateLinkHub, err error) {
	result = &v1alpha1.PrivateLinkHub{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("privatelinkhubs").
...
func (c *privateLinkHubs) Update(ctx context.Context, privateLinkHub *v1alpha1.PrivateLinkHub, opts v1.UpdateOptions) (result *v1alpha1.PrivateLinkHub, err error) {
	result = &v1alpha1.PrivateLinkHub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatelinkhubs").
		Name(privateLinkHub.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateLinkHub).
		Do(ctx).
		Into(result)
...
func (c *privateLinkHubs) UpdateStatus(ctx context.Context, privateLinkHub *v1alpha1.PrivateLinkHub, opts v1.UpdateOptions) (result *v1alpha1.PrivateLinkHub, err error) {
	result = &v1alpha1.PrivateLinkHub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatelinkhubs").
...
func (c *privateLinkHubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *privateLinkHubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *privateLinkHubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrivateLinkHub, err error) {
	result = &v1alpha1.PrivateLinkHub{}
