...
// SqlPoolSecurityAlertPoliciesGetter has a method to return a SqlPoolSecurityAlertPolicyInterface.
...
// sqlPoolSecurityAlertPolicies implements SqlPoolSecurityAlertPolicyInterface
type sqlPoolSecurityAlertPolicies struct {
	client rest.Interface
	ns     string
}

// newSqlPoolSecurityAlertPolicies returns a SqlPoolSecurityAlertPolicies
func newSqlPoolSecurityAlertPolicies(c *SynapseV1alpha1Client, namespace string) *sqlPoolSecurityAlertPolicies {
...
func (c *sqlPoolSecurityAlertPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlPoolSecurityAlertPolicy, err error) {
	result = &v1alpha1.SqlPoolSecurityAlertPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *sqlPoolSecurityAlertPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlPoolSecurityAlertPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SqlPoolSecurityAlertPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sqlpoolsecurityalertpolicies").
...
func (c *sqlPoolSecurityAlertPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlPoolSecurityAlertPolicies) Create(ctx context.Context, sqlPoolSecurityAlertPolicy *v1alpha1.SqlPoolSecurityAlertPolicy, opts v1.CreateOptions) (result *v1alpha1.SqlPoolSecurityAlertPolicy, err error) {
	result = &v1alpha1.SqlPoolSecurityAlertPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlpoolsecurityalertpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sqlPoolSecurityAlertPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *sqlPoolSecurityAlertPolicies) Update(ctx context.Context, sqlPoolSecurityAlertPolicy *v1alpha1.SqlPoolSecurityAlertPolicy, opts v1.UpdateOptions) (result *v1alpha1.SqlPoolSecurityAlertPolicy, err error) {
	result = &v1alpha1.SqlPoolSecurityAlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpoolsecurityalertpolicies").
		Name(sqlPoolSecurityAlertPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sqlPoolSecurityAlertPolicy).
		Do(ctx).
		Into(result)
...
func (c *sqlPoolSecurityAlertPolicies) UpdateStatus(ctx context.Context, sqlPoolSecurityAlertPolicy *v1alpha1.SqlPoolSecurityAlertPolicy, opts v1.UpdateOptions) (result *v1alpha1.SqlPoolSecurityAlertPolicy, err error) {
	result = &v1alpha1.SqlPoolSecurityAlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpoolsecurityalertpolicies").
...
func (c *sqlPoolSecurityAlertPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlPoolSecurityAlertPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlPoolSecurityAlertPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlPoolSecurityAlertPolicy, err error) {
	result = &v1alpha1.SqlPoolSecurityAlertPolicy{}
