...
// ManagedInstancesGetter has a method to return a ManagedInstanceInterface.
...
// managedInstances implements ManagedInstanceInterface
type managedInstances struct {
	client rest.Interface
	ns     string
}

// newManagedInstances returns a ManagedInstances
func newManagedInstances(c *MssqlV1alpha1Client, namespace string) *managedInstances {
...
func (c *managedInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedInstance, err error) {
	result = &v1alpha1.ManagedInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagedInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managedinstances").
...
func (c *managedInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedInstances) Create(ctx context.Context, managedInstance *v1alpha1.ManagedInstance, opts v1.CreateOptions) (result *v1alpha1.ManagedInstance, err error) {
	result = &v1alpha1.ManagedInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedinstances").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedInstance).
		Do(ctx).
		Into(result)
	return
}
...
func (c *managedInstances) Update(ctx context.Context, managedInstance *v1alpha1.ManagedInstance, opts v1.UpdateOptions) (result *v1alpha1.ManagedInstance, err error) {
	result = &v1alpha1.ManagedInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedinstances").
...
func (c *managedInstances) UpdateStatus(ctx context.Context, managedInstance *v1alpha1.ManagedInstance, opts v1.UpdateOptions) (result *v1alpha1.ManagedInstance, err error) {
	result = &v1alpha1.ManagedInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedinstances").
...
func (c *managedInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managedInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedInstance, err error) {
	result = &v1alpha1.ManagedInstance{}
