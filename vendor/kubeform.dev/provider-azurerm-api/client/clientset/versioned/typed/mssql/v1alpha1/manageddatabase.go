...
// ManagedDatabasesGetter has a method to return a ManagedDatabaseInterface.
...
// managedDatabases implements ManagedDatabaseInterface
type managedDatabases struct {
	client rest.Interface
	ns     string
}

// newManagedDatabases returns a ManagedDatabases
func newManagedDatabases(c *MssqlV1alpha1Client, namespace string) *managedDatabases {
...
func (c *managedDatabases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedDatabase, err error) {
	result = &v1alpha1.ManagedDatabase{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedDatabases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedDatabaseList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagedDatabaseList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("manageddatabases").
...
func (c *managedDatabases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedDatabases) Create(ctx context.Context, managedDatabase *v1alpha1.ManagedDatabase, opts v1.CreateOptions) (result *v1alpha1.ManagedDatabase, err error) {
	result = &v1alpha1.ManagedDatabase{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("manageddatabases").
...
func (c *managedDatabases) Update(ctx context.Context, managedDatabase *v1alpha1.ManagedDatabase, opts v1.UpdateOptions) (result *v1alpha1.ManagedDatabase, err error) {
	result = &v1alpha1.ManagedDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("manageddatabases").
...
func (c *managedDatabases) UpdateStatus(ctx context.Context, managedDatabase *v1alpha1.ManagedDatabase, opts v1.UpdateOptions) (result *v1alpha1.ManagedDatabase, err error) {
	result = &v1alpha1.ManagedDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("manageddatabases").
...
func (c *managedDatabases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managedDatabases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedDatabases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedDatabase, err error) {
	result = &v1alpha1.ManagedDatabase{}
