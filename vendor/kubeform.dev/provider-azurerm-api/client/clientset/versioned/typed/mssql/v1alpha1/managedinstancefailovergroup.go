...
// ManagedInstanceFailoverGroupsGetter has a method to return a ManagedInstanceFailoverGroupInterface.
...
// managedInstanceFailoverGroups implements ManagedInstanceFailoverGroupInterface
type managedInstanceFailoverGroups struct {
	client rest.Interface
	ns     string
}

// newManagedInstanceFailoverGroups returns a ManagedInstanceFailoverGroups
func newManagedInstanceFailoverGroups(c *MssqlV1alpha1Client, namespace string) *managedInstanceFailoverGroups {
	return &managedInstanceFailoverGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *managedInstanceFailoverGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedInstanceFailoverGroup, err error) {
	result = &v1alpha1.ManagedInstanceFailoverGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedInstanceFailoverGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedInstanceFailoverGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagedInstanceFailoverGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managedinstancefailovergroups").
...
func (c *managedInstanceFailoverGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedInstanceFailoverGroups) Create(ctx context.Context, managedInstanceFailoverGroup *v1alpha1.ManagedInstanceFailoverGroup, opts v1.CreateOptions) (result *v1alpha1.ManagedInstanceFailoverGroup, err error) {
	result = &v1alpha1.ManagedInstanceFailoverGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedinstancefailovergroups").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedInstanceFailoverGroup).
		Do(ctx).
		Into(result)
	return
}
...
func (c *managedInstanceFailoverGroups) Update(ctx context.Context, managedInstanceFailoverGroup *v1alpha1.ManagedInstanceFailoverGroup, opts v1.UpdateOptions) (result *v1alpha1.ManagedInstanceFailoverGroup, err error) {
	result = &v1alpha1.ManagedInstanceFailoverGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedinstancefailovergroups").
		Name(managedInstanceFailoverGroup.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedInstanceFailoverGroup).
		Do(ctx).
		Into(result)
...
func (c *managedInstanceFailoverGroups) UpdateStatus(ctx context.Context, managedInstanceFailoverGroup *v1alpha1.ManagedInstanceFailoverGroup, opts v1.UpdateOptions) (result *v1alpha1.ManagedInstanceFailoverGroup, err error) {
	result = &v1alpha1.ManagedInstanceFailoverGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedinstancefailovergroups").
...
func (c *managedInstanceFailoverGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managedInstanceFailoverGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedInstanceFailoverGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedInstanceFailoverGroup, err error) {
	result = &v1alpha1.ManagedInstanceFailoverGroup{}
