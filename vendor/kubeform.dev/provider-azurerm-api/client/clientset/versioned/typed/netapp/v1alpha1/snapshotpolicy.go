...
func newSnapshotPolicies(c *NetappV1alpha1Client, namespace string) *snapshotPolicies {
...
func (c *snapshotPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SnapshotPolicy, err error) {
...
func (c *snapshotPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SnapshotPolicyList, err error) {
...
func (c *snapshotPolicies) Create(ctx context.Context, snapshotPolicy *v1alpha1.SnapshotPolicy, opts v1.CreateOptions) (result *v1alpha1.SnapshotPolicy, err error) {
	result = &v1alpha1.SnapshotPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("snapshotpolicies").
...
func (c *snapshotPolicies) Update(ctx context.Context, snapshotPolicy *v1alpha1.SnapshotPolicy, opts v1.UpdateOptions) (result *v1alpha1.SnapshotPolicy, err error) {
	result = &v1alpha1.SnapshotPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snapshotpolicies").
...
func (c *snapshotPolicies) UpdateStatus(ctx context.Context, snapshotPolicy *v1alpha1.SnapshotPolicy, opts v1.UpdateOptions) (result *v1alpha1.SnapshotPolicy, err error) {
	result = &v1alpha1.SnapshotPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snapshotpolicies").
...
func (c *snapshotPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SnapshotPolicy, err error) {
	result = &v1alpha1.SnapshotPolicy{}
