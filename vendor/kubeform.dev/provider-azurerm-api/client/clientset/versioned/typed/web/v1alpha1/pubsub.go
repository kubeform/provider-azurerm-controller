...
func newPubsubs(c *WebV1alpha1Client, namespace string) *pubsubs {
	return &pubsubs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pubsubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Pubsub, err error) {
...
func (c *pubsubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PubsubList, err error) {
...
func (c *pubsubs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pubsubs) Create(ctx context.Context, pubsub *v1alpha1.Pubsub, opts v1.CreateOptions) (result *v1alpha1.Pubsub, err error) {
	result = &v1alpha1.Pubsub{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pubsubs").
...
func (c *pubsubs) Update(ctx context.Context, pubsub *v1alpha1.Pubsub, opts v1.UpdateOptions) (result *v1alpha1.Pubsub, err error) {
	result = &v1alpha1.Pubsub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubs").
...
func (c *pubsubs) UpdateStatus(ctx context.Context, pubsub *v1alpha1.Pubsub, opts v1.UpdateOptions) (result *v1alpha1.Pubsub, err error) {
	result = &v1alpha1.Pubsub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubs").
...
func (c *pubsubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pubsubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pubsubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Pubsub, err error) {
	result = &v1alpha1.Pubsub{}
