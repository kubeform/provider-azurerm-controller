...
// PubsubHubsGetter has a method to return a PubsubHubInterface.
...
// pubsubHubs implements PubsubHubInterface
type pubsubHubs struct {
	client rest.Interface
	ns     string
}

// newPubsubHubs returns a PubsubHubs
func newPubsubHubs(c *WebV1alpha1Client, namespace string) *pubsubHubs {
	return &pubsubHubs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pubsubHubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PubsubHub, err error) {
	result = &v1alpha1.PubsubHub{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pubsubhubs").
		Name(name).
...
func (c *pubsubHubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PubsubHubList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PubsubHubList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pubsubhubs").
...
func (c *pubsubHubs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pubsubHubs) Create(ctx context.Context, pubsubHub *v1alpha1.PubsubHub, opts v1.CreateOptions) (result *v1alpha1.PubsubHub, err error) {
	result = &v1alpha1.PubsubHub{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pubsubhubs").
...
func (c *pubsubHubs) Update(ctx context.Context, pubsubHub *v1alpha1.PubsubHub, opts v1.UpdateOptions) (result *v1alpha1.PubsubHub, err error) {
	result = &v1alpha1.PubsubHub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubhubs").
...
func (c *pubsubHubs) UpdateStatus(ctx context.Context, pubsubHub *v1alpha1.PubsubHub, opts v1.UpdateOptions) (result *v1alpha1.PubsubHub, err error) {
	result = &v1alpha1.PubsubHub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubhubs").
...
func (c *pubsubHubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pubsubHubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pubsubHubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PubsubHub, err error) {
	result = &v1alpha1.PubsubHub{}
