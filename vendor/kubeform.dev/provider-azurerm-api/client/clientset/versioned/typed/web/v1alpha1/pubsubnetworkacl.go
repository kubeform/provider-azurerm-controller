...
// PubsubNetworkACLsGetter has a method to return a PubsubNetworkACLInterface.
...
// pubsubNetworkACLs implements PubsubNetworkACLInterface
type pubsubNetworkACLs struct {
	client rest.Interface
	ns     string
}

// newPubsubNetworkACLs returns a PubsubNetworkACLs
func newPubsubNetworkACLs(c *WebV1alpha1Client, namespace string) *pubsubNetworkACLs {
	return &pubsubNetworkACLs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *pubsubNetworkACLs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PubsubNetworkACL, err error) {
	result = &v1alpha1.PubsubNetworkACL{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *pubsubNetworkACLs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PubsubNetworkACLList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PubsubNetworkACLList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pubsubnetworkacls").
...
func (c *pubsubNetworkACLs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pubsubNetworkACLs) Create(ctx context.Context, pubsubNetworkACL *v1alpha1.PubsubNetworkACL, opts v1.CreateOptions) (result *v1alpha1.PubsubNetworkACL, err error) {
	result = &v1alpha1.PubsubNetworkACL{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pubsubnetworkacls").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pubsubNetworkACL).
		Do(ctx).
		Into(result)
	return
}
...
func (c *pubsubNetworkACLs) Update(ctx context.Context, pubsubNetworkACL *v1alpha1.PubsubNetworkACL, opts v1.UpdateOptions) (result *v1alpha1.PubsubNetworkACL, err error) {
	result = &v1alpha1.PubsubNetworkACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubnetworkacls").
		Name(pubsubNetworkACL.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pubsubNetworkACL).
		Do(ctx).
		Into(result)
...
func (c *pubsubNetworkACLs) UpdateStatus(ctx context.Context, pubsubNetworkACL *v1alpha1.PubsubNetworkACL, opts v1.UpdateOptions) (result *v1alpha1.PubsubNetworkACL, err error) {
	result = &v1alpha1.PubsubNetworkACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubnetworkacls").
...
func (c *pubsubNetworkACLs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pubsubNetworkACLs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pubsubNetworkACLs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PubsubNetworkACL, err error) {
	result = &v1alpha1.PubsubNetworkACL{}
