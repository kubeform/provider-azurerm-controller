...
// WatchlistsGetter has a method to return a WatchlistInterface.
...
// watchlists implements WatchlistInterface
type watchlists struct {
	client rest.Interface
	ns     string
}

// newWatchlists returns a Watchlists
func newWatchlists(c *SentinelV1alpha1Client, namespace string) *watchlists {
	return &watchlists{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *watchlists) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Watchlist, err error) {
	result = &v1alpha1.Watchlist{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("watchlists").
		Name(name).
...
func (c *watchlists) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WatchlistList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.WatchlistList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("watchlists").
...
func (c *watchlists) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *watchlists) Create(ctx context.Context, watchlist *v1alpha1.Watchlist, opts v1.CreateOptions) (result *v1alpha1.Watchlist, err error) {
	result = &v1alpha1.Watchlist{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("watchlists").
...
func (c *watchlists) Update(ctx context.Context, watchlist *v1alpha1.Watchlist, opts v1.UpdateOptions) (result *v1alpha1.Watchlist, err error) {
	result = &v1alpha1.Watchlist{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("watchlists").
...
func (c *watchlists) UpdateStatus(ctx context.Context, watchlist *v1alpha1.Watchlist, opts v1.UpdateOptions) (result *v1alpha1.Watchlist, err error) {
	result = &v1alpha1.Watchlist{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("watchlists").
...
func (c *watchlists) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *watchlists) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *watchlists) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Watchlist, err error) {
	result = &v1alpha1.Watchlist{}
