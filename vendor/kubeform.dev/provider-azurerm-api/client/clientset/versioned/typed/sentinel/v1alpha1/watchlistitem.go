...
// WatchlistItemsGetter has a method to return a WatchlistItemInterface.
...
// watchlistItems implements WatchlistItemInterface
type watchlistItems struct {
	client rest.Interface
	ns     string
}

// newWatchlistItems returns a WatchlistItems
func newWatchlistItems(c *SentinelV1alpha1Client, namespace string) *watchlistItems {
...
func (c *watchlistItems) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WatchlistItem, err error) {
	result = &v1alpha1.WatchlistItem{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *watchlistItems) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WatchlistItemList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.WatchlistItemList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("watchlistitems").
...
func (c *watchlistItems) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *watchlistItems) Create(ctx context.Context, watchlistItem *v1alpha1.WatchlistItem, opts v1.CreateOptions) (result *v1alpha1.WatchlistItem, err error) {
	result = &v1alpha1.WatchlistItem{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("watchlistitems").
...
func (c *watchlistItems) Update(ctx context.Context, watchlistItem *v1alpha1.WatchlistItem, opts v1.UpdateOptions) (result *v1alpha1.WatchlistItem, err error) {
	result = &v1alpha1.WatchlistItem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("watchlistitems").
...
func (c *watchlistItems) UpdateStatus(ctx context.Context, watchlistItem *v1alpha1.WatchlistItem, opts v1.UpdateOptions) (result *v1alpha1.WatchlistItem, err error) {
	result = &v1alpha1.WatchlistItem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("watchlistitems").
...
func (c *watchlistItems) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *watchlistItems) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *watchlistItems) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WatchlistItem, err error) {
	result = &v1alpha1.WatchlistItem{}
