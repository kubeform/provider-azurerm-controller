...
// ManagedStorageAccountsGetter has a method to return a ManagedStorageAccountInterface.
...
// managedStorageAccounts implements ManagedStorageAccountInterface
type managedStorageAccounts struct {
	client rest.Interface
	ns     string
}

// newManagedStorageAccounts returns a ManagedStorageAccounts
func newManagedStorageAccounts(c *KeyvaultV1alpha1Client, namespace string) *managedStorageAccounts {
	return &managedStorageAccounts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *managedStorageAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedStorageAccount, err error) {
	result = &v1alpha1.ManagedStorageAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedStorageAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedStorageAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagedStorageAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managedstorageaccounts").
...
func (c *managedStorageAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedStorageAccounts) Create(ctx context.Context, managedStorageAccount *v1alpha1.ManagedStorageAccount, opts v1.CreateOptions) (result *v1alpha1.ManagedStorageAccount, err error) {
	result = &v1alpha1.ManagedStorageAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedstorageaccounts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedStorageAccount).
		Do(ctx).
		Into(result)
	return
}
...
func (c *managedStorageAccounts) Update(ctx context.Context, managedStorageAccount *v1alpha1.ManagedStorageAccount, opts v1.UpdateOptions) (result *v1alpha1.ManagedStorageAccount, err error) {
	result = &v1alpha1.ManagedStorageAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedstorageaccounts").
		Name(managedStorageAccount.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedStorageAccount).
		Do(ctx).
		Into(result)
...
func (c *managedStorageAccounts) UpdateStatus(ctx context.Context, managedStorageAccount *v1alpha1.ManagedStorageAccount, opts v1.UpdateOptions) (result *v1alpha1.ManagedStorageAccount, err error) {
	result = &v1alpha1.ManagedStorageAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedstorageaccounts").
...
func (c *managedStorageAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managedStorageAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedStorageAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedStorageAccount, err error) {
	result = &v1alpha1.ManagedStorageAccount{}
