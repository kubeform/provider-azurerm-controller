...
// DesktopScalingPlansGetter has a method to return a DesktopScalingPlanInterface.
...
// desktopScalingPlans implements DesktopScalingPlanInterface
type desktopScalingPlans struct {
	client rest.Interface
	ns     string
}

// newDesktopScalingPlans returns a DesktopScalingPlans
func newDesktopScalingPlans(c *VirtualV1alpha1Client, namespace string) *desktopScalingPlans {
	return &desktopScalingPlans{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *desktopScalingPlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DesktopScalingPlan, err error) {
	result = &v1alpha1.DesktopScalingPlan{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *desktopScalingPlans) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DesktopScalingPlanList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DesktopScalingPlanList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("desktopscalingplans").
...
func (c *desktopScalingPlans) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *desktopScalingPlans) Create(ctx context.Context, desktopScalingPlan *v1alpha1.DesktopScalingPlan, opts v1.CreateOptions) (result *v1alpha1.DesktopScalingPlan, err error) {
	result = &v1alpha1.DesktopScalingPlan{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("desktopscalingplans").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(desktopScalingPlan).
		Do(ctx).
		Into(result)
	return
}
...
func (c *desktopScalingPlans) Update(ctx context.Context, desktopScalingPlan *v1alpha1.DesktopScalingPlan, opts v1.UpdateOptions) (result *v1alpha1.DesktopScalingPlan, err error) {
	result = &v1alpha1.DesktopScalingPlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("desktopscalingplans").
		Name(desktopScalingPlan.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(desktopScalingPlan).
		Do(ctx).
		Into(result)
...
func (c *desktopScalingPlans) UpdateStatus(ctx context.Context, desktopScalingPlan *v1alpha1.DesktopScalingPlan, opts v1.UpdateOptions) (result *v1alpha1.DesktopScalingPlan, err error) {
	result = &v1alpha1.DesktopScalingPlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("desktopscalingplans").
...
func (c *desktopScalingPlans) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *desktopScalingPlans) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *desktopScalingPlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DesktopScalingPlan, err error) {
	result = &v1alpha1.DesktopScalingPlan{}
