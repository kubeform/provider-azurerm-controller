...
// DesktopApplicationsGetter has a method to return a DesktopApplicationInterface.
...
// desktopApplications implements DesktopApplicationInterface
type desktopApplications struct {
	client rest.Interface
	ns     string
}

// newDesktopApplications returns a DesktopApplications
func newDesktopApplications(c *VirtualV1alpha1Client, namespace string) *desktopApplications {
...
func (c *desktopApplications) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DesktopApplication, err error) {
	result = &v1alpha1.DesktopApplication{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *desktopApplications) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DesktopApplicationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DesktopApplicationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("desktopapplications").
...
func (c *desktopApplications) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *desktopApplications) Create(ctx context.Context, desktopApplication *v1alpha1.DesktopApplication, opts v1.CreateOptions) (result *v1alpha1.DesktopApplication, err error) {
	result = &v1alpha1.DesktopApplication{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("desktopapplications").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(desktopApplication).
		Do(ctx).
		Into(result)
	return
}
...
func (c *desktopApplications) Update(ctx context.Context, desktopApplication *v1alpha1.DesktopApplication, opts v1.UpdateOptions) (result *v1alpha1.DesktopApplication, err error) {
	result = &v1alpha1.DesktopApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("desktopapplications").
...
func (c *desktopApplications) UpdateStatus(ctx context.Context, desktopApplication *v1alpha1.DesktopApplication, opts v1.UpdateOptions) (result *v1alpha1.DesktopApplication, err error) {
	result = &v1alpha1.DesktopApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("desktopapplications").
...
func (c *desktopApplications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *desktopApplications) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *desktopApplications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DesktopApplication, err error) {
	result = &v1alpha1.DesktopApplication{}
