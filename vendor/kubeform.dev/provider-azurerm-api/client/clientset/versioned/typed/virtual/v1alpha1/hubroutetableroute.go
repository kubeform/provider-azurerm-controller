...
// HubRouteTableRoutesGetter has a method to return a HubRouteTableRouteInterface.
...
// hubRouteTableRoutes implements HubRouteTableRouteInterface
type hubRouteTableRoutes struct {
	client rest.Interface
	ns     string
}

// newHubRouteTableRoutes returns a HubRouteTableRoutes
func newHubRouteTableRoutes(c *VirtualV1alpha1Client, namespace string) *hubRouteTableRoutes {
	return &hubRouteTableRoutes{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *hubRouteTableRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HubRouteTableRoute, err error) {
	result = &v1alpha1.HubRouteTableRoute{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *hubRouteTableRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HubRouteTableRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HubRouteTableRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hubroutetableroutes").
...
func (c *hubRouteTableRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hubRouteTableRoutes) Create(ctx context.Context, hubRouteTableRoute *v1alpha1.HubRouteTableRoute, opts v1.CreateOptions) (result *v1alpha1.HubRouteTableRoute, err error) {
	result = &v1alpha1.HubRouteTableRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hubroutetableroutes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(hubRouteTableRoute).
		Do(ctx).
		Into(result)
	return
}
...
func (c *hubRouteTableRoutes) Update(ctx context.Context, hubRouteTableRoute *v1alpha1.HubRouteTableRoute, opts v1.UpdateOptions) (result *v1alpha1.HubRouteTableRoute, err error) {
	result = &v1alpha1.HubRouteTableRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubroutetableroutes").
		Name(hubRouteTableRoute.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(hubRouteTableRoute).
		Do(ctx).
		Into(result)
...
func (c *hubRouteTableRoutes) UpdateStatus(ctx context.Context, hubRouteTableRoute *v1alpha1.HubRouteTableRoute, opts v1.UpdateOptions) (result *v1alpha1.HubRouteTableRoute, err error) {
	result = &v1alpha1.HubRouteTableRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubroutetableroutes").
...
func (c *hubRouteTableRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hubRouteTableRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hubRouteTableRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HubRouteTableRoute, err error) {
	result = &v1alpha1.HubRouteTableRoute{}
