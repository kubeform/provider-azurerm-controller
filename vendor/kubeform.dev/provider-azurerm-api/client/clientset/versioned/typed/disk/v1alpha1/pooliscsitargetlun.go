...
// PoolIscsiTargetLunsGetter has a method to return a PoolIscsiTargetLunInterface.
...
// poolIscsiTargetLuns implements PoolIscsiTargetLunInterface
type poolIscsiTargetLuns struct {
	client rest.Interface
	ns     string
}

// newPoolIscsiTargetLuns returns a PoolIscsiTargetLuns
func newPoolIscsiTargetLuns(c *DiskV1alpha1Client, namespace string) *poolIscsiTargetLuns {
	return &poolIscsiTargetLuns{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *poolIscsiTargetLuns) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PoolIscsiTargetLun, err error) {
	result = &v1alpha1.PoolIscsiTargetLun{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *poolIscsiTargetLuns) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PoolIscsiTargetLunList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PoolIscsiTargetLunList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pooliscsitargetluns").
...
func (c *poolIscsiTargetLuns) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *poolIscsiTargetLuns) Create(ctx context.Context, poolIscsiTargetLun *v1alpha1.PoolIscsiTargetLun, opts v1.CreateOptions) (result *v1alpha1.PoolIscsiTargetLun, err error) {
	result = &v1alpha1.PoolIscsiTargetLun{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pooliscsitargetluns").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(poolIscsiTargetLun).
		Do(ctx).
		Into(result)
	return
}
...
func (c *poolIscsiTargetLuns) Update(ctx context.Context, poolIscsiTargetLun *v1alpha1.PoolIscsiTargetLun, opts v1.UpdateOptions) (result *v1alpha1.PoolIscsiTargetLun, err error) {
	result = &v1alpha1.PoolIscsiTargetLun{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pooliscsitargetluns").
		Name(poolIscsiTargetLun.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(poolIscsiTargetLun).
		Do(ctx).
		Into(result)
...
func (c *poolIscsiTargetLuns) UpdateStatus(ctx context.Context, poolIscsiTargetLun *v1alpha1.PoolIscsiTargetLun, opts v1.UpdateOptions) (result *v1alpha1.PoolIscsiTargetLun, err error) {
	result = &v1alpha1.PoolIscsiTargetLun{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pooliscsitargetluns").
...
func (c *poolIscsiTargetLuns) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *poolIscsiTargetLuns) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *poolIscsiTargetLuns) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PoolIscsiTargetLun, err error) {
	result = &v1alpha1.PoolIscsiTargetLun{}
