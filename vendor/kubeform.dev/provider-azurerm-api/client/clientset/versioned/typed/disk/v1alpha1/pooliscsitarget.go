...
// PoolIscsiTargetsGetter has a method to return a PoolIscsiTargetInterface.
...
// poolIscsiTargets implements PoolIscsiTargetInterface
type poolIscsiTargets struct {
	client rest.Interface
	ns     string
}

// newPoolIscsiTargets returns a PoolIscsiTargets
func newPoolIscsiTargets(c *DiskV1alpha1Client, namespace string) *poolIscsiTargets {
	return &poolIscsiTargets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *poolIscsiTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PoolIscsiTarget, err error) {
	result = &v1alpha1.PoolIscsiTarget{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *poolIscsiTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PoolIscsiTargetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PoolIscsiTargetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pooliscsitargets").
...
func (c *poolIscsiTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *poolIscsiTargets) Create(ctx context.Context, poolIscsiTarget *v1alpha1.PoolIscsiTarget, opts v1.CreateOptions) (result *v1alpha1.PoolIscsiTarget, err error) {
	result = &v1alpha1.PoolIscsiTarget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pooliscsitargets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(poolIscsiTarget).
		Do(ctx).
		Into(result)
	return
}
...
func (c *poolIscsiTargets) Update(ctx context.Context, poolIscsiTarget *v1alpha1.PoolIscsiTarget, opts v1.UpdateOptions) (result *v1alpha1.PoolIscsiTarget, err error) {
	result = &v1alpha1.PoolIscsiTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pooliscsitargets").
		Name(poolIscsiTarget.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(poolIscsiTarget).
		Do(ctx).
		Into(result)
...
func (c *poolIscsiTargets) UpdateStatus(ctx context.Context, poolIscsiTarget *v1alpha1.PoolIscsiTarget, opts v1.UpdateOptions) (result *v1alpha1.PoolIscsiTarget, err error) {
	result = &v1alpha1.PoolIscsiTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pooliscsitargets").
...
func (c *poolIscsiTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *poolIscsiTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *poolIscsiTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PoolIscsiTarget, err error) {
	result = &v1alpha1.PoolIscsiTarget{}
