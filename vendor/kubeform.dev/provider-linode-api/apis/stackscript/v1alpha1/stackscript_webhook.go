...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-stackscript-azurerm-kubeform-com-v1alpha1-stackscript,mutating=false,failurePolicy=fail,groups=stackscript.azurerm.kubeform.com,resources=stackscripts,versions=v1alpha1,name=stackscript.stackscript.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
