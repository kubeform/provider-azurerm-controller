...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-domain-azurerm-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=domain.azurerm.kubeform.com,resources=domains,versions=v1alpha1,name=domain.domain.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
