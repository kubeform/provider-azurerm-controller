...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-object-azurerm-kubeform-com-v1alpha1-storagebucket,mutating=false,failurePolicy=fail,groups=object.azurerm.kubeform.com,resources=storagebuckets,versions=v1alpha1,name=storagebucket.object.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
