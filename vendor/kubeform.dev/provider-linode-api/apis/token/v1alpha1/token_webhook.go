...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-token-azurerm-kubeform-com-v1alpha1-token,mutating=false,failurePolicy=fail,groups=token.azurerm.kubeform.com,resources=tokens,versions=v1alpha1,name=token.token.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
