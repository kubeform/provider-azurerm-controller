...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.Token":             schema_provider_azurerm_api_apis_token_v1alpha1_Token(ref),
		"kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenList":         schema_provider_azurerm_api_apis_token_v1alpha1_TokenList(ref),
		"kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenSpec":         schema_provider_azurerm_api_apis_token_v1alpha1_TokenSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenSpecResource": schema_provider_azurerm_api_apis_token_v1alpha1_TokenSpecResource(ref),
		"kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenStatus":       schema_provider_azurerm_api_apis_token_v1alpha1_TokenStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_token_v1alpha1_Token(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenSpec", "kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenStatus"},
	}
}

func schema_provider_azurerm_api_apis_token_v1alpha1_TokenList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.Token"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.Token"},
	}
}

func schema_provider_azurerm_api_apis_token_v1alpha1_TokenSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenSpecResource"),
						},
					},
					"resource": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-azurerm-api/apis/token/v1alpha1.TokenSpecResource"},
	}
}

func schema_provider_azurerm_api_apis_token_v1alpha1_TokenSpecResource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_token_v1alpha1_TokenStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
