...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.Volume":             schema_provider_azurerm_api_apis_volume_v1alpha1_Volume(ref),
		"kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeList":         schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeList(ref),
		"kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeSpec":         schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeSpecResource": schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeSpecResource(ref),
		"kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeStatus":       schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_volume_v1alpha1_Volume(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeSpec", "kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeStatus"},
	}
}

func schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.Volume"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.Volume"},
	}
}

func schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeSpecResource"),
						},
					},
					"resource": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-azurerm-api/apis/volume/v1alpha1.VolumeSpecResource"},
	}
}

func schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeSpecResource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_volume_v1alpha1_VolumeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
