...
type InstanceSpecConfig struct {
	...
	// A Kernel ID to boot a Linode with. Default is based on image choice. (examples: azurerm/latest-64bit, azurerm/grub2, azurerm/direct-disk)
	// +optional
...
type InstanceSpecDisk struct {
	...
	// An Image ID to deploy the Disk from. Official Linode Images start with azurerm/, while your Images start with private/.
	// +optional
...
type InstanceSpecResource struct {
	...
	// An Image ID to deploy the Disk from. Official Linode Images start with azurerm/, while your Images start with private/. See /images for more information on the Images available for you to use.
	// +optional
	Image *string `json:"image,omitempty" tf:"image"`
