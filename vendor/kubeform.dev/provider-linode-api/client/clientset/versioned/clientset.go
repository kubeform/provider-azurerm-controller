...
import (
	...
	domainv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/domain/v1alpha1"
	...
	instancev1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/instance/v1alpha1"
	lkev1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/lke/v1alpha1"
	nodebalancerv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/nodebalancer/v1alpha1"
	objectv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/object/v1alpha1"
	rdnsv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/rdns/v1alpha1"
	sshkeyv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/sshkey/v1alpha1"
	stackscriptv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/stackscript/v1alpha1"
	tokenv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/token/v1alpha1"
	userv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/user/v1alpha1"
	vlanv1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/vlan/v1alpha1"
	volumev1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/volume/v1alpha1"
