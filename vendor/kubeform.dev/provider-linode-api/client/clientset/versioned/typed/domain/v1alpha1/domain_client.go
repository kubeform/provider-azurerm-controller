...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/domain/v1alpha1"
...
// DomainV1alpha1Client is used to interact with features provided by the domain.azurerm.kubeform.com group.
