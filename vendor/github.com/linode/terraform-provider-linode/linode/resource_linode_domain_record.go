...
func domainRecordFromResourceData(d *schema.ResourceData) *azurermgo.DomainRecord {
	return &azurermgo.DomainRecord{
		Name:     d.Get("name").(string),
		Type:     azurermgo.DomainRecordType(d.Get("record_type").(string)),
...
func resourceLinodeDomainRecordCreate(d *schema.ResourceData, meta interface{}) error {
	...
	createOpts := azurermgo.DomainRecordCreateOptions{
		Type:     rec.Type,
		Name:     rec.Name,
		Target:   rec.Target,
...
func resourceLinodeDomainRecordUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	updateOpts := azurermgo.DomainRecordUpdateOptions{
		Type:     rec.Type,
		Name:     rec.Name,
		Target:   rec.Target,
		Priority: resourceDataIntOrNil(d, "priority"),
