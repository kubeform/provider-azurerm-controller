...
func resourceLinodeObjectStorageKeyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	createOpts := azurermgo.ObjectStorageKeyCreateOptions{
...
func resourceLinodeObjectStorageKeyUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("label") {
		...
		updateOpts := azurermgo.ObjectStorageKeyUpdateOptions{
			Label: d.Get("label").(string),
		}
...
func flattenLinodeObjectStorageKeyBucketAccess(
	bucketAccesses *[]azurermgo.ObjectStorageKeyBucketAccess) *[]map[string]interface{} {
...
func expandLinodeObjectStorageKeyBucketAccess(
	bucketAccessSpecs []interface{}) *[]azurermgo.ObjectStorageKeyBucketAccess {
	bucketAccesses := make([]azurermgo.ObjectStorageKeyBucketAccess, len(bucketAccessSpecs))
	for i, bucketAccessSpec := range bucketAccessSpecs {
		bucketAccessSpec := bucketAccessSpec.(map[string]interface{})
		bucketAccess := azurermgo.ObjectStorageKeyBucketAccess{
