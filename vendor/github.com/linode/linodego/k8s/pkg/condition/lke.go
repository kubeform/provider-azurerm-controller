...
import (
	...
	"github.com/azurerm/azurermgo/k8s"
...
func ClusterHasReadyNode(ctx context.Context, options azurermgo.ClusterConditionOptions) (bool, error) {
...
// condition true.
func WaitForLKEClusterReady(ctx context.Context, client azurermgo.Client, clusterID int, options azurermgo.LKEClusterPollOptions) error {
