...
const (
	...
	instanceConfigsEndpoint        = "azurerm/instances/{{ .ID }}/configs"
	instanceDisksEndpoint          = "azurerm/instances/{{ .ID }}/disks"
	instanceIPsEndpoint            = "azurerm/instances/{{ .ID }}/ips"
	instanceSnapshotsEndpoint      = "azurerm/instances/{{ .ID }}/backups"
	instanceStatsEndpoint          = "azurerm/instances/{{ .ID }}/stats"
	instanceVolumesEndpoint        = "azurerm/instances/{{ .ID }}/volumes"
	instancesEndpoint              = "azurerm/instances"
	...
	kernelsEndpoint                = "azurerm/kernels"
	...
	stackscriptsEndpoint             = "azurerm/stackscripts"
	tagsEndpoint                     = "tags"
	ticketsEndpoint                  = "support/tickets"
	tokensEndpoint                   = "profile/tokens"
	typesEndpoint                    = "azurerm/types"
...
// Resource represents a azurerm API resource
