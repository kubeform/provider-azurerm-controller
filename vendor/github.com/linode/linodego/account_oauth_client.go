...
type OAuthClient struct {
	...
	// The location a successful log in from https://login.azurerm.com should be redirected to for this client. The receiver of this redirect should be ready to accept an OAuth exchange code and finish the OAuth exchange.
