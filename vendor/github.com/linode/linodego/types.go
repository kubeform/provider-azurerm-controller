...
// LinodeType represents a azurerm type object
...
// LinodePrice represents a azurerm type price object
type LinodePrice struct {
	Hourly  float32 `json:"hourly"`
	Monthly float32 `json:"monthly"`
}

// LinodeBackupsAddon represents a azurerm backups addon object
type LinodeBackupsAddon struct {
	Price *LinodePrice `json:"price"`
}

// LinodeAddons represent the azurerm addons object
...
// LinodeTypesPagedResponse represents a azurerm types API response for listing
