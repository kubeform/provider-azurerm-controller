...
func (c *Client) GetInstanceIPAddresses(ctx context.Context, azurermID int) (*InstanceIPAddressResponse, error) {
	e, err := c.InstanceIPs.endpointWithParams(azurermID)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetInstanceIPAddress(ctx context.Context, azurermID int, ipaddress string) (*InstanceIP, error) {
	e, err := c.InstanceIPs.endpointWithParams(azurermID)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddInstanceIPAddress(ctx context.Context, azurermID int, public bool) (*InstanceIP, error) {
	var body string
	e, err := c.InstanceIPs.endpointWithParams(azurermID)
	if err != nil {
		return nil, err
...
func (c *Client) UpdateInstanceIPAddress(ctx context.Context, azurermID int, ipAddress string, updateOpts IPAddressUpdateOptions) (*InstanceIP, error) {
	var body string
	e, err := c.InstanceIPs.endpointWithParams(azurermID)
	if err != nil {
		return nil, err
...
func (c *Client) DeleteInstanceIPAddress(ctx context.Context, azurermID int, ipAddress string) error {
	e, err := c.InstanceIPs.endpointWithParams(azurermID)
	if err != nil {
		return err
	}
