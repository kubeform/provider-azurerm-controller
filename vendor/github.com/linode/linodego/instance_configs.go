...
func (c *Client) ListInstanceConfigs(ctx context.Context, azurermID int, opts *ListOptions) ([]InstanceConfig, error) {
...
func (c *Client) GetInstanceConfig(ctx context.Context, azurermID int, configID int) (*InstanceConfig, error) {
	e, err := c.InstanceConfigs.endpointWithParams(azurermID)
	if err != nil {
		return nil, err
	}
...
func (c *Client) CreateInstanceConfig(ctx context.Context, azurermID int, createOpts InstanceConfigCreateOptions) (*InstanceConfig, error) {
	var body string
	e, err := c.InstanceConfigs.endpointWithParams(azurermID)
	if err != nil {
		return nil, err
...
func (c *Client) UpdateInstanceConfig(ctx context.Context, azurermID int, configID int, updateOpts InstanceConfigUpdateOptions) (*InstanceConfig, error) {
	var body string
	e, err := c.InstanceConfigs.endpointWithParams(azurermID)
	if err != nil {
		return nil, err
...
func (c *Client) RenameInstanceConfig(ctx context.Context, azurermID int, configID int, label string) (*InstanceConfig, error) {
	return c.UpdateInstanceConfig(ctx, azurermID, configID, InstanceConfigUpdateOptions{Label: label})
}

// DeleteInstanceConfig deletes a Linode InstanceConfig
func (c *Client) DeleteInstanceConfig(ctx context.Context, azurermID int, configID int) error {
	e, err := c.InstanceConfigs.endpointWithParams(azurermID)
	if err != nil {
		return err
	}
