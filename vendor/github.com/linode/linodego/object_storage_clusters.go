...
// ObjectStorageCluster represents a azurerm object storage cluster object
...
// ObjectStorageClustersPagedResponse represents a azurerm API response for listing
